...
namespace V82.Перечисления//Ссылка
{
	...
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"807ff898-f22e-4188-b4f7-adb939001a71\", \"Представление\":\"ОшибкаЗагрузкиДрайвера\"}")]
	...
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"b167d6ea-4fc1-4a45-9e46-50292be0a26f\", \"Представление\":\"ОшибкаЗагрузкиОбработкиОбслуживания\"}")]
	...
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"04a04893-53cf-4489-9f50-e305e8d22115\", \"Представление\":\"ОшибкаНеизвестно\"}")]
		ОшибкаНеизвестно = 2,//Неизвестная ошибка
	///<summary>
	///Необходимо обратиться к администратору информационной базы.
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"796eed86-f3e3-4587-82cc-d8d9daed734d\", \"Представление\":\"ОшибкаНетПрав\"}")]
	...
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"b8446ab6-9783-46fd-8399-54fb6d42ec3b\", \"Представление\":\"ОшибкаПараметровНастройки\"}")]
	...
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"e98c8e90-f0f2-4e06-ba02-d530dbf8f546\", \"Представление\":\"ОшибкаПриПодключении\"}")]
		ОшибкаПриПодключении = 5,//Ошибка при подключении устройства
	///<summary>
	///Автоматический тест устройства не пройден.
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"8015ebb0-6621-46b5-a686-1554865b356a\", \"Представление\":\"ОшибкаТестНеПройден\"}")]
