...
namespace V82.Перечисления//Ссылка
{
	...
	public enum ВидыСтажаСЗВ4
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"40bd639e-a72e-4d9e-a2f6-c7e41c72a72f\", \"Представление\":\"ВключаетсяВСтажДляДосрочногоНазначенияПенсии\"}")]
		ВключаетсяВСтажДляДосрочногоНазначенияПенсии = 0,//Включается в стаж для досрочного назначения пенсии
		[EnumMember(Value = "{\"Ссылка\":\"1c8719fd-870a-401c-bb40-4e02e7f1c4d8\", \"Представление\":\"ВключаетсяВСтраховойСтаж\"}")]
		ВключаетсяВСтраховойСтаж = 1,//Включается в страховой стаж
		[EnumMember(Value = "{\"Ссылка\":\"703655d1-ee14-4aac-9330-3d08fc4e21c8\", \"Представление\":\"ВременнаяНетрудоспособность\"}")]
		ВременнаяНетрудоспособность = 2,//Временная нетрудоспособность
		[EnumMember(Value = "{\"Ссылка\":\"c470b387-2326-44b7-a4ff-1c20757974e9\", \"Представление\":\"ЧАЭС\"}")]
		ЧАЭС = 3,//Доп. отпуск, пострадавших в аварии на Чернобыльской АЭС
		[EnumMember(Value = "{\"Ссылка\":\"b3a3e3a6-5861-4c3c-9481-5d3953747783\", \"Представление\":\"ОтпускБезСохраненияЗарплаты\"}")]
		ОтпускБезСохраненияЗарплаты = 4,//Отпуск без сохранения зарплаты
		[EnumMember(Value = "{\"Ссылка\":\"9dffe1e2-9575-4cd0-b795-f54979eaee75\", \"Представление\":\"НЕОПЛ\"}")]
		НЕОПЛ = 5,//Неоплачиваемый период
		[EnumMember(Value = "{\"Ссылка\":\"f3a14d7c-7e46-4efc-bb2a-11fdd900a4ef\", \"Представление\":\"Дети\"}")]
		Дети = 6,
		[EnumMember(Value = "{\"Ссылка\":\"f68eb6ed-3b5e-4001-81ab-030ba49e880c\", \"Представление\":\"Декрет\"}")]
		Декрет = 7,
		[EnumMember(Value = "{\"Ссылка\":\"f0c41354-336b-496e-b2f8-d82e17028122\", \"Представление\":\"ДЛДЕТИ\"}")]
		ДЛДЕТИ = 8,//Отпуск по уходу за ребенком (ДЛДЕТИ)
		[EnumMember(Value = "{\"Ссылка\":\"750ccd33-0e7d-4000-8203-b00fc75084f2\", \"Представление\":\"НеВключаетсяВСтраховойСтаж\"}")]
