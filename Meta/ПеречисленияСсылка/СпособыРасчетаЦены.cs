...
namespace V82.Перечисления//Ссылка
{
	...
	public enum СпособыРасчетаЦены
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"ab05418b-748f-4582-8299-5b9bea7c1d1b\", \"Представление\":\"ПоПроцентнойНаценкеНаБазовыйТип\"}")]
		ПоПроцентнойНаценкеНаБазовыйТип = 0,//По процентной наценке на базовый тип
		[EnumMember(Value = "{\"Ссылка\":\"3c146cad-5879-4ce6-86e9-3069355d286e\", \"Представление\":\"ПоВхождениюБазовойЦеныВДиапазон\"}")]
