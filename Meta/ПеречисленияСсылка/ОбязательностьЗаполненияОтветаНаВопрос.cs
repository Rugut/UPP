...
namespace V82.Перечисления//Ссылка
{
	...
	public enum ОбязательностьЗаполненияОтветаНаВопрос
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"c9407984-abce-49d4-bd24-60d211dc90f6\", \"Представление\":\"НеОбязателенКЗаполнению\"}")]
		НеОбязателенКЗаполнению = 0,//Не обязателен к заполнению
		[EnumMember(Value = "{\"Ссылка\":\"22effe32-e4f8-4bd8-904a-33dbdf010897\", \"Представление\":\"ОбязателенКЗаполнению\"}")]
		ОбязателенКЗаполнению = 1,//Обязателен к заполнению
		[EnumMember(Value = "{\"Ссылка\":\"1a7213c3-1510-4150-b0b4-d8419338a54d\", \"Представление\":\"УсловноОбязателенКЗаполнению\"}")]
		УсловноОбязателенКЗаполнению = 2,//Условно обязателен к заполнению
		[EnumMember(Value = "{\"Ссылка\":\"a1613f15-292c-46b8-a037-8ccdbda03fe0\", \"Представление\":\"УсловноНеЗаполнять\"}")]
