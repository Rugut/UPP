...
namespace V82.Перечисления//Ссылка
{
	...
	public enum ВариантыВерсионированияОбъектов
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"de1b792d-320b-4da6-b902-407ce97617e9\", \"Представление\":\"ВерсионироватьВсегда\"}")]
		ВерсионироватьВсегда = 0,//Версионировать
		[EnumMember(Value = "{\"Ссылка\":\"1ec1cf2d-8933-4c0a-98cc-65d3704a1611\", \"Представление\":\"ВерсионироватьПриПроведении\"}")]
		ВерсионироватьПриПроведении = 1,//Версионировать при проведении
		[EnumMember(Value = "{\"Ссылка\":\"ce81a111-4d1e-4636-9cd8-8433d83bb1fd\", \"Представление\":\"НеВерсионировать\"}")]
