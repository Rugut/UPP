...
namespace V82.Перечисления//Ссылка
{
	...
	public enum МетодыОценкиАктивов
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"4d6eafe0-6050-4a37-8547-d1c161465b55\", \"Представление\":\"ПоПервоначальнойСтоимости\"}")]
		ПоПервоначальнойСтоимости = 0,//По первоначальной стоимости
		[EnumMember(Value = "{\"Ссылка\":\"e2646212-a0e3-42ca-ba35-408c688cae18\", \"Представление\":\"ПоСправедливойСтоимости\"}")]
