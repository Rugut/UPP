...
namespace V82.Перечисления//Ссылка
{
	...
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"34f8e2a9-c926-4fb4-b365-d4043a016677\", \"Представление\":\"ПоПорядку\"}")]
		ПоПорядку = 0,//По порядку
	///<summary>
	///Новой позиции назначается код, совпадающий с кодом номенклатуры в соответствующей позиции
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"55ea011e-fa06-45ca-be98-c7deafb0c968\", \"Представление\":\"ПоКодуНоменклатуры\"}")]
