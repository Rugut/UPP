...
namespace V82.Перечисления//Ссылка
{
	...
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"b8bc0dbb-1362-457d-8b79-6a6b24506d86\", \"Представление\":\"СписаниеПартийВПроизводствоОперативно\"}")]
		СписаниеПартийВПроизводствоОперативно = 0,//Списание партий в производство оперативно
	///<summary>
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"81b7f347-aba2-4a90-9ee2-a990f5020833\", \"Представление\":\"ПрочиеПостоянныеЗатраты\"}")]
		ПрочиеПостоянныеЗатраты = 1,//Прочие постоянные затраты
	///<summary>
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"36b69abd-628e-446e-9179-a1f2b8fb0d72\", \"Представление\":\"ВнутренниеУслугиНаПостоянныеЗатраты\"}")]
		ВнутренниеУслугиНаПостоянныеЗатраты = 2,//Внутренние услуги на постоянные затраты
	///<summary>
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"490a733b-64c7-486b-8f79-ab7437958f3a\", \"Представление\":\"УслугиКонтрагентаНаПостоянныеЗатраты\"}")]
		УслугиКонтрагентаНаПостоянныеЗатраты = 3,//Услуги контрагента на постоянные затраты
	///<summary>
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"eea8cc30-91aa-4e72-9399-a4d998c7bae1\", \"Представление\":\"СписаниеОХР_Регламент\"}")]
		СписаниеОХР_Регламент = 4,//Списание ОХР (26-й счет) (регламент.)
	///<summary>
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"aa77bc18-d938-4739-9c11-5c4a7f161856\", \"Представление\":\"СписаниеОПР_Регламент\"}")]
		СписаниеОПР_Регламент = 5,//Списание ОПР (25-й счет) (регламент.)
		[EnumMember(Value = "{\"Ссылка\":\"42942420-2a4a-4ad7-bb2b-a4f0154b2770\", \"Представление\":\"ЗакрытиеКосвенныхРасходовНУ\"}")]
		ЗакрытиеКосвенныхРасходовНУ = 6,//Закрытие косвенных расходов (НУ)
		[EnumMember(Value = "{\"Ссылка\":\"8fafa0a2-6e2f-4e77-a736-db9c773c50ed\", \"Представление\":\"СписаниеРасходовНаПродажу\"}")]
		СписаниеРасходовНаПродажу = 7,//Списание расходов на продажу (регламент.)
		[EnumMember(Value = "{\"Ссылка\":\"9be6b32f-a0bb-4474-a59d-205afe2b35d7\", \"Представление\":\"РасчетБазыРаспределения\"}")]
		РасчетБазыРаспределения = 8,//Расчет базы распределения
		[EnumMember(Value = "{\"Ссылка\":\"c37f0794-08d3-42a5-bb59-5f7dd5af50bb\", \"Представление\":\"ЗакрытиеКосвенныхРасходовНУФикс\"}")]
