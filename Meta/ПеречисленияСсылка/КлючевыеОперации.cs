...
namespace V82.Перечисления//Ссылка
{
	...
	public enum КлючевыеОперации
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"cd600a24-ec68-4176-bcd4-2cb513c3d329\", \"Представление\":\"ПроведениеДокументаВыпускПродукции\"}")]
		ПроведениеДокументаВыпускПродукции = 0,//Проведение документа "Выпуск продукции"
		[EnumMember(Value = "{\"Ссылка\":\"e726d3f9-90ba-4ec9-be2c-43e3774aca5a\", \"Представление\":\"ПроведениеДокументаЗаказПокупателя\"}")]
		ПроведениеДокументаЗаказПокупателя = 1,//Проведение документа "Заказ покупателя"
		[EnumMember(Value = "{\"Ссылка\":\"35678298-10a2-4631-998d-3558f2540f24\", \"Представление\":\"ПроведениеДокументаЗаказПоставщику\"}")]
		ПроведениеДокументаЗаказПоставщику = 2,//Проведение документа "Заказ поставщику"
		[EnumMember(Value = "{\"Ссылка\":\"68f75a0e-c9ec-4b70-b297-b3004d918e60\", \"Представление\":\"ПроведениеДокументаКомплектацияНоменклатуры\"}")]
		ПроведениеДокументаКомплектацияНоменклатуры = 3,//Проведение документа "Комплектация номенклатуры"
		[EnumMember(Value = "{\"Ссылка\":\"4509c0ea-91ad-4b4e-82aa-1bf70b5a1a1d\", \"Представление\":\"ПроведениеДокументаОприходованиеМатериаловИзПроизводства\"}")]
		ПроведениеДокументаОприходованиеМатериаловИзПроизводства = 4,//Проведение документа "Оприходование материалов из производства"
		[EnumMember(Value = "{\"Ссылка\":\"2696e69d-0f6c-4a19-8bc3-5ec74f1f2577\", \"Представление\":\"ПроведениеДокументаОтчетМастераСмены\"}")]
		ПроведениеДокументаОтчетМастераСмены = 5,//Проведение документа "Отчет мастера смены"
		[EnumMember(Value = "{\"Ссылка\":\"e9cb19cd-2ab8-4080-8323-7b44428405aa\", \"Представление\":\"ПроведениеДокументаОтчетПроизводстваЗаСмену\"}")]
		ПроведениеДокументаОтчетПроизводстваЗаСмену = 6,//Проведение документа "Отчет производства за смену"
		[EnumMember(Value = "{\"Ссылка\":\"406dfc28-2c7b-4565-817e-e8b629ae2556\", \"Представление\":\"ПроведениеДокументаПоступлениеТоваровУслуг\"}")]
		ПроведениеДокументаПоступлениеТоваровУслуг = 7,//Проведение документа "Поступление товаров и услуг"
		[EnumMember(Value = "{\"Ссылка\":\"003720a4-277b-406d-80f2-788dce5df7b3\", \"Представление\":\"ПроведениеДокументаПриходныйКассовыйОрдер\"}")]
		ПроведениеДокументаПриходныйКассовыйОрдер = 8,//Проведение документа "Приходный кассовый ордер"
		[EnumMember(Value = "{\"Ссылка\":\"b555ba9b-e3f2-4d60-92f1-e6b473623ac6\", \"Представление\":\"ПроведениеДокументаПриходныйОрдерНаТовары\"}")]
		ПроведениеДокументаПриходныйОрдерНаТовары = 9,//Проведение документа "Приходный ордер на товары"
		[EnumMember(Value = "{\"Ссылка\":\"4f51816f-bdf2-481d-b3c2-24e04c88a56b\", \"Представление\":\"ПроведениеДокументаРасходныйКассовыйОрдер\"}")]
		ПроведениеДокументаРасходныйКассовыйОрдер = 10,//Проведение документа "Расходный кассовый ордер"
		[EnumMember(Value = "{\"Ссылка\":\"43a456ef-2ca3-4490-894d-962c758e27cf\", \"Представление\":\"ПроведениеДокументаРасходныйОрдерНаТовары\"}")]
		ПроведениеДокументаРасходныйОрдерНаТовары = 11,//Проведение документа "Расходный ордер на товары"
		[EnumMember(Value = "{\"Ссылка\":\"12e44d37-cfbb-4e36-a387-da1669bca621\", \"Представление\":\"ПроведениеДокументаРасчетСебестоимостиВыпуска\"}")]
		ПроведениеДокументаРасчетСебестоимостиВыпуска = 12,//Проведение документа "Расчет себестоимости"
		[EnumMember(Value = "{\"Ссылка\":\"8b5d80cb-5fe0-413d-b9fd-98a49da82ab8\", \"Представление\":\"ПроведениеДокументаРеализацияТоваровУслуг\"}")]
		ПроведениеДокументаРеализацияТоваровУслуг = 13,//Проведение документа "Реализация товаров и услуг"
		[EnumMember(Value = "{\"Ссылка\":\"cca9817a-5931-4262-b0a2-b8060e07ee44\", \"Представление\":\"ПроведениеДокументаТребованиеНакладная\"}")]
		ПроведениеДокументаТребованиеНакладная = 14,//Прведение документа "Требование-накладная"
		[EnumMember(Value = "{\"Ссылка\":\"db9d05b6-2741-42b0-990e-85013380f77c\", \"Представление\":\"ОбщаяПроизводительностьСистемы\"}")]
