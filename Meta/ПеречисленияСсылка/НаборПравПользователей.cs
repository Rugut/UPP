...
namespace V82.Перечисления//Ссылка
{
	...
	public enum НаборПравПользователей
	{
		[NonSerialized]
		ПустаяСсылка = - 1,
		[EnumMember(Value = "{\"Ссылка\":\"55c0e4e0-00e0-4b43-aa57-67b4d336d750\", \"Представление\":\"Бухгалтер\"}")]
		Бухгалтер = 0,
		[EnumMember(Value = "{\"Ссылка\":\"29829d65-3a20-4ade-893b-b12fa2e8ed46\", \"Представление\":\"БухгалтерМСФО\"}")]
		БухгалтерМСФО = 1,//Бухгалтер МСФО
		[EnumMember(Value = "{\"Ссылка\":\"3aeaf9ae-f9a2-43c7-bf0b-4f1c74d9154d\", \"Представление\":\"Бюджетирование\"}")]
		Бюджетирование = 2,
		[EnumMember(Value = "{\"Ссылка\":\"142479b9-62ce-4009-829c-0bf833b7ce77\", \"Представление\":\"КадровикРегламентированныхДанных\"}")]
		КадровикРегламентированныхДанных = 3,//Кадровик регламентированных данных
		[EnumMember(Value = "{\"Ссылка\":\"3523c0e0-5957-447b-90c1-efcc4b7a725f\", \"Представление\":\"КадровикУправленческихДанных\"}")]
		КадровикУправленческихДанных = 4,//Кадровик управленческих данных
		[EnumMember(Value = "{\"Ссылка\":\"29e1407d-b7ec-4273-997d-118f52ee484c\", \"Представление\":\"Кладовщик\"}")]
		Кладовщик = 5,
		[EnumMember(Value = "{\"Ссылка\":\"35a49c0d-bddc-4fa5-b71f-d9c8fc332c61\", \"Представление\":\"МенеджерПоЗаказам\"}")]
		МенеджерПоЗаказам = 6,//Менеджер по заказам
		[EnumMember(Value = "{\"Ссылка\":\"4e73ff6c-c792-4e9c-94f9-acebd96cd6a8\", \"Представление\":\"МенеджерПоЗакупкам\"}")]
		МенеджерПоЗакупкам = 7,//Менеджер по закупкам
		[EnumMember(Value = "{\"Ссылка\":\"ecfaf234-f754-4afe-a972-1724a83659c0\", \"Представление\":\"МенеджерПоНаборуПерсонала\"}")]
		МенеджерПоНаборуПерсонала = 8,//Менеджер по набору персонала
	///<summary>
	///(Общ)
	///</summary>
		[EnumMember(Value = "{\"Ссылка\":\"56dce8c8-293c-41d2-b593-645c7c185933\", \"Представление\":\"МенеджерПоПродажам\"}")]
		МенеджерПоПродажам = 9,//Менеджер по продажам
		[EnumMember(Value = "{\"Ссылка\":\"fca2cc8d-42d3-40ea-8533-e8d0f549b397\", \"Представление\":\"Планирование\"}")]
		Планирование = 10,
		[EnumMember(Value = "{\"Ссылка\":\"7b1367a5-7eab-4c30-832b-146dc629a081\", \"Представление\":\"ПолныеПрава\"}")]
		ПолныеПрава = 11,//Полные права
		[EnumMember(Value = "{\"Ссылка\":\"ffb57601-e8d2-4017-b97f-3c0bfbb64c58\", \"Представление\":\"Пользователь\"}")]
		Пользователь = 12,
		[EnumMember(Value = "{\"Ссылка\":\"85842581-3241-4b38-9a45-64c6c0cff590\", \"Представление\":\"ПроведениеПоПартиям\"}")]
		ПроведениеПоПартиям = 13,//Проведение по партиям
		[EnumMember(Value = "{\"Ссылка\":\"a000f580-b8d0-400b-a2f0-62667ef13ddf\", \"Представление\":\"ПроведениеПоПартиямРегл\"}")]
		ПроведениеПоПартиямРегл = 14,//Проведение по партиям регл
		[EnumMember(Value = "{\"Ссылка\":\"0c8141b0-ee36-4a9a-9ad1-c3354a7fb68d\", \"Представление\":\"РасчетчикРегламентированнойЗарплаты\"}")]
		РасчетчикРегламентированнойЗарплаты = 15,//Расчетчик регламентированной зарплаты
		[EnumMember(Value = "{\"Ссылка\":\"43460170-34c4-4484-844c-5b45e7c47a32\", \"Представление\":\"РасчетчикУправленческойЗарплаты\"}")]
		РасчетчикУправленческойЗарплаты = 16,//Расчетчик управленческой зарплаты
		[EnumMember(Value = "{\"Ссылка\":\"f1fab1cd-8240-4eed-8bb5-8c341159338b\", \"Представление\":\"РозничныеПродажи\"}")]
		РозничныеПродажи = 17,//Розничные продажи
		[EnumMember(Value = "{\"Ссылка\":\"838ec5ff-843e-4b1f-8816-6a805a4afc1b\", \"Представление\":\"Сертификация\"}")]
		Сертификация = 18,
		[EnumMember(Value = "{\"Ссылка\":\"13857472-f056-44f9-9f08-bb3e814f06b1\", \"Представление\":\"Технолог\"}")]
		Технолог = 19,
		[EnumMember(Value = "{\"Ссылка\":\"a262a315-4131-4712-825b-aeca5cec661b\", \"Представление\":\"УчетОСиНМА\"}")]
		УчетОСиНМА = 20,//Учет ОС и НМА
		[EnumMember(Value = "{\"Ссылка\":\"0548d22c-9fec-4e7f-bd23-5f029126e1f9\", \"Представление\":\"Финансист\"}")]
		Финансист = 21,
		[EnumMember(Value = "{\"Ссылка\":\"004e3c8c-f610-45d4-a442-6ea9344f15ec\", \"Представление\":\"Ценообразование\"}")]
		Ценообразование = 22,
		[EnumMember(Value = "{\"Ссылка\":\"dd523b2e-aef7-4cf0-96d4-d37aaae101df\", \"Представление\":\"ЭкономистЦеха\"}")]
