...
namespace V82.ДокументыСсылка
{
	...
	///(Общ)
	///</summary>
	public partial class ВозвратТоваровОтПокупателя:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		///(Общ)
		///</summary>
		public V82.Перечисления/*Ссылка*/.ВидыОперацийВозвратТоваровОтПокупателя ВидОперации;//Вид операции
		///<summary>
		///(Общ)
		///</summary>
		...
		public bool ОтразитьВКнигеПокупок;//Отразить в книге покупок
		public bool ПокупателемВыставляетсяСчетФактураНаВозврат;//Покупателем выставляется счет-фактура на возврат
		///<summary>
		///(Упр)
		///</summary>
