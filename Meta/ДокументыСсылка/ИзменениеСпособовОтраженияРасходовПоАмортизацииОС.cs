...
namespace V82.ДокументыСсылка
{
	...
	///(Общ)
	///</summary>
	public partial class ИзменениеСпособовОтраженияРасходовПоАмортизацииОС:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		///(Общ)
		///</summary>
		public V82.СправочникиСсылка.СпособыОтраженияРасходовПоАмортизации СпособОтраженияРасходовПоАмортизации;//Способ отражения расходов по амортизации
		///<summary>
		///(Общ)
		///</summary>
