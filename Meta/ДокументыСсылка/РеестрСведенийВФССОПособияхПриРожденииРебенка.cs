...
namespace V82.ДокументыСсылка
{
	[ProtoContract]
	[DataContract]
	public partial class РеестрСведенийВФССОПособияхПриРожденииРебенка:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		public static readonly Guid ГуидКласса = new Guid("1131ba0c-167e-4383-ad1a-24ee9544e252");
		...
		public РеестрСведенийВФССОПособияхПриРожденииРебенка()
		{
		}
		
		public РеестрСведенийВФССОПособияхПриРожденииРебенка(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.РеестрСведенийВФССОПособияхПриРожденииРебенка  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.РеестрСведенийВФССОПособияхПриРожденииРебенка ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.РеестрСведенийВФССОПособияхПриРожденииРебенка)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.РеестрСведенийВФССОПособияхПриРожденииРебенка(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
