...
namespace V82.ДокументыСсылка
{
	...
	///(Общ)
	///</summary>
	public partial class ВозвратТоваровПоставщику:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		///(Общ)
		///</summary>
		public V82.Перечисления/*Ссылка*/.ВидыОперацийВозвратТоваровПоставщику ВидОперации;//Вид операции
		///<summary>
