...
namespace V82.ДокументыСсылка
{
	...
	public partial class АттестацияРаботника:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public АттестацияРаботника()
		{
		}
		
		public АттестацияРаботника(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.АттестацияРаботника  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.АттестацияРаботника ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.АттестацияРаботника)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.АттестацияРаботника(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
