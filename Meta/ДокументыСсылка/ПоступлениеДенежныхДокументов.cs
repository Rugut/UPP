...
{
	public partial class ПоступлениеДенежныхДокументов:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		///(Общ)
		///</summary>
		public V82.Перечисления/*Ссылка*/.ВидыОперацийПоступлениеДенежныхДокументов ВидОперации;//Вид операции
		///<summary>
		///(Общ) 
		///</summary>
		...
		public object СубконтоКт2;//Субконто Кт2
		public object СубконтоКт3;//Субконто Кт3
