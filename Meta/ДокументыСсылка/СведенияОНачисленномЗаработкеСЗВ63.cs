...
namespace V82.ДокументыСсылка
{
	...
	///(Регл)
	///</summary>
	public partial class СведенияОНачисленномЗаработкеСЗВ63:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		public decimal/*(4)*/ ОтчетныйПериод;//Отчетный период
		...
		public V82.Перечисления/*Ссылка*/.ТипДоговораСЗВ63 ТипДоговора;//Тип договора
		public V82.ДокументыСсылка.ПередачаСЗВ4вПФР ОписьАДВ62;//Опись АДВ62
	}
}