...
namespace V82.ДокументыСсылка
{
	...
	public partial class ПравоНаДополнительныеДниОтпуска:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ПравоНаДополнительныеДниОтпуска()
		{
		}
		
		public ПравоНаДополнительныеДниОтпуска(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.ПравоНаДополнительныеДниОтпуска  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.ПравоНаДополнительныеДниОтпуска ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.ПравоНаДополнительныеДниОтпуска)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.ПравоНаДополнительныеДниОтпуска(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
