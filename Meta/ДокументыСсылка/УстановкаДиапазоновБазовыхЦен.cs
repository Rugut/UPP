...
namespace V82.ДокументыСсылка
{
	...
	public partial class УстановкаДиапазоновБазовыхЦен:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public УстановкаДиапазоновБазовыхЦен()
		{
		}
		
		public УстановкаДиапазоновБазовыхЦен(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.УстановкаДиапазоновБазовыхЦен  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.УстановкаДиапазоновБазовыхЦен ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.УстановкаДиапазоновБазовыхЦен)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.УстановкаДиапазоновБазовыхЦен(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
