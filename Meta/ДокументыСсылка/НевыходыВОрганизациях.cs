...
namespace V82.ДокументыСсылка
{
	...
	///(Регл)
	///</summary>
	public partial class НевыходыВОрганизациях:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		public V82.ДокументыСсылка.НевыходыВОрганизациях ПерерассчитываемыйДокумент;//Перерассчитываемый документ
