...
{
	public partial class ТабельУчетаРабочегоВремениОрганизации:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		public V82.Перечисления/*Ссылка*/.ПериодНачисленияЗарплаты СпособУказанияПериода;//Способ указания периода
