...
namespace V82.ДокументыСсылка
{
	...
	///(Общ)
	///</summary>
	public partial class РаспределениеПрочихЗатрат:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		public V82.ДокументыСсылка.ИнвентаризацияНЗП ДокументИнвентаризация;//Документ инвентаризации
