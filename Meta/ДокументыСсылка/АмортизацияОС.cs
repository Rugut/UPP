...
namespace V82.ДокументыСсылка
{
	...
	[ProtoContract]
	[DataContract]
	public partial class АмортизацияОС:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		public static readonly Guid ГуидКласса = new Guid("f5655726-ef57-4579-868b-4ec00c35d950");
		...
		public АмортизацияОС()
		{
		}
		
		public АмортизацияОС(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.АмортизацияОС  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.АмортизацияОС ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.АмортизацияОС)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.АмортизацияОС(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
