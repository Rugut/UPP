...
namespace V82.ДокументыСсылка
{
	...
	public partial class РасчетСебестоимостиВыпуска:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public РасчетСебестоимостиВыпуска()
		{
		}
		
		public РасчетСебестоимостиВыпуска(byte[] УникальныйИдентификатор)
		{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							УчитыватьОбщепроизводственныеРасходыПриРаспределенииПоПеределам = ((byte[])Читалка.GetValue(12))[0]==1;
							//return Ссылка;
						}
						else
						{
		...
		public V82.ДокументыОбъект.РасчетСебестоимостиВыпуска  ПолучитьОбъект()
		{
			...
			Объект.УчитыватьОбщепроизводственныеРасходыПриРаспределенииПоПеределам = УчитыватьОбщепроизводственныеРасходыПриРаспределенииПоПеределам;
		...
		public static V82.ДокументыСсылка.РасчетСебестоимостиВыпуска ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.РасчетСебестоимостиВыпуска)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.РасчетСебестоимостиВыпуска(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
