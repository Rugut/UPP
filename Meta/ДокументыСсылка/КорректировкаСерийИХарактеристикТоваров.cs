...
namespace V82.ДокументыСсылка
{
	...
	///(Общ)
	///</summary>
	public partial class КорректировкаСерийИХарактеристикТоваров:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		///(Общ.)
		///</summary>
		public V82.Перечисления/*Ссылка*/.ВидыОперацийКорректировкаСерийИХарактеристикТоваров ВидОперации;//Вид операции
	}
}
