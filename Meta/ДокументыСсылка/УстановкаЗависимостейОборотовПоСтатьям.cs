...
namespace V82.ДокументыСсылка
{
	...
	public partial class УстановкаЗависимостейОборотовПоСтатьям:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.СтатьиОборотовПоБюджетам СтатьяОборотовВлияющая {get;set;}//Статья оборотов влияющая
		...
		public УстановкаЗависимостейОборотовПоСтатьям()
		{
		}
		
		public УстановкаЗависимостейОборотовПоСтатьям(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.УстановкаЗависимостейОборотовПоСтатьям  ПолучитьОбъект()
		{
			...
			Объект.СтатьяОборотовВлияющая = СтатьяОборотовВлияющая;
			Объект.ЦФО = ЦФО;
		...
		public static V82.ДокументыСсылка.УстановкаЗависимостейОборотовПоСтатьям ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.УстановкаЗависимостейОборотовПоСтатьям)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.УстановкаЗависимостейОборотовПоСтатьям(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
