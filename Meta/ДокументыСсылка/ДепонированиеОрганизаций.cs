...
namespace V82.ДокументыСсылка
{
	...
	public partial class ДепонированиеОрганизаций:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public object СчетУчетаРасходов {get;set;}//Счет учета расходов в БУ
		...
		public ДепонированиеОрганизаций()
		{
		}
		
		public ДепонированиеОрганизаций(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.ДепонированиеОрганизаций  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.ДепонированиеОрганизаций ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.ДепонированиеОрганизаций)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.ДепонированиеОрганизаций(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
