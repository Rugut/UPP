...
namespace V82.ДокументыСсылка
{
	...
	public partial class ПереносЗадолженностиРаботниковОрганизаций:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ПереносЗадолженностиРаботниковОрганизаций()
		{
		}
		
		public ПереносЗадолженностиРаботниковОрганизаций(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.ПереносЗадолженностиРаботниковОрганизаций  ПолучитьОбъект()
		{
			var Объект = new V82.ДокументыОбъект.ПереносЗадолженностиРаботниковОрганизаций();
		...
		public static V82.ДокументыСсылка.ПереносЗадолженностиРаботниковОрганизаций ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.ПереносЗадолженностиРаботниковОрганизаций)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.ПереносЗадолженностиРаботниковОрганизаций(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
