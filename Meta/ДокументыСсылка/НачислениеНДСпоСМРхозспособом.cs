...
namespace V82.ДокументыСсылка
{
	...
	public partial class НачислениеНДСпоСМРхозспособом:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public НачислениеНДСпоСМРхозспособом()
		{
		}
		
		public НачислениеНДСпоСМРхозспособом(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.НачислениеНДСпоСМРхозспособом  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.НачислениеНДСпоСМРхозспособом ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.НачислениеНДСпоСМРхозспособом)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.НачислениеНДСпоСМРхозспособом(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
