...
namespace V82.ДокументыСсылка
{
	...
	[ProtoContract]
	[DataContract]
	public partial class ИнкассовоеПоручениеПолученное:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		public static readonly Guid ГуидКласса = new Guid("9ec30e54-ea3b-46e1-b569-e83d57cd8f17");
		public static readonly DateTime ВерсияКласса = DateTime.ParseExact("20121221190952.000", new string[] {"yyyyMMddHHmmss.fff"}, CultureInfo.InvariantCulture, DateTimeStyles.None);
		...
		public ИнкассовоеПоручениеПолученное()
		{
		}
		
		public ИнкассовоеПоручениеПолученное(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.ИнкассовоеПоручениеПолученное  ПолучитьОбъект()
		{
		...
		public static V82.ДокументыСсылка.ИнкассовоеПоручениеПолученное ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.ИнкассовоеПоручениеПолученное)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.ИнкассовоеПоручениеПолученное(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
