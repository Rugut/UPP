...
namespace V82.ДокументыСсылка
{
	...
	public partial class РасходыНаДобровольноеСтрахование:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public РасходыНаДобровольноеСтрахование()
		{
		}
		
		public РасходыНаДобровольноеСтрахование(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.РасходыНаДобровольноеСтрахование  ПолучитьОбъект()
		{
			var Объект = new V82.ДокументыОбъект.РасходыНаДобровольноеСтрахование();
		...
		public static V82.ДокументыСсылка.РасходыНаДобровольноеСтрахование ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.РасходыНаДобровольноеСтрахование)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.РасходыНаДобровольноеСтрахование(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
