...
namespace V82.ДокументыСсылка
{
	...
	///(Регл)
	///</summary>
	public partial class УвольнениеИзОрганизаций:ДокументСсылка
	{
		public Guid Ссылка;
		public ulong Версия;
		...
		public V82.ДокументыСсылка.УвольнениеИзОрганизаций ИсправляемыйДокумент;//Исправляемый документ
