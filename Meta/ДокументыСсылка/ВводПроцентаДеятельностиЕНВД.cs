...
namespace V82.ДокументыСсылка
{
	...
	public partial class ВводПроцентаДеятельностиЕНВД:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public bool ВводДанныхПоПериодам {get;set;}//Ввод данных по периодам
		
		public ВводПроцентаДеятельностиЕНВД()
		{
		}
		
		public ВводПроцентаДеятельностиЕНВД(byte[] УникальныйИдентификатор)
		{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ВводДанныхПоПериодам = ((byte[])Читалка.GetValue(9))[0]==1;
							//return Ссылка;
						}
						else
						{
		...
		public V82.ДокументыОбъект.ВводПроцентаДеятельностиЕНВД  ПолучитьОбъект()
		{
			...
			Объект.ВводДанныхПоПериодам = ВводДанныхПоПериодам;
			return Объект;
		}
		
		private static readonly Hashtable Кэш = new Hashtable(1000);
		
		public static V82.ДокументыСсылка.ВводПроцентаДеятельностиЕНВД ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.ВводПроцентаДеятельностиЕНВД)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.ВводПроцентаДеятельностиЕНВД(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
