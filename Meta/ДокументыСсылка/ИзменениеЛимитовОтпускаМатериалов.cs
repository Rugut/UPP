...
namespace V82.ДокументыСсылка
{
	...
	public partial class ИзменениеЛимитовОтпускаМатериалов:ДокументСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ИзменениеЛимитовОтпускаМатериалов()
		{
		}
		
		public ИзменениеЛимитовОтпускаМатериалов(byte[] УникальныйИдентификатор)
		{
		...
		public V82.ДокументыОбъект.ИзменениеЛимитовОтпускаМатериалов  ПолучитьОбъект()
		{
			var Объект = new V82.ДокументыОбъект.ИзменениеЛимитовОтпускаМатериалов();
		...
		public static V82.ДокументыСсылка.ИзменениеЛимитовОтпускаМатериалов ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.ДокументыСсылка.ИзменениеЛимитовОтпускаМатериалов)Кэш[УИ];
			}
			var Ссылка = new V82.ДокументыСсылка.ИзменениеЛимитовОтпускаМатериалов(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
