...
{
	public partial class ПоказНамеченныхСобытийПоПерсоналуПереопределяемый
	{
		////////////////////////////////////////////////////////////////////////////////
	...
	|		И НамеченныеИзменения.ДатаИзменения <= &ДатаОкончания";*/
		...
		public object ВыполняетсяДополнительноеУсловие(/*Строка, ПараметрыОтбора, СписокДокументов*/)
		{
			if(true/*Строка.УправленческийУчет*/)
			{
