...
{
	public partial class ПодключаемоеОборудование1ССканерыШтрихкода
	{
		///////////////////////////////////////////////////////////////////////////////
...
*/
					if(true/*ВерсияСтрокаВЧисло(ОбъектДрайвера.ПолучитьНомерВерсии()) >= 8001202 И Параметры.Порт=0*/)
					{
...
*/
			/*// начиная с версии 8.0.12.2 произошли изменения в интерфейсе драйвера
*/
			if(true/*ВерсияСтрокаВЧисло(ОбъектДрайвера.ПолучитьНомерВерсии()) >= 8001202*/)
			{
				//ОбъектДрайвера.Таймаут = Параметры.Таймаут;
