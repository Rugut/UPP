			...
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					else
					{
						...
						,_Fld2891RRef	= @ШаблонРегулярногоДокумента
					...
					Команда.Parameters.AddWithValue("ШаблонРегулярногоДокумента", ШаблонРегулярногоДокумента.Ссылка);
