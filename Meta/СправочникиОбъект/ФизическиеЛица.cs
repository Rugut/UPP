...
namespace V82.СправочникиОбъект
{
	...
	public partial class ФизическиеЛица:СправочникОбъект
	{
		...
		///(Общ)
		///</summary>
		public string/*(240)*/ МестоРождения;//Место рождения
		///<summary>
		///(Общ)
		///</summary>
		...
		///(Регл)
		///</summary>
		public string/*(11)*/ МестоРожденияКодПоОКАТО;//Место рождения - код по ОКАТО
		public V82.СправочникиСсылка.ГруппыДоступаФизическихЛиц ГруппаДоступаФизическогоЛица;//Группа доступа физического лица
		public V82.Перечисления/*Ссылка*/.ВидыЛьготПриНачисленииБольничных ЛьготаПриНачисленииПособий;//Льгота при начислении пособий
		public bool ИмеетНаучныеТруды;//Имеет научные труды
		public bool ИмеетИзобретения;//Имеет изобретения
