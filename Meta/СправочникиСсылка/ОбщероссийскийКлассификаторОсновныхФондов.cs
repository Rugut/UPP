...
namespace V82.СправочникиСсылка
{
	...
	public partial class ОбщероссийскийКлассификаторОсновныхФондов:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.ОбщероссийскийКлассификаторОсновныхФондов Родитель {get;set;}
		...
		public ОбщероссийскийКлассификаторОсновныхФондов()
		{
		}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Родитель = new V82.СправочникиСсылка.ОбщероссийскийКлассификаторОсновныхФондов((byte[])Читалка.GetValue(4),Глубина+1);
							...
							Наименование = Читалка.GetString(7);
								...
								НаименованиеГруппировки = Читалка.GetString(9);
