...
namespace V82.СправочникиСсылка
{
	...
	public partial class МаршрутыСогласования:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public МаршрутыСогласования()
		{
		}
		
		public МаршрутыСогласования(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public МаршрутыСогласования(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.МаршрутыСогласования ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.МаршрутыСогласования)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.МаршрутыСогласования(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
