...
namespace V82.СправочникиСсылка
{
	...
	public partial class ВидыПараметровВыпускаПродукции:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ВидыПараметровВыпускаПродукции()
		{
		}
		
		public ВидыПараметровВыпускаПродукции(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public ВидыПараметровВыпускаПродукции(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.ВидыПараметровВыпускаПродукции ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ВидыПараметровВыпускаПродукции)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ВидыПараметровВыпускаПродукции(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
