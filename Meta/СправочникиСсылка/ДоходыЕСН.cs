...
namespace V82.СправочникиСсылка
{
	...
	public partial class ДоходыЕСН:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public static V82.СправочникиСсылка.ДоходыЕСН ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ДоходыЕСН)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ДоходыЕСН(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
