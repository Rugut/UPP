...
namespace V82.СправочникиСсылка
{
	...
	public partial class КлючиАналитикиВидаУчета:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public КлючиАналитикиВидаУчета()
		{
		}
		...
		public V82.СправочникиОбъект.КлючиАналитикиВидаУчета  ПолучитьОбъект()
		{
		...
		public static V82.СправочникиСсылка.КлючиАналитикиВидаУчета ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.КлючиАналитикиВидаУчета)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.КлючиАналитикиВидаУчета(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
