				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ИсточникДанныхДляЦены = new V82.СправочникиСсылка.ИсточникиДанныхДляРасчетовБюджетирования((byte[])Читалка.GetValue(9),Глубина+1);
							ПоказательИсточникаДанныхДляЦены = Читалка.GetString(10);
							ИсточникДанныхДляФакта = new V82.СправочникиСсылка.ИсточникиДанныхДляРасчетовБюджетирования((byte[])Читалка.GetValue(11),Глубина+1);
							...
							ЕдиницаИзмерения = new V82.СправочникиСсылка.КлассификаторЕдиницИзмерения((byte[])Читалка.GetValue(15),Глубина+1);
							РазделениеПоКонтрагентам = ((byte[])Читалка.GetValue(16))[0]==1;
							РазделениеПоНоменклатуре = ((byte[])Читалка.GetValue(17))[0]==1;
							ОсновнаяВалюта = new V82.СправочникиСсылка.Валюты((byte[])Читалка.GetValue(18),Глубина+1);
							ОсновноеЦФО = new V82.СправочникиСсылка.Подразделения((byte[])Читалка.GetValue(19),Глубина+1);
							ОсновнойПроект = new V82.СправочникиСсылка.Проекты((byte[])Читалка.GetValue(20),Глубина+1);
							ОсновнойКонтрагент = new V82.СправочникиСсылка.Контрагенты((byte[])Читалка.GetValue(21),Глубина+1);
