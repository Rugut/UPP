...
namespace V82.СправочникиСсылка
{
	...
	public partial class ДоговорыЭквайринга:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиОбъект.ДоговорыЭквайринга  ПолучитьОбъект()
		{
			...
			Объект.ДоговорВзаиморасчетов = ДоговорВзаиморасчетов;
			return Объект;
		}
		
		private static readonly Hashtable Кэш = new Hashtable(1000);
		
		public static V82.СправочникиСсылка.ДоговорыЭквайринга ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ДоговорыЭквайринга)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ДоговорыЭквайринга(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
