...
namespace V82.СправочникиСсылка
{
	...
	public partial class ТехнологическиеОперации:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ОсновнаяСтатьяЗатратНаПроизводство = new V82.СправочникиСсылка.СтатьиЗатрат((byte[])Читалка.GetValue(6),Глубина+1);
							СпособОтраженияЗарплатыВБухучете = new V82.СправочникиСсылка.СпособыОтраженияЗарплатыВРеглУчете((byte[])Читалка.GetValue(7),Глубина+1);
							ОсновнойСпособРаспределенияЗатратНаВыпуск = new V82.СправочникиСсылка.СпособыРаспределенияЗатратНаВыпуск((byte[])Читалка.GetValue(8),Глубина+1);
							ОсновнаяНоменклатурнаяГруппа = new V82.СправочникиСсылка.НоменклатурныеГруппы((byte[])Читалка.GetValue(9),Глубина+1);
							Расценка = Читалка.GetDecimal(10);
							БазоваяЕдиницаИзмерения = new V82.СправочникиСсылка.КлассификаторЕдиницИзмерения((byte[])Читалка.GetValue(11),Глубина+1);
							Валюта = new V82.СправочникиСсылка.Валюты((byte[])Читалка.GetValue(12),Глубина+1);
		...
		public static V82.СправочникиСсылка.ТехнологическиеОперации ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ТехнологическиеОперации)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ТехнологическиеОперации(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
