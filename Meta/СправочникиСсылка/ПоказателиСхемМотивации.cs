...
namespace V82.СправочникиСсылка
{
	...
	public partial class ПоказателиСхемМотивации:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ПоказателиСхемМотивации(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ФактическийПоказатель = new V82.СправочникиСсылка.ПоказателиСхемМотивации((byte[])Читалка.GetValue(11),Глубина+1);
							СпособРасчетаСуммы = V82.Перечисления/*Ссылка*/.СпособыРасчетаСуммыПоказателей.ПустаяСсылка.Получить((byte[])Читалка.GetValue(12));
							СуммируемыйПоказатель = new V82.СправочникиСсылка.ПоказателиСхемМотивации((byte[])Читалка.GetValue(13),Глубина+1);
							Валюта = new V82.СправочникиСсылка.Валюты((byte[])Читалка.GetValue(14),Глубина+1);
							ВидСтажа = new V82.СправочникиСсылка.ВидыСтажа((byte[])Читалка.GetValue(15),Глубина+1);
							//return Ссылка;
						}
						else
						{
		...
		public static V82.СправочникиСсылка.ПоказателиСхемМотивации ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ПоказателиСхемМотивации)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ПоказателиСхемМотивации(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
