...
namespace V82.СправочникиСсылка
{
	...
	public partial class ГруппыЗаменяемостиРабочихЦентров:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ГруппыЗаменяемостиРабочихЦентров()
		{
		}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ТребуетсяЗагрузкаПодчиненныхРабочихЦентров = ((byte[])Читалка.GetValue(6))[0]==1;
							//return Ссылка;
						}
						else
						{
		...
		public V82.СправочникиОбъект.ГруппыЗаменяемостиРабочихЦентров  ПолучитьОбъект()
		{
		...
		public static V82.СправочникиСсылка.ГруппыЗаменяемостиРабочихЦентров ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ГруппыЗаменяемостиРабочихЦентров)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ГруппыЗаменяемостиРабочихЦентров(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
