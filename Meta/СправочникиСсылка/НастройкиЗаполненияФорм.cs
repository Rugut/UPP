...
namespace V82.СправочникиСсылка
{
	...
	public partial class НастройкиЗаполненияФорм:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public НастройкиЗаполненияФорм()
		{
		}
		
		public НастройкиЗаполненияФорм(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public НастройкиЗаполненияФорм(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.НастройкиЗаполненияФорм ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.НастройкиЗаполненияФорм)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.НастройкиЗаполненияФорм(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
