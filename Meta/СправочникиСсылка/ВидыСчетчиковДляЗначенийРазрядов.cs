...
namespace V82.СправочникиСсылка
{
	...
	public partial class ВидыСчетчиковДляЗначенийРазрядов:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public static V82.СправочникиСсылка.ВидыСчетчиковДляЗначенийРазрядов ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ВидыСчетчиковДляЗначенийРазрядов)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ВидыСчетчиковДляЗначенийРазрядов(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
