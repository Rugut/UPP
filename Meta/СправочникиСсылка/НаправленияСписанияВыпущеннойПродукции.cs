...
namespace V82.СправочникиСсылка
{
	...
	public partial class НаправленияСписанияВыпущеннойПродукции:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public НаправленияСписанияВыпущеннойПродукции()
		{
		}
		
		public НаправленияСписанияВыпущеннойПродукции(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public НаправленияСписанияВыпущеннойПродукции(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.НаправленияСписанияВыпущеннойПродукции ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.НаправленияСписанияВыпущеннойПродукции)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.НаправленияСписанияВыпущеннойПродукции(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
