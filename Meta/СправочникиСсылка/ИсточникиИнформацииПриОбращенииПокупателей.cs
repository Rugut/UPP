...
namespace V82.СправочникиСсылка
{
	...
	public partial class ИсточникиИнформацииПриОбращенииПокупателей:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ИсточникиИнформацииПриОбращенииПокупателей(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.ИсточникиИнформацииПриОбращенииПокупателей ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ИсточникиИнформацииПриОбращенииПокупателей)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ИсточникиИнформацииПриОбращенииПокупателей(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
