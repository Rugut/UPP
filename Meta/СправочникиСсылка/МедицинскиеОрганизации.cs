...
namespace V82.СправочникиСсылка
{
	...
	public partial class МедицинскиеОрганизации:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ОГРН = Читалка.GetString(6);
							Адрес = Читалка.GetString(7);
							АдресКодПоКЛАДР = Читалка.GetString(8);
							//return Ссылка;
						}
						else
						{
		...
		public static V82.СправочникиСсылка.МедицинскиеОрганизации ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.МедицинскиеОрганизации)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.МедицинскиеОрганизации(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
