...
namespace V82.СправочникиСсылка
{
	...
	public partial class СтатьиАналитическогоБаланса:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.СтатьиАналитическогоБаланса Родитель {get;set;}
		...
		public СтатьиАналитическогоБаланса()
		{
		}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Родитель = new V82.СправочникиСсылка.СтатьиАналитическогоБаланса((byte[])Читалка.GetValue(4),Глубина+1);
							ЭтоГруппа = ((byte[])Читалка.GetValue(5))[0]==0;
							Код = Читалка.GetString(6);
							Наименование = Читалка.GetString(7);
							if(!ЭтоГруппа)
							{
								ОбластьОтчета = Читалка.GetString(8);
								НаименованиеДляОтчета = Читалка.GetString(9);
							}
							//return Ссылка;
						}
						else
		...
		public static V82.СправочникиСсылка.СтатьиАналитическогоБаланса ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.СтатьиАналитическогоБаланса)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.СтатьиАналитическогоБаланса(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
