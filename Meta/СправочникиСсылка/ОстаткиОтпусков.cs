...
namespace V82.СправочникиСсылка
{
	...
	public partial class ОстаткиОтпусков:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public static V82.СправочникиСсылка.ОстаткиОтпусков ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ОстаткиОтпусков)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ОстаткиОтпусков(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
