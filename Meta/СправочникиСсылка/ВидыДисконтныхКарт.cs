...
namespace V82.СправочникиСсылка
{
	...
	public partial class ВидыДисконтныхКарт:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ВидыДисконтныхКарт()
		{
		}
		
		public ВидыДисконтныхКарт(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public ВидыДисконтныхКарт(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.ВидыДисконтныхКарт ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ВидыДисконтныхКарт)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ВидыДисконтныхКарт(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
