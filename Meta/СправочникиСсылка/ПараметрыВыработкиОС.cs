...
namespace V82.СправочникиСсылка
{
	...
	public partial class ПараметрыВыработкиОС:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ПараметрыВыработкиОС()
		{
		}
		
		public ПараметрыВыработкиОС(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public ПараметрыВыработкиОС(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Наименование = Читалка.GetString(5);
								ЕдиницаИзмерения = new V82.СправочникиСсылка.КлассификаторЕдиницИзмерения((byte[])Читалка.GetValue(6),Глубина+1);
							//return Ссылка;
						}
						else
						{
		...
		public static V82.СправочникиСсылка.ПараметрыВыработкиОС ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ПараметрыВыработкиОС)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ПараметрыВыработкиОС(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
