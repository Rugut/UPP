...
namespace V82.СправочникиСсылка
{
	...
	public partial class ХарактеристикиНоменклатуры:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ХарактеристикиНоменклатуры()
		{
		}
		...
		public V82.СправочникиОбъект.ХарактеристикиНоменклатуры  ПолучитьОбъект()
		{
		...
		public static V82.СправочникиСсылка.ХарактеристикиНоменклатуры ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ХарактеристикиНоменклатуры)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ХарактеристикиНоменклатуры(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
