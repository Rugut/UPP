...
namespace V82.СправочникиСсылка
{
	...
	public partial class Подразделения:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.Подразделения Родитель {get;set;}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Родитель = new V82.СправочникиСсылка.Подразделения((byte[])Читалка.GetValue(4),Глубина+1);
							...
							Наименование = Читалка.GetString(6);
								...
								ВидЦФО = new V82.СправочникиСсылка.ВидыЦФО((byte[])Читалка.GetValue(8),Глубина+1);
		...
		public static V82.СправочникиСсылка.Подразделения ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.Подразделения)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.Подразделения(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
