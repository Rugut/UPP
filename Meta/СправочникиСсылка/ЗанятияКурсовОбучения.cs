...
namespace V82.СправочникиСсылка
{
	...
	public partial class ЗанятияКурсовОбучения:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public string/*(0)*/ ОписаниеЗанятия {get;set;}//Описание занятия
		///<summary>
		///Длительность занятия в часах
		///</summary>
		public decimal/*(6.2)*/ ДлительностьЗанятия {get;set;}//Длительность занятия
		public V82.СправочникиСсылка.ФормыОбучения ВидЗанятия {get;set;}//Вид занятия
		
		public ЗанятияКурсовОбучения()
		{
		}
		...
		public V82.СправочникиОбъект.ЗанятияКурсовОбучения  ПолучитьОбъект()
		{
			...
			Объект.ОписаниеЗанятия = ОписаниеЗанятия;
			Объект.ДлительностьЗанятия = ДлительностьЗанятия;
			Объект.ВидЗанятия = ВидЗанятия;
			return Объект;
		}
		
		private static readonly Hashtable Кэш = new Hashtable(1000);
		
		public static V82.СправочникиСсылка.ЗанятияКурсовОбучения ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ЗанятияКурсовОбучения)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ЗанятияКурсовОбучения(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
