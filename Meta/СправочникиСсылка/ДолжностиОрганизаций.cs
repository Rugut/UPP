...
namespace V82.СправочникиСсылка
{
	...
	public partial class ДолжностиОрганизаций:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ДолжностиОрганизаций(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Наименование = Читалка.GetString(5);
								КодПозицииСписка = new V82.СправочникиСсылка.СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения((byte[])Читалка.GetValue(6),Глубина+1);
								ОснованиеВыслугиЛет = new V82.СправочникиСсылка.ОснованияВыслугиЛет((byte[])Читалка.GetValue(7),Глубина+1);
								...
								Должность = new V82.СправочникиСсылка.Должности((byte[])Читалка.GetValue(11),Глубина+1);
