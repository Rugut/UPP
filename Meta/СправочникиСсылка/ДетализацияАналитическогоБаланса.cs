...
namespace V82.СправочникиСсылка
{
	...
	public partial class ДетализацияАналитическогоБаланса:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public ДетализацияАналитическогоБаланса()
		{
		}
		
		public ДетализацияАналитическогоБаланса(byte[] УникальныйИдентификатор)
			: this(УникальныйИдентификатор,0)
		{
		}
		
		public ДетализацияАналитическогоБаланса(byte[] УникальныйИдентификатор,int Глубина)
		{
			if (Глубина>3)
			{
				return;
		...
		public static V82.СправочникиСсылка.ДетализацияАналитическогоБаланса ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ДетализацияАналитическогоБаланса)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ДетализацияАналитическогоБаланса(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
