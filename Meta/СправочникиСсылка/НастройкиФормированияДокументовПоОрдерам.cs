...
namespace V82.СправочникиСсылка
{
	...
	public partial class НастройкиФормированияДокументовПоОрдерам:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.НастройкиФормированияДокументовПоОрдерам Родитель {get;set;}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Родитель = new V82.СправочникиСсылка.НастройкиФормированияДокументовПоОрдерам((byte[])Читалка.GetValue(4),Глубина+1);
							...
							if(!ЭтоГруппа)
							{
								...
								ПериодДетализации = V82.Перечисления/*Ссылка*/.Периодичность.ПустаяСсылка.Получить((byte[])Читалка.GetValue(11));
								...
								ГраницаОбработки = Читалка.GetDateTime(15);
								ВидРегулярногоДокумента = Читалка.GetString(19);
								НеОбрабатыватьВсеДокументы = ((byte[])Читалка.GetValue(20))[0]==1;
								Задержка = Читалка.GetDecimal(21);
							}
							//return Ссылка;
						}
						else
