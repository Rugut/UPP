...
namespace V82.СправочникиСсылка
{
	...
	public partial class ВидыОплатЧекаККМ:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.ВидыОплатЧекаККМ Родитель {get;set;}
		...
		public static V82.СправочникиСсылка.ВидыОплатЧекаККМ ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ВидыОплатЧекаККМ)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ВидыОплатЧекаККМ(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
