...
namespace V82.СправочникиСсылка
{
	[ProtoContract]
	[DataContract]
	public partial class ТарифныеРазряды:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		public static readonly Guid ГуидКласса = new Guid("da2d0091-ddb4-4a84-a1a0-48c36bc8bf73");
		...
		public V82.СправочникиСсылка.ТарифныеРазряды Родитель {get;set;}
		...
		public ТарифныеРазряды()
		{
		}
		
		public ТарифныеРазряды(byte[] УникальныйИдентификатор)
		...
		public V82.СправочникиОбъект.ТарифныеРазряды  ПолучитьОбъект()
		{
