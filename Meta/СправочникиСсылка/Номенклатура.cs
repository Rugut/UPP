				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							ВидНоменклатуры = new V82.СправочникиСсылка.ВидыНоменклатуры((byte[])Читалка.GetValue(16),Глубина+1);
							ЕдиницаДляОтчетов = new V82.СправочникиСсылка.ЕдиницыИзмерения((byte[])Читалка.GetValue(17),Глубина+1);
							ЕдиницаХраненияОстатков = new V82.СправочникиСсылка.ЕдиницыИзмерения((byte[])Читалка.GetValue(18),Глубина+1);
							БазоваяЕдиницаИзмерения = new V82.СправочникиСсылка.КлассификаторЕдиницИзмерения((byte[])Читалка.GetValue(19),Глубина+1);
							Набор = ((byte[])Читалка.GetValue(20))[0]==1;
							НазначениеИспользования = new V82.СправочникиСсылка.НазначенияИспользования((byte[])Читалка.GetValue(21),Глубина+1);
							...
							НоменклатурнаяГруппаЗатрат = new V82.СправочникиСсылка.НоменклатурныеГруппы((byte[])Читалка.GetValue(24),Глубина+1);
							Услуга = ((byte[])Читалка.GetValue(25))[0]==1;
							ОсновноеИзображение = new V82.СправочникиСсылка.ХранилищеДополнительнойИнформации((byte[])Читалка.GetValue(26),Глубина+1);
							ОсновнойПоставщик = new V82.СправочникиСсылка.Контрагенты((byte[])Читалка.GetValue(27),Глубина+1);
							ОтветственныйМенеджерЗаПокупки = new V82.СправочникиСсылка.Пользователи((byte[])Читалка.GetValue(28),Глубина+1);
							НоменклатурнаяГруппа = new V82.СправочникиСсылка.НоменклатурныеГруппы((byte[])Читалка.GetValue(29),Глубина+1);
							СтранаПроисхождения = new V82.СправочникиСсылка.КлассификаторСтранМира((byte[])Читалка.GetValue(30),Глубина+1);
							НомерГТД = new V82.СправочникиСсылка.НомераГТД((byte[])Читалка.GetValue(31),Глубина+1);
							ТребуетсяВнешняяСертификация = ((byte[])Читалка.GetValue(32))[0]==1;
							ТребуетсяВнутренняяСертификация = ((byte[])Читалка.GetValue(33))[0]==1;
							СтатьяЗатрат = new V82.СправочникиСсылка.СтатьиЗатрат((byte[])Читалка.GetValue(34),Глубина+1);
							...
							НаправлениеСписанияВыпущеннойПродукции = new V82.СправочникиСсылка.НаправленияСписанияВыпущеннойПродукции((byte[])Читалка.GetValue(38),Глубина+1);
							ПорядокПрисвоенияСерийногоНомера = new V82.СправочникиСсылка.ПорядокПрисвоенияСерийныхНомеров((byte[])Читалка.GetValue(39),Глубина+1);
							ЦеноваяГруппа = new V82.СправочникиСсылка.ЦеновыеГруппы((byte[])Читалка.GetValue(40),Глубина+1);
							ОКП = new V82.СправочникиСсылка.ОбщероссийскийКлассификаторПродукции((byte[])Читалка.GetValue(41),Глубина+1);
							ЕдиницаИзмеренияМест = new V82.СправочникиСсылка.ЕдиницыИзмерения((byte[])Читалка.GetValue(42),Глубина+1);
							ДополнительноеОписаниеНоменклатуры = Читалка.GetString(43);
							Производитель = new V82.СправочникиСсылка.Контрагенты((byte[])Читалка.GetValue(44),Глубина+1);
							Импортер = new V82.СправочникиСсылка.Контрагенты((byte[])Читалка.GetValue(45),Глубина+1);
							//return Ссылка;
						}
						else
						{
