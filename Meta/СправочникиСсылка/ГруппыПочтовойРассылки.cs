...
namespace V82.СправочникиСсылка
{
	...
	public partial class ГруппыПочтовойРассылки:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.ГруппыПочтовойРассылки Родитель {get;set;}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Родитель = new V82.СправочникиСсылка.ГруппыПочтовойРассылки((byte[])Читалка.GetValue(4),Глубина+1);
		...
		public V82.СправочникиОбъект.ГруппыПочтовойРассылки  ПолучитьОбъект()
		{
		...
		public static V82.СправочникиСсылка.ГруппыПочтовойРассылки ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ГруппыПочтовойРассылки)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ГруппыПочтовойРассылки(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
