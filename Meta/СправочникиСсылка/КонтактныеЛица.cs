...
namespace V82.СправочникиСсылка
{
	...
	public partial class КонтактныеЛица:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public static V82.СправочникиСсылка.КонтактныеЛица ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.КонтактныеЛица)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.КонтактныеЛица(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
