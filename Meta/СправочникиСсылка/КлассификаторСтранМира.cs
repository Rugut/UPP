...
namespace V82.СправочникиСсылка
{
	...
	public partial class КлассификаторСтранМира:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public static V82.СправочникиСсылка.КлассификаторСтранМира ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.КлассификаторСтранМира)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.КлассификаторСтранМира(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
