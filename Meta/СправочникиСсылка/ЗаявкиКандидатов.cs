...
namespace V82.СправочникиСсылка
{
	...
	public partial class ЗаявкиКандидатов:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public static V82.СправочникиСсылка.ЗаявкиКандидатов ВзятьИзКэша(byte[] УникальныйИдентификатор)
		{
			var УИ = new Guid(УникальныйИдентификатор);
			if (Кэш.ContainsKey(УИ))
			{
				return (V82.СправочникиСсылка.ЗаявкиКандидатов)Кэш[УИ];
			}
			var Ссылка = new V82.СправочникиСсылка.ЗаявкиКандидатов(УникальныйИдентификатор);
			Кэш.Add(УИ, Ссылка);
			return Ссылка;
		}
