...
namespace V82.СправочникиСсылка
{
	...
	public partial class РабочиеЦентры:СправочникСсылка,IСериализаторProtoBuf,IСериализаторJson
	{
		...
		public V82.СправочникиСсылка.РабочиеЦентры Родитель {get;set;}
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Родитель = new V82.СправочникиСсылка.РабочиеЦентры((byte[])Читалка.GetValue(4),Глубина+1);
							...
							if(!ЭтоГруппа)
							{
								...
								ТребуетсяЗагрузкаПодчиненныхРабочихЦентров = ((byte[])Читалка.GetValue(10))[0]==1;
							}
							//return Ссылка;
						}
						else
