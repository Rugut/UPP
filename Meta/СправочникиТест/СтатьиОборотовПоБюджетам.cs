	...
	public partial class СтатьиОборотовПоБюджетам: СправочникТест
	{
		...
		public static void Создать1000()
		{
			...
			for (var НомерЭлемента = 1;НомерЭлемента < 1000;НомерЭлемента++)
			{
				...
				Объект.ИсточникДанныхДляЦены = V82.Справочники/*Менеджер*/.ИсточникиДанныхДляРасчетовБюджетирования.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(999)) ?? new V82.СправочникиСсылка.ИсточникиДанныхДляРасчетовБюджетирования();
				Объект.ПоказательИсточникаДанныхДляЦены = ГенераторСлучайныхЧисел.СлучайноеРусскоеСлово(3, 50);
				Объект.ИсточникДанныхДляФакта = V82.Справочники/*Менеджер*/.ИсточникиДанныхДляРасчетовБюджетирования.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(999)) ?? new V82.СправочникиСсылка.ИсточникиДанныхДляРасчетовБюджетирования();
				Объект.ПоказательИсточникаДанныхДляФактаСум = ГенераторСлучайныхЧисел.СлучайноеРусскоеСлово(3, 100);
				...
				Объект.ПоказательИсточникаДанныхДляФактаКол = ГенераторСлучайныхЧисел.СлучайноеРусскоеСлово(3, 100);
				...
				Объект.ОсновнаяВалюта = V82.Справочники/*Менеджер*/.Валюты.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(99)) ?? new V82.СправочникиСсылка.Валюты();
				Объект.ОсновноеЦФО = V82.Справочники/*Менеджер*/.Подразделения.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(999)) ?? new V82.СправочникиСсылка.Подразделения();
				Объект.ОсновнойПроект = V82.Справочники/*Менеджер*/.Проекты.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(999)) ?? new V82.СправочникиСсылка.Проекты();
				Объект.ОсновнойКонтрагент = V82.Справочники/*Менеджер*/.Контрагенты.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(999)) ?? new V82.СправочникиСсылка.Контрагенты();
				Объект.Комментарий = ГенераторСлучайныхЧисел.СлучайноеРусскоеСлово(3, 255);
				Объект.КоэффициентДляФактаСум = ГенераторСлучайныхЧисел.Следующий(99999999);
				Объект.КоэффициентДляФактаКол = ГенераторСлучайныхЧисел.Следующий(99999999);
