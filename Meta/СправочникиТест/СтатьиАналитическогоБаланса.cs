...
{
	public partial class СтатьиАналитическогоБаланса: СправочникТест
	{
		...
		public static void СериализацияJson1000()
		{
			var Старт = DateTime.Now;
			Console.WriteLine("--------------------------------------------------------------------");
			Console.WriteLine("СериализацияJson 1000 элементов справочника СтатьиАналитическогоБаланса. Старт: " + Старт.ToString("dd.MM.yy HH:mm:ss.fff") + ".");
			var НомерЭлемента = 0;
			foreach (var Ссылка in V82.Справочники/*Менеджер*/.СтатьиАналитическогоБаланса.Выбрать())
			{
				НомерЭлемента++;
