	...
	public partial class ФизическиеЛица: СправочникТест
	{
		...
		public static void Создать1000()
		{
			...
			for (var НомерЭлемента = 1;НомерЭлемента < 1000;НомерЭлемента++)
			{
				...
				Объект.ГруппаДоступаФизическогоЛица = V82.Справочники/*Менеджер*/.ГруппыДоступаФизическихЛиц.НайтиПоКоду(ГенераторСлучайныхЧисел.Следующий(999)) ?? new V82.СправочникиСсылка.ГруппыДоступаФизическихЛиц();
