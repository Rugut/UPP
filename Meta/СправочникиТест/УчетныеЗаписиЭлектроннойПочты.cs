	...
	public partial class УчетныеЗаписиЭлектроннойПочты: СправочникТест
	{
		...
		public static void Создать1000()
		{
			...
			for (var НомерЭлемента = 1;НомерЭлемента < 1000;НомерЭлемента++)
			{
				...
				Объект.ПортSMTP = ГенераторСлучайныхЧисел.Следующий(999);
				Объект.ПортPOP3 = ГенераторСлучайныхЧисел.Следующий(999);
				...
				Объект.ВремяОжиданияСервера = ГенераторСлучайныхЧисел.Следующий(999);
				...
				Объект.КоличествоДнейУдаленияПисемССервера = ГенераторСлучайныхЧисел.Следующий(99);
				...
				Объект.ИнтервалАвтоПолученияОтправкиСообщений = ГенераторСлучайныхЧисел.Следующий(9);
				...
				Объект.ИнтервалАвтоматическойУстановкиОтметкиРассмотрено = ГенераторСлучайныхЧисел.Следующий(9);
				...
				Объект.ИнтервалАвтосохраненияПисем = ГенераторСлучайныхЧисел.Следующий(99);
