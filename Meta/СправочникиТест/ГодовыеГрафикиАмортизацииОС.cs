	...
	public partial class ГодовыеГрафикиАмортизацииОС: СправочникТест
	{
		...
		public static void Создать1000()
		{
			...
			for (var НомерЭлемента = 1;НомерЭлемента < 1000;НомерЭлемента++)
			{
				...
				Объект.Коэффициент1 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент2 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент3 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент4 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент5 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент6 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент7 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент8 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент9 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент10 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент11 = ГенераторСлучайныхЧисел.Следующий(999999);
				Объект.Коэффициент12 = ГенераторСлучайныхЧисел.Следующий(999999);
