...
namespace V82.Справочники//Менеджер
{
	...
	public partial class Должности:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.Должности НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.Должности Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2270 [Требования],_Fld2271 [Обязанности],_Fld2272 [Условия],_Fld2273 [УдалитьНазваниеВакансииВСМИ],_Fld2274RRef [АнкетаРезюмеКандидата]
		 From _Reference91(NOLOCK)";
