...
namespace V82.Справочники//Менеджер
{
	public partial class КонтактныеЛица:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.КонтактныеЛица НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.КонтактныеЛица Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2448 [Фамилия],_Fld2449 [Имя],_Fld2450 [КоличествоДнейДоНапоминания],_Fld2451 [НапоминатьОДнеРождения],_Fld2452 [Отчество],_Fld2453 [ДатаРождения],_Fld2454 [Описание],_Fld2455RRef [Пол]
		 From _Reference128(NOLOCK)";
