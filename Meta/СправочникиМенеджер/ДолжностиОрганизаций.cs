...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ДолжностиОрганизаций:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ДолжностиОрганизаций НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ДолжностиОрганизаций Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2276RRef [КодПозицииСписка],_Fld2277RRef [ОснованиеВыслугиЛет],_Fld2278 [АУП],_Fld2279RRef [КатегорияВоинскогоУчета],_Fld2280 [КодПоОКПДТР],_Fld2281RRef [Должность],_Fld2282RRef [КатегорияСтатистическогоУчета],_Fld2283 [ЯвляетсяДолжностьюЛетногоЭкипажа],_Fld2284 [ЯвляетсяШахтерскойДолжностью],_Fld2285RRef [КатегорияУчетаЗабронированных],_Fld2286 [ЯвляетсяФармацевтическойДолжностью]
		 From _Reference92(NOLOCK)";
