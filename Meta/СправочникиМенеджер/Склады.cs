...
namespace V82.Справочники//Менеджер
{
	...
	public partial class Склады:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.Склады НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.Склады Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3427 [Комментарий],_Fld3428RRef [ТипЦенРозничнойТорговли],_Fld3429RRef [Подразделение],_Fld3430RRef [ВидСклада],_Fld3431 [НомерСекции],_Fld3432 [РасчетРозничныхЦенПоТорговойНаценке]
		 From _Reference229(NOLOCK)";
