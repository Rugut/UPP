...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ВычетыНДФЛ:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ВычетыНДФЛ НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ВычетыНДФЛ Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2017 [КодДляОтчетности2007],_Fld2018 [КодДляОтчетности2008],_Fld2019 [КодДляОтчетности2009],_Fld2020 [Наименование2007],_Fld2021 [Наименование2008],_Fld2022 [КодДляОтчетности2010],_Fld2023 [НеПредоставляетсяНерезидентам],_Fld2024 [НеОтражаетсяВОтчетности2010],_Fld2025RRef [ГруппаВычета],_Fld2026 [Наименование2010],_Fld2027 [КодДляОтчетности2011]
		 From _Reference70(NOLOCK)";
