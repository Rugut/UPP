...
namespace V82.Справочники//Менеджер
{
	public partial class МедицинскиеСтраховыеПолисы:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.МедицинскиеСтраховыеПолисы НайтиПоСсылке(Guid _Ссылка)
		{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Наименование = Читалка.GetString(5);
								...
								Ссылка.ПрограммаСтрахования = V82.СправочникиСсылка.ПрограммыМедицинскогоСтрахования.ВзятьИзКэша((byte[])Читалка.GetValue(11));
								Ссылка.СтрахованиеРодственника = ((byte[])Читалка.GetValue(12))[0]==1;
								...
								Ссылка.ДокументВид = V82.СправочникиСсылка.ДокументыУдостоверяющиеЛичность.ВзятьИзКэша((byte[])Читалка.GetValue(19));
		...
		public static СправочникиВыборка.МедицинскиеСтраховыеПолисы ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.МедицинскиеСтраховыеПолисы ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
