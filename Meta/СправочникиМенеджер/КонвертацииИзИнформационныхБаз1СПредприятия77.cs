...
namespace V82.Справочники//Менеджер
{
	...
	public partial class КонвертацииИзИнформационныхБаз1СПредприятия77:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.КонвертацииИзИнформационныхБаз1СПредприятия77 НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.КонвертацииИзИнформационныхБаз1СПредприятия77 Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2436 [ИдентификаторКонфигурации],_Fld2437 [Конфигурация],_Fld2438 [НомерРелиза],_Fld2439 [КонвертацияПомощник],_Fld2440 [КонвертацияОбработка],_Fld2441 [КонвертацияПравила],_Fld2442 [ХранилищеПомощник],_Fld2443 [ХранилищеОписаниеПомощника],_Fld2444 [ХранилищеОбработка],_Fld2445 [ХранилищеПравила],_Fld2446 [ИдентификаторЭлемента]
		 From _Reference127(NOLOCK)";
