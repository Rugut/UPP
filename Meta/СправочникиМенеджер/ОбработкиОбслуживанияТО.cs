...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ОбработкиОбслуживанияТО:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ОбработкиОбслуживанияТО НайтиПоКоду(decimal Код)
		{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Версия = Читалка.GetDecimal(10);
							Ссылка.Идентификатор = Читалка.GetString(11);
							Ссылка.ВерсияAPI = Читалка.GetDecimal(12);
							return Ссылка;
						}
						else
						{
		...
		public static СправочникиВыборка.ОбработкиОбслуживанияТО Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2990 [Описание],_Fld2991RRef [Вид],_Fld2992 [ИмяФайла],_Fld2993 [Обработка],_Fld2994 [Версия],_Fld2995 [Идентификатор],_Fld2996 [ВерсияAPI]
		 From _Reference168(NOLOCK)";
