...
namespace V82.Справочники//Менеджер
{
	...
	public partial class Бюджеты:СправочникМенеджер
	{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Родитель = V82.СправочникиСсылка.Бюджеты.ВзятьИзКэша((byte[])Читалка.GetValue(4));
							...
							if(!Ссылка.ЭтоГруппа)
							{
								...
								Ссылка.ВидБюджета = V82.Перечисления/*Ссылка*/.ВидыБюджетов.ПустаяСсылка.Получить((byte[])Читалка.GetValue(8));
		...
		public static СправочникиВыборка.Бюджеты ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.Бюджеты ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
