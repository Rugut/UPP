		...
		public static СправочникиВыборка.ПоказателиСхемМотивации Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld3222RRef [ТипПоказателя],_Fld3223RRef [ВозможностьИзменения],_Fld3224RRef [ВидПоказателя],_Fld3225 [ПоказательЭффективности],_Fld3226 [Идентификатор],_Fld3227 [ТарифнаяСтавка],_Fld3228RRef [ФактическийПоказатель],_Fld3229RRef [СпособРасчетаСуммы],_Fld3230RRef [СуммируемыйПоказатель],_Fld3231RRef [Валюта],_Fld3232RRef [ВидСтажа]
