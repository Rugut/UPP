		...
		public static СправочникиВыборка.ГрафикиРаботы Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld2043RRef [ВидГрафика],_Fld2044 [СуммированныйУчетРабочегоВремени],_Fld2045RRef [ПервыйВыходной],_Fld2046RRef [ВторойВыходной],_Fld2047 [ДатаОтсчета],_Fld2048 [ДлительностьРабочейНедели],_Fld2049 [СокращенноеРабочееВремя],_Fld2050RRef [ГрафикПолногоРабочегоВремени],_Fld2051 [НачалоДневныхЧасов],_Fld2052 [НачалоВечернихЧасов],_Fld2053 [НачалоНочныхЧасов],_Fld2054 [СокращеннаяРабочаяНеделя],_Fld2055 [НеполныйРабочийДень],_Fld2056 [УчитыватьПраздники],_Fld2057 [УчитыватьВечерниеЧасы],_Fld2058 [УчитыватьНочныеЧасы],_Fld2059RRef [ШаблонЗаполнения],_Fld2060 [УдалитьВыходныеПоСкользящемуГрафику]
