...
namespace V82.Справочники//Менеджер
{
	...
	public partial class СтатьиОборотовПоБюджетам:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.СтатьиОборотовПоБюджетам НайтиПоКоду(decimal Код)
		{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.КоэффициентДляФактаСум = Читалка.GetDecimal(24);
							Ссылка.КоэффициентДляФактаКол = Читалка.GetDecimal(25);
							return Ссылка;
						}
						else
						{
		...
		public static СправочникиВыборка.СтатьиОборотовПоБюджетам Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3816 [НаименованиеПолное],_Fld3817 [УчетПоКоличеству],_Fld3818 [УчетПоСумме],_Fld3819RRef [ИсточникДанныхДляЦены],_Fld3820 [ПоказательИсточникаДанныхДляЦены],_Fld3821RRef [ИсточникДанныхДляФакта],_Fld3822 [ПоказательИсточникаДанныхДляФактаСум],_Fld3823RRef [СпособОпределенияВалютыОборотаФакт],_Fld3824 [ПоказательИсточникаДанныхДляФактаКол],_Fld3825RRef [ЕдиницаИзмерения],_Fld3826 [РазделениеПоКонтрагентам],_Fld3827 [РазделениеПоНоменклатуре],_Fld3828RRef [ОсновнаяВалюта],_Fld3829RRef [ОсновноеЦФО],_Fld3830RRef [ОсновнойПроект],_Fld3831RRef [ОсновнойКонтрагент],_Fld3832RRef [ОсновнаяНоменклатура],_Fld3833 [Комментарий],_Fld3834 [КоэффициентДляФактаСум],_Fld3835 [КоэффициентДляФактаКол]
		 From _Reference249(NOLOCK)";
