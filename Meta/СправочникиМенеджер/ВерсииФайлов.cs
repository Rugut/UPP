...
namespace V82.Справочники//Менеджер
{
	public partial class ВерсииФайлов:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ВерсииФайлов НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ВерсииФайлов Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld1895RRef [Автор],_Fld1896 [ДатаМодификацииУниверсальная],_Fld1897 [ДатаСоздания],_Fld1898 [Зашифрован],_Fld1899 [ИндексКартинки],_Fld1900 [Комментарий],_Fld1901 [НомерВерсии],_Fld1902 [ПодписанЭЦП],_Fld1903 [ПолноеНаименование],_Fld1904 [ПутьКФайлу],_Fld1905 [Размер],_Fld1906 [Расширение],_Fld1907RRef [РодительскаяВерсия],_Fld1908RRef [СтатусИзвлеченияТекста],_Fld1909 [ТекстХранилище],_Fld1910RRef [ТипХраненияФайла],_Fld1911RRef [Том],_Fld1912 [ФайлХранилище]
		 From _Reference44(NOLOCK)";
