...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ДоверенностиНалогоплательщика:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ДоверенностиНалогоплательщика НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ДоверенностиНалогоплательщика Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2116 [НомерДовер],_Fld2117 [ДатаВыдачи],_Fld2118 [ДатаОкончания],_Fld2119 [ПризнакДоверителя],_Fld2120 [ДоверительЮЛ_НаимОрг],_Fld2121 [ДоверительЮЛ_ИНН],_Fld2122 [ДоверительЮЛ_КПП],_Fld2123 [ДоверительЮЛ_ОГРН],_Fld2124 [ДоверительРук_ИНН],_Fld2125 [ДоверительФЛ_ИНН],_Fld2126 [ДоверительФЛ_ОГРН],_Fld2127RRef [ДоверительФЛ_Гражданство],_Fld2128 [ДоверительФЛ_ДатаРождения],_Fld2129 [ПредставительЮЛ_НаимОрг],_Fld2130 [ПредставительЮЛ_ИНН],_Fld2131 [ПредставительЮЛ_КПП],_Fld2132 [ПредставительЮЛ_ОГРН],_Fld2133 [ПредставительФЛ_ИНН],_Fld2134 [ПредставительФЛ_ОГРН],_Fld2135RRef [ПредставительФЛ_Гражданство],_Fld2136 [ПредставительФЛ_ДатаРождения],_Fld2137 [НотариусЮЛ_НаимОрг],_Fld2138 [НотариусЮЛ_ИНН],_Fld2139 [НотариусЮЛ_КПП],_Fld2140 [НотариусЮЛ_ОГРН],_Fld2141 [НотариусФЛ_ИНН],_Fld2142 [ДоверительЯвляетсяЮЛ],_Fld2143 [ПредставительЯвляетсяЮЛ],_Fld2144 [НотариусЯвляетсяЮЛ],_Fld2145 [ЗаверенаНотариально],_Fld2146 [ДоверительИмеетУЛ],_Fld2147 [ПредставительЯвляетсяСотрудником]
		 From _Reference85(NOLOCK)";
