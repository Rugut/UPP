...
namespace V82.Справочники//Менеджер
{
	public partial class ВидыОтправляемыхДокументов:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ВидыОтправляемыхДокументов НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ВидыОтправляемыхДокументов Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld1960 [Описание],_Fld1961 [Источник],_Fld1962RRef [ТипПолучателя],_Fld1963RRef [ТипДокумента]
		 From _Reference60(NOLOCK)";
