				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Весовой = ((byte[])Читалка.GetValue(8))[0]==1;
							Ссылка.ВесовойКоэффициентВхождения = Читалка.GetDecimal(9);
							Ссылка.ВестиОперативныйУчетОстатковНЗП = ((byte[])Читалка.GetValue(10))[0]==1;
							Ссылка.ВестиПартионныйУчетПоСериям = ((byte[])Читалка.GetValue(11))[0]==1;
							Ссылка.ВестиУчетПоСериям = ((byte[])Читалка.GetValue(12))[0]==1;
							Ссылка.ВестиУчетПоСериямВНЗП = ((byte[])Читалка.GetValue(13))[0]==1;
							Ссылка.ВестиУчетПоХарактеристикам = ((byte[])Читалка.GetValue(14))[0]==1;
							...
							Ссылка.ВидНоменклатуры = V82.СправочникиСсылка.ВидыНоменклатуры.ВзятьИзКэша((byte[])Читалка.GetValue(16));
							Ссылка.ЕдиницаДляОтчетов = V82.СправочникиСсылка.ЕдиницыИзмерения.ВзятьИзКэша((byte[])Читалка.GetValue(17));
							Ссылка.ЕдиницаХраненияОстатков = V82.СправочникиСсылка.ЕдиницыИзмерения.ВзятьИзКэша((byte[])Читалка.GetValue(18));
							Ссылка.БазоваяЕдиницаИзмерения = V82.СправочникиСсылка.КлассификаторЕдиницИзмерения.ВзятьИзКэша((byte[])Читалка.GetValue(19));
							Ссылка.Набор = ((byte[])Читалка.GetValue(20))[0]==1;
							Ссылка.НазначениеИспользования = V82.СправочникиСсылка.НазначенияИспользования.ВзятьИзКэша((byte[])Читалка.GetValue(21));
							...
							Ссылка.НоменклатурнаяГруппаЗатрат = V82.СправочникиСсылка.НоменклатурныеГруппы.ВзятьИзКэша((byte[])Читалка.GetValue(24));
							Ссылка.Услуга = ((byte[])Читалка.GetValue(25))[0]==1;
							Ссылка.ОсновноеИзображение = V82.СправочникиСсылка.ХранилищеДополнительнойИнформации.ВзятьИзКэша((byte[])Читалка.GetValue(26));
							Ссылка.ОсновнойПоставщик = V82.СправочникиСсылка.Контрагенты.ВзятьИзКэша((byte[])Читалка.GetValue(27));
							Ссылка.ОтветственныйМенеджерЗаПокупки = V82.СправочникиСсылка.Пользователи.ВзятьИзКэша((byte[])Читалка.GetValue(28));
							Ссылка.НоменклатурнаяГруппа = V82.СправочникиСсылка.НоменклатурныеГруппы.ВзятьИзКэша((byte[])Читалка.GetValue(29));
							Ссылка.СтранаПроисхождения = V82.СправочникиСсылка.КлассификаторСтранМира.ВзятьИзКэша((byte[])Читалка.GetValue(30));
							Ссылка.НомерГТД = V82.СправочникиСсылка.НомераГТД.ВзятьИзКэша((byte[])Читалка.GetValue(31));
							Ссылка.ТребуетсяВнешняяСертификация = ((byte[])Читалка.GetValue(32))[0]==1;
							Ссылка.ТребуетсяВнутренняяСертификация = ((byte[])Читалка.GetValue(33))[0]==1;
							Ссылка.СтатьяЗатрат = V82.СправочникиСсылка.СтатьиЗатрат.ВзятьИзКэша((byte[])Читалка.GetValue(34));
							Ссылка.ВестиСерийныеНомера = ((byte[])Читалка.GetValue(35))[0]==1;
							Ссылка.Комплект = ((byte[])Читалка.GetValue(36))[0]==1;
							Ссылка.НаправлениеВыпуска = V82.Перечисления/*Ссылка*/.НаправленияВыпуска.ПустаяСсылка.Получить((byte[])Читалка.GetValue(37));
							Ссылка.НаправлениеСписанияВыпущеннойПродукции = V82.СправочникиСсылка.НаправленияСписанияВыпущеннойПродукции.ВзятьИзКэша((byte[])Читалка.GetValue(38));
							Ссылка.ПорядокПрисвоенияСерийногоНомера = V82.СправочникиСсылка.ПорядокПрисвоенияСерийныхНомеров.ВзятьИзКэша((byte[])Читалка.GetValue(39));
							Ссылка.ЦеноваяГруппа = V82.СправочникиСсылка.ЦеновыеГруппы.ВзятьИзКэша((byte[])Читалка.GetValue(40));
							Ссылка.ОКП = V82.СправочникиСсылка.ОбщероссийскийКлассификаторПродукции.ВзятьИзКэша((byte[])Читалка.GetValue(41));
							Ссылка.ЕдиницаИзмеренияМест = V82.СправочникиСсылка.ЕдиницыИзмерения.ВзятьИзКэша((byte[])Читалка.GetValue(42));
							Ссылка.ДополнительноеОписаниеНоменклатуры = Читалка.GetString(43);
							Ссылка.Производитель = V82.СправочникиСсылка.Контрагенты.ВзятьИзКэша((byte[])Читалка.GetValue(44));
							Ссылка.Импортер = V82.СправочникиСсылка.Контрагенты.ВзятьИзКэша((byte[])Читалка.GetValue(45));
							return Ссылка;
						}
						else
						{
