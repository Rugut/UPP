		...
		public static СправочникиВыборка.НастройкиРасчетаЦеныНоменклатуры Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld2835 [ФормироватьДокументыАвтоматически],_Fld2836 [РегламентноеЗадание],_Fld2837 [НастройкиКомпоновщика],_Fld2838RRef [ТипЦен],_Fld2839RRef [ВидОтраженияВУчете],_Fld2840 [ПорядокФормированияЦены],_Fld2841 [Комментарий],_Fld2842RRef [НастройкаРасчетаСебестоимости],_Fld2843 [СоздаватьНовыйДокумент]
