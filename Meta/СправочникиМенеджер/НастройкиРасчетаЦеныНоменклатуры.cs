				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.ТипЦен = V82.СправочникиСсылка.ТипыЦенНоменклатуры.ВзятьИзКэша((byte[])Читалка.GetValue(8));
							...
							Ссылка.НастройкаРасчетаСебестоимости = V82.СправочникиСсылка.НастройкиРасчетаСебестоимости.ВзятьИзКэша((byte[])Читалка.GetValue(12));
							Ссылка.СоздаватьНовыйДокумент = ((byte[])Читалка.GetValue(13))[0]==1;
							return Ссылка;
						}
						else
						{
