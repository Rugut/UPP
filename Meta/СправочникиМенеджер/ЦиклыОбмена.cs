...
namespace V82.Справочники//Менеджер
{
	public partial class ЦиклыОбмена:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ЦиклыОбмена НайтиПоСсылке(Guid _Ссылка)
		{
		...
		public static СправочникиВыборка.ЦиклыОбмена ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.ЦиклыОбмена ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
