...
namespace V82.Справочники//Менеджер
{
	...
	public partial class СпособыРаспределенияЗатратНаВыпуск:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.СпособыРаспределенияЗатратНаВыпуск НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.СпособыРаспределенияЗатратНаВыпуск Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3740 [Комментарий],_Fld3741RRef [СпособРаспределенияЗатратНаВыпуск],_Fld3742RRef [ТипФильтраПриРаспределенииЗатратНаВыпуск],_Fld3743RRef [БазаРаспределенияЗатрат],_Fld3744RRef [ПоказательБазыРаспределения],_Fld3745RRef [ТипЦен],_Fld3746RRef [ОсновноеСырье],_Fld3747RRef [СпособРаспределенияЗатратПоПодразделениям],_Fld3748 [РаспределятьНаСобственнуюПродукцию],_Fld3749 [РаспределятьНаПродукциюСтороннегоПереработчика],_Fld3750 [РаспределятьНаПродукциюИзДавальческогоСырья],_Fld3751 [РаспределятьНаПодчиненныеПодразделения],_Fld3752 [РаспределятьНаНаработку],_Fld3753 [Процент],_Fld3754 [Коэффициент],_Fld3755RRef [ПорядокОкругления],_Fld3756 [НастройкиПостроителя],_Fld3757 [ИзменитьНаПроцент],_Fld3758 [ИзменитьНаКоэффициент],_Fld3759 [ОкруглитьДо],_Fld3760 [СхемаКомпоновкиДанных],_Fld3761RRef [Применимость],_Fld3762 [ИспользоватьПростоеРаспределение],_Fld3763RRef [НаправлениеРаспределения],_Fld3764 [КогдаПрименять],_Fld3765RRef [ТипБазыРаспределения]
		 From _Reference244(NOLOCK)";
