...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ПодразделенияОрганизаций:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ПодразделенияОрганизаций НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ПодразделенияОрганизаций Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3202RRef [ВидПодразделения],_Fld3203 [КодПоОКАТО],_Fld3204 [КПП],_Fld3205 [РайонныйКоэффициент],_Fld3206 [РайонныйКоэффициентРФ],_Fld3207RRef [ТерриториальныеУсловияПФР],_Fld3208 [Порядок],_Fld3209 [СоответствуетСудамПодФлагомРФ]
		 From _Reference192(NOLOCK)";
