		...
		public static СправочникиВыборка.ВложенияЭлектронныхПисем Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld1986RRef [Объект],_Fld1987 [ИмяФайла],_Fld1988 [Хранилище],_Fld1989 [ИДФайлаПочтовогоПисьма],_Fld1990RRef [Предмет],_Fld1991 [ТекстФайла]
