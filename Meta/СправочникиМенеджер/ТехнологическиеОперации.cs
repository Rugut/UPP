...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ТехнологическиеОперации:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ТехнологическиеОперации НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ТехнологическиеОперации Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3906RRef [ОсновнаяСтатьяЗатратНаПроизводство],_Fld3907RRef [СпособОтраженияЗарплатыВБухучете],_Fld3908RRef [ОсновнойСпособРаспределенияЗатратНаВыпуск],_Fld3909RRef [ОсновнаяНоменклатурнаяГруппа],_Fld3910 [Расценка],_Fld3911RRef [БазоваяЕдиницаИзмерения],_Fld3912RRef [Валюта],_Fld3913 [НормаВремени],_Fld3914 [Коэффициент]
		 From _Reference264(NOLOCK)";
