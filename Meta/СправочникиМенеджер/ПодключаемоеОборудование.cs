		...
		public static СправочникиВыборка.ПодключаемоеОборудование Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld3184 [ВерсияКомпоненты],_Fld3185 [ИдентификаторУстройства],_Fld3186 [УстройствоОтключено],_Fld3187 [УстройствоИспользуется],_Fld3188RRef [ОбработчикДрайвера],_Fld3189 [Параметры],_Fld3190RRef [РабочееМесто],_Fld3191RRef [ТипОборудования],_Fld3192 [ТребуетсяПереустановка]
