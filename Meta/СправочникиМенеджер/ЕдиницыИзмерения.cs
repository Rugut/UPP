...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ЕдиницыИзмерения:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ЕдиницыИзмерения НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ЕдиницыИзмерения Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2307RRef [ЕдиницаПоКлассификатору],_Fld2308 [Вес],_Fld2309 [Объем],_Fld2310 [Коэффициент],_Fld2311 [ПорогОкругления],_Fld2312 [ПредупреждатьОНецелыхМестах]
		 From _Reference97(NOLOCK)";
