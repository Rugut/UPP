...
namespace V82.Справочники//Менеджер
{
	public partial class НастройкиРасчетаСебестоимости:СправочникМенеджер
	{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Родитель = V82.СправочникиСсылка.НастройкиРасчетаСебестоимости.ВзятьИзКэша((byte[])Читалка.GetValue(4));
							...
							if(!Ссылка.ЭтоГруппа)
							{
								...
								Ссылка.НастройкаЗакрытияМесяца = V82.СправочникиСсылка.НастройкиЗакрытияМесяца.ВзятьИзКэша((byte[])Читалка.GetValue(8));
								...
								Ссылка.Задержка = Читалка.GetDecimal(12);
		...
		public static СправочникиВыборка.НастройкиРасчетаСебестоимости ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.НастройкиРасчетаСебестоимости ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
