...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ОстаткиОтпусковОрганизаций:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ОстаткиОтпусковОрганизаций НайтиПоСсылке(Guid _Ссылка)
		{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Наименование = Читалка.GetString(4);
								Ссылка.Сотрудник = V82.СправочникиСсылка.СотрудникиОрганизаций.ВзятьИзКэша((byte[])Читалка.GetValue(5));
		...
		public static СправочникиВыборка.ОстаткиОтпусковОрганизаций ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.ОстаткиОтпусковОрганизаций ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
