				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Активная = ((byte[])Читалка.GetValue(9))[0]==1;
							Ссылка.КодВерсии = Читалка.GetString(10);
							Ссылка.Комментарий = Читалка.GetString(11);
							Ссылка.Ответственный = V82.СправочникиСсылка.Пользователи.ВзятьИзКэша((byte[])Читалка.GetValue(12));
							Ссылка.ИспользоватьВозвратныеОтходы = ((byte[])Читалка.GetValue(13))[0]==1;
							Ссылка.ИспользоватьПараметрыВыпускаПродукции = ((byte[])Читалка.GetValue(14))[0]==1;
							Ссылка.ИспользоватьДокументацию = ((byte[])Читалка.GetValue(15))[0]==1;
							Ссылка.ИспользоватьВидНорматива = ((byte[])Читалка.GetValue(16))[0]==1;
							Ссылка.ИспользоватьВидВоспроизводства = ((byte[])Читалка.GetValue(17))[0]==1;
							Ссылка.ИспользоватьУказаниеНорматива = ((byte[])Читалка.GetValue(18))[0]==1;
							Ссылка.ИспользоватьФормулы = ((byte[])Читалка.GetValue(19))[0]==1;
							Ссылка.ИспользоватьУправлениеСписанием = ((byte[])Читалка.GetValue(20))[0]==1;
							Ссылка.Назначение = V82.СправочникиСсылка.НазначенияИспользованияСпецификаций.ВзятьИзКэша((byte[])Читалка.GetValue(21));
							return Ссылка;
						}
						else
						{
