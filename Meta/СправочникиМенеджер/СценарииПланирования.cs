				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.УчетПоСуммам = ((byte[])Читалка.GetValue(8))[0]==1;
							Ссылка.УчетПоКоличеству = ((byte[])Читалка.GetValue(9))[0]==1;
							Ссылка.Валюта = V82.СправочникиСсылка.Валюты.ВзятьИзКэша((byte[])Читалка.GetValue(10));
							...
							Ссылка.ИспользоватьКурсыСценария = ((byte[])Читалка.GetValue(16))[0]==1;
							return Ссылка;
						}
						else
						{
