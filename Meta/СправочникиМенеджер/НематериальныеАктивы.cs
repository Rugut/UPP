...
namespace V82.Справочники//Менеджер
{
	...
	public partial class НематериальныеАктивы:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.НематериальныеАктивы НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.НематериальныеАктивы Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2898 [НаименованиеПолное],_Fld2899RRef [ВидНМА],_Fld2900RRef [АмортизационнаяГруппа],_Fld2901 [ПрочиеСведения],_Fld2902RRef [ВидОбъектаУчета]
		 From _Reference161(NOLOCK)";
