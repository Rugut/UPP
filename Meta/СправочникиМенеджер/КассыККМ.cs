...
namespace V82.Справочники//Менеджер
{
	...
	public partial class КассыККМ:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.КассыККМ НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.КассыККМ Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld2388 [ФормироватьНефискальныеЧеки],_Fld2389 [ШиринаЛенты],_Fld2390 [РучнойРежимФормирования]
		 From _Reference110(NOLOCK)";
