...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ФизическиеЛица:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ФизическиеЛица НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ФизическиеЛица Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld4121 [ДатаРождения],_Fld4122 [ИНН],_Fld4123 [КодИМНС],_Fld4124 [Комментарий],_Fld4125 [СтраховойНомерПФР],_Fld4126RRef [Пол],_Fld4127 [МестоРождения],_Fld4128RRef [ОсновноеИзображение],_Fld4129 [МестоРожденияКодПоОКАТО],_Fld4130RRef [ГруппаДоступаФизическогоЛица],_Fld4131RRef [ЛьготаПриНачисленииПособий],_Fld4132 [ИмеетНаучныеТруды],_Fld4133 [ИмеетИзобретения]
		 From _Reference283(NOLOCK)";
