...
namespace V82.Справочники//Менеджер
{
	...
	public partial class ФизическиеЛица:СправочникМенеджер
	{
		...
		public static СправочникиВыборка.ФизическиеЛица ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.ФизическиеЛица ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
