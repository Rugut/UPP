...
namespace V82.Справочники//Менеджер
{
	...
	public partial class Организации:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.Организации НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.Организации Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3012 [Префикс],_Fld3013 [ИНН],_Fld3014 [КПП],_Fld3015 [РегистрационныйНомерПФР],_Fld3016RRef [ГоловнаяОрганизация],_Fld3017 [НаименованиеПолное],_Fld3018 [КодПоОКПО],_Fld3019 [КодПоОКАТО],_Fld3020 [КодИМНС],_Fld3021 [РайонныйКоэффициент],_Fld3022RRef [ЮрФизЛицо],_Fld3023RRef [ТерриториальныеУсловияПФР],_Fld3024RRef [ОсновнойБанковскийСчет],_Fld3025RRef [ВидСтавокЕСНиПФР],_Fld3026 [НаименованиеПлательщикаПриПеречисленииНалогов],_Fld3027 [ИностраннаяОрганизация],_Fld3028 [ДатаРегистрации],_Fld3029 [КодОКОПФ],_Fld3030 [НаименованиеОКОПФ],_Fld3031 [КодОКФС],_Fld3032 [НаименованиеОКФС],_Fld3033 [СвидетельствоСерияНомер],_Fld3034 [СвидетельствоДатаВыдачи],_Fld3035 [СвидетельствоНаименованиеОргана],_Fld3036 [СвидетельствоКодОргана],_Fld3037RRef [СтранаРегистрации],_Fld3038RRef [СтранаПостоянногоМестонахождения],_Fld3039 [КодВСтранеРегистрации],_Fld3040 [ОГРН],_Fld3041 [НаименованиеИнострОрганизации],_Fld3042 [РегистрационныйНомерФСС],_Fld3043 [НаименованиеИМНС],_Fld3044 [КодОКВЭД],_Fld3045 [НаименованиеОКВЭД],_Fld3046 [КодОКОНХ],_Fld3047RRef [ИндивидуальныйПредприниматель],_Fld3048 [УдалитьОбменЗадействован],_Fld3049 [ОбменКодАбонента],_Fld3050 [ОбменКаталогОтправкиДанныхОтчетности],_Fld3051 [ОбменКаталогПрограммыЭлектроннойПочты],_Fld3052 [РайонныйКоэффициентРФ],_Fld3053 [ОтражатьВРегламентированномУчете],_Fld3054 [КодИФНСПолучателя],_Fld3055 [НаименованиеТерриториальногоОрганаПФР],_Fld3056 [НаименованиеСокращенное],_Fld3057RRef [ВидОбменаСКонтролирующимиОрганами],_Fld3058RRef [УчетнаяЗаписьОбмена],_Fld3059 [КодОрганаПФР],_Fld3060 [КодОрганаФСГС],_Fld3061 [ДополнительныйКодФСС],_Fld3062 [КодПодчиненностиФСС],_Fld3063 [ЦифровойИндексОбособленногоПодразделения],_Fld3064 [РегистрационныйНомерТФОМС],_Fld3065 [ИПРегистрационныйНомерПФР],_Fld3066 [ИПРегистрационныйНомерФСС],_Fld3067 [ИПКодПодчиненностиФСС],_Fld3068 [ИПРегистрационныйНомерТФОМС],_Fld3069 [НаименованиеТерриториальногоОрганаФСС]
		 From _Reference172(NOLOCK)";
