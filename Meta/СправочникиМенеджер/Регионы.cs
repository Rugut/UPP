...
namespace V82.Справочники//Менеджер
{
	...
	public partial class Регионы:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.Регионы НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.Регионы Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld3359 [Комментарий],_Fld3360 [КодРегиона],_Fld3361 [КодАдресногоЭлемента],_Fld3362 [ЖДСтанцияНазначения]
		 From _Reference218(NOLOCK)";
