		...
		public static СправочникиВыборка.СпособыОтраженияЗарплатыВРеглУчете Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld3688RRef [СчетДт],_Fld3689RRef [СубконтоДт1],_Fld3690RRef [СубконтоДт2],_Fld3691RRef [СубконтоДт3],_Fld3692RRef [СпособРаспределенияЗатрат],_Fld3693RRef [СчетКт],_Fld3694RRef [СубконтоКт1],_Fld3695RRef [СубконтоКт2],_Fld3696RRef [СубконтоКт3],_Fld3697RRef [СчетДтНУ],_Fld3698RRef [СубконтоДтНУ1],_Fld3699RRef [СубконтоДтНУ2],_Fld3700RRef [СубконтоДтНУ3],_Fld3701RRef [СчетКтНУ],_Fld3702RRef [СубконтоКтНУ1],_Fld3703RRef [СубконтоКтНУ2],_Fld3704RRef [СубконтоКтНУ3],_Fld3705RRef [ОтражениеВУСН],_Fld3706RRef [ПодразделениеДт],_Fld3707RRef [ПодразделениеКт],_Fld3708RRef [ВидНачисленийОплатыТрудаПоСтатье255НК]
