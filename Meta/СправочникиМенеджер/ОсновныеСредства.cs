				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.Автотранспорт = ((byte[])Читалка.GetValue(6))[0]==1;
							...
							Ссылка.КодПоОКОФ = V82.СправочникиСсылка.ОбщероссийскийКлассификаторОсновныхФондов.ВзятьИзКэша((byte[])Читалка.GetValue(13));
							...
							Ссылка.Помещение = ((byte[])Читалка.GetValue(18))[0]==1;
