				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					using (var Читалка = Команда.ExecuteReader())
					{
						if (Читалка.Read())
						{
							...
							Ссылка.ПрофильПолномочийПользователя = V82.СправочникиСсылка.ПрофилиПолномочийПользователей.ВзятьИзКэша((byte[])Читалка.GetValue(6));
							Ссылка.ФизЛицо = V82.СправочникиСсылка.ФизическиеЛица.ВзятьИзКэша((byte[])Читалка.GetValue(7));
							return Ссылка;
						}
						else
						{
