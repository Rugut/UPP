		...
		public static СправочникиВыборка.НастройкиДопроведенияДокументов Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_Description [Наименование],_Fld2670 [ФормироватьДокументыАвтоматически],_Fld2671 [РегламентноеЗадание],_Fld2672 [Комментарий],_Fld2673 [ДопроводитьВсеДокументы],_Fld2674 [НомерДняКонецЗапуска],_Fld2675 [НомерДняНачалоЗапуска],_Fld2676 [НачалоИнтервалаДопроведения],_Fld2677 [КонецИнтервалаДопроведения],_Fld2678 [КоличествоПериодовОтставанияКонецИнтервала],_Fld2679 [КоличествоПериодовОтставанияНачалоИнтервала],_Fld2680RRef [ПериодичностьОтставанияКонецИнтервала],_Fld2681RRef [ПериодичностьОтставанияНачалоИнтервала],_Fld2682 [РассчитыватьКонецИнтервала],_Fld2683 [РассчитыватьНачалоИнтервала]
