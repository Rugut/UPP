...
namespace V82.Справочники//Менеджер
{
	...
	public partial class КлассификаторЕдиницИзмерения:СправочникМенеджер
	{
		...
		public static СправочникиВыборка.КлассификаторЕдиницИзмерения ИерархияВыбратьПоСсылке(Guid Родитель,int Режим,int Первые,Guid Мин,Guid Макс)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
		...
		public static СправочникиВыборка.КлассификаторЕдиницИзмерения ИерархияСтраницаПоСсылке(Guid Родитель,int Режим,int Размер,int Номер)
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				Подключение.Open();
