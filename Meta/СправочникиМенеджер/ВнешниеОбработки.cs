...
namespace V82.Справочники//Менеджер
{
	public partial class ВнешниеОбработки:СправочникМенеджер
	{
		...
		public static СправочникиСсылка.ВнешниеОбработки НайтиПоКоду(decimal Код)
		{
		...
		public static СправочникиВыборка.ВнешниеОбработки Выбрать()
		{
			using (var Подключение = new SqlConnection(СтрокаСоединения))
			{
				...
				using (var Команда = Подключение.CreateCommand())
				{
					...
					,_IsMetadata [Предопределенный]
					,_Code [Код]
					,_Description [Наименование],_Fld1994 [ХранилищеВнешнейОбработки],_Fld1995RRef [ВидОбработки],_Fld1996 [Комментарий],_Fld1997 [КомментарийКФайлуИсточнику]
		 From _Reference68(NOLOCK)";
