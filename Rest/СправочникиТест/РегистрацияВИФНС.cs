...
namespace V82.Rest.СправочникиТест
{
	public class РегистрацияВИФНС:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегистрацияВИФНС/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегистрацияВИФНС/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РегистрацияВИФНСЗапрос РегистрацияВИФНСЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегистрацияВИФНС/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РегистрацияВИФНСЗапрос РегистрацияВИФНСЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегистрацияВИФНС?format=json";
			var Клиент = new JsonServiceClient(Урл);
