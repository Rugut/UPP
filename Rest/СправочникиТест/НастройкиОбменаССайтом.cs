...
namespace V82.Rest.СправочникиТест
{
	public class НастройкиОбменаССайтом:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НастройкиОбменаССайтом/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НастройкиОбменаССайтом/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НастройкиОбменаССайтомЗапрос НастройкиОбменаССайтомЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НастройкиОбменаССайтом/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НастройкиОбменаССайтомЗапрос НастройкиОбменаССайтомЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НастройкиОбменаССайтом?format=json";
			var Клиент = new JsonServiceClient(Урл);
