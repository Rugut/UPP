...
namespace V82.Rest.СправочникиТест
{
	public class КодыОКПД:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КодыОКПД/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/КодыОКПД/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КодыОКПДЗапрос КодыОКПДЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КодыОКПД?format=json";
			var Клиент = new JsonServiceClient(Урл);
