...
namespace V82.Rest.СправочникиТест
{
	public class ВидыАнализовНоменклатуры:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыАнализовНоменклатуры/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыАнализовНоменклатуры/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыАнализовНоменклатурыЗапрос ВидыАнализовНоменклатурыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыАнализовНоменклатуры/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыАнализовНоменклатурыЗапрос ВидыАнализовНоменклатурыЗапрос = null;
			try
			{
