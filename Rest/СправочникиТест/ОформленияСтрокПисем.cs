...
namespace V82.Rest.СправочникиТест
{
	public class ОформленияСтрокПисем:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОформленияСтрокПисем/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОформленияСтрокПисем/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОформленияСтрокПисемЗапрос ОформленияСтрокПисемЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОформленияСтрокПисем/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОформленияСтрокПисемЗапрос ОформленияСтрокПисемЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОформленияСтрокПисем?format=json";
			var Клиент = new JsonServiceClient(Урл);
