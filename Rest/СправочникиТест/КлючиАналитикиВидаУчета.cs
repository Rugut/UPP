...
namespace V82.Rest.СправочникиТест
{
	public class КлючиАналитикиВидаУчета:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлючиАналитикиВидаУчета/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлючиАналитикиВидаУчета/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КлючиАналитикиВидаУчетаЗапрос КлючиАналитикиВидаУчетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлючиАналитикиВидаУчета?format=json";
			var Клиент = new JsonServiceClient(Урл);
