...
namespace V82.Rest.СправочникиТест
{
	public class ОстаткиОтпусковОрганизаций:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОстаткиОтпусковОрганизаций/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОстаткиОтпусковОрганизаций/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОстаткиОтпусковОрганизацийЗапрос ОстаткиОтпусковОрганизацийЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОстаткиОтпусковОрганизаций?format=json";
			var Клиент = new JsonServiceClient(Урл);
