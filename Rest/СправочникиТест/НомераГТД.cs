...
namespace V82.Rest.СправочникиТест
{
	public class НомераГТД:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НомераГТД/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НомераГТД/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НомераГТДЗапрос НомераГТДЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НомераГТД?format=json";
			var Клиент = new JsonServiceClient(Урл);
