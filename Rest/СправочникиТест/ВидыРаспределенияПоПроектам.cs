...
namespace V82.Rest.СправочникиТест
{
	public class ВидыРаспределенияПоПроектам:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыРаспределенияПоПроектам/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыРаспределенияПоПроектам/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыРаспределенияПоПроектамЗапрос ВидыРаспределенияПоПроектамЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыРаспределенияПоПроектам/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыРаспределенияПоПроектамЗапрос ВидыРаспределенияПоПроектамЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыРаспределенияПоПроектам?format=json";
			var Клиент = new JsonServiceClient(Урл);
