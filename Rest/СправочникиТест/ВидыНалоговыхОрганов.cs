...
namespace V82.Rest.СправочникиТест
{
	public class ВидыНалоговыхОрганов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыНалоговыхОрганов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыНалоговыхОрганов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыНалоговыхОргановЗапрос ВидыНалоговыхОргановЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыНалоговыхОрганов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыНалоговыхОргановЗапрос ВидыНалоговыхОргановЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыНалоговыхОрганов?format=json";
			var Клиент = new JsonServiceClient(Урл);
