...
namespace V82.Rest.СправочникиТест
{
	public class ТипыЗаписейЗаметок:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЗаписейЗаметок/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЗаписейЗаметок/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТипыЗаписейЗаметокЗапрос ТипыЗаписейЗаметокЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЗаписейЗаметок?format=json";
			var Клиент = new JsonServiceClient(Урл);
