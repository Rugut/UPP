...
namespace V82.Rest.СправочникиТест
{
	public class ВидыДисконтныхКарт:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыДисконтныхКарт/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыДисконтныхКарт/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыДисконтныхКартЗапрос ВидыДисконтныхКартЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыДисконтныхКарт/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыДисконтныхКартЗапрос ВидыДисконтныхКартЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыДисконтныхКарт?format=json";
			var Клиент = new JsonServiceClient(Урл);
