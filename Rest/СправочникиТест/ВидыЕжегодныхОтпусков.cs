...
namespace V82.Rest.СправочникиТест
{
	public class ВидыЕжегодныхОтпусков:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыЕжегодныхОтпусков/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыЕжегодныхОтпусков/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыЕжегодныхОтпусковЗапрос ВидыЕжегодныхОтпусковЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыЕжегодныхОтпусков/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыЕжегодныхОтпусковЗапрос ВидыЕжегодныхОтпусковЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыЕжегодныхОтпусков?format=json";
			var Клиент = new JsonServiceClient(Урл);
