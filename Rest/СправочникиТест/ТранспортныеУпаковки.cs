...
namespace V82.Rest.СправочникиТест
{
	public class ТранспортныеУпаковки:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ТранспортныеУпаковки/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ТранспортныеУпаковки/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТранспортныеУпаковкиЗапрос ТранспортныеУпаковкиЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ТранспортныеУпаковки/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТранспортныеУпаковкиЗапрос ТранспортныеУпаковкиЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ТранспортныеУпаковки?format=json";
			var Клиент = new JsonServiceClient(Урл);
