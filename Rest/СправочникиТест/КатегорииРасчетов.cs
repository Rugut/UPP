...
namespace V82.Rest.СправочникиТест
{
	public class КатегорииРасчетов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КатегорииРасчетов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/КатегорииРасчетов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КатегорииРасчетовЗапрос КатегорииРасчетовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КатегорииРасчетов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КатегорииРасчетовЗапрос КатегорииРасчетовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КатегорииРасчетов?format=json";
			var Клиент = new JsonServiceClient(Урл);
