...
namespace V82.Rest.СправочникиТест
{
	public class ВидыОплатЧекаККМ:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыОплатЧекаККМ/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыОплатЧекаККМ/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыОплатЧекаККМЗапрос ВидыОплатЧекаККМЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыОплатЧекаККМ/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыОплатЧекаККМЗапрос ВидыОплатЧекаККМЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ВидыОплатЧекаККМ?format=json";
			var Клиент = new JsonServiceClient(Урл);
