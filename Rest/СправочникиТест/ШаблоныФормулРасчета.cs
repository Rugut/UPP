...
namespace V82.Rest.СправочникиТест
{
	public class ШаблоныФормулРасчета:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ШаблоныФормулРасчета/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ШаблоныФормулРасчета/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ШаблоныФормулРасчетаЗапрос ШаблоныФормулРасчетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ШаблоныФормулРасчета/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ШаблоныФормулРасчетаЗапрос ШаблоныФормулРасчетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ШаблоныФормулРасчета?format=json";
			var Клиент = new JsonServiceClient(Урл);
