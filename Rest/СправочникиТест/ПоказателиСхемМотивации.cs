...
namespace V82.Rest.СправочникиТест
{
	public class ПоказателиСхемМотивации:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПоказателиСхемМотивации/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПоказателиСхемМотивации/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПоказателиСхемМотивацииЗапрос ПоказателиСхемМотивацииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПоказателиСхемМотивации?format=json";
			var Клиент = new JsonServiceClient(Урл);
