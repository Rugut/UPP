...
namespace V82.Rest.СправочникиТест
{
	public class СерверыДокументооборота:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СерверыДокументооборота/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СерверыДокументооборота/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СерверыДокументооборотаЗапрос СерверыДокументооборотаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СерверыДокументооборота/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СерверыДокументооборотаЗапрос СерверыДокументооборотаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СерверыДокументооборота?format=json";
			var Клиент = new JsonServiceClient(Урл);
