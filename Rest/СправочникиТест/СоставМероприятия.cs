...
namespace V82.Rest.СправочникиТест
{
	public class СоставМероприятия:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СоставМероприятия/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СоставМероприятия/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СоставМероприятияЗапрос СоставМероприятияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СоставМероприятия/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СоставМероприятияЗапрос СоставМероприятияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СоставМероприятия?format=json";
			var Клиент = new JsonServiceClient(Урл);
