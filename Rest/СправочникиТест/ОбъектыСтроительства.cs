...
namespace V82.Rest.СправочникиТест
{
	public class ОбъектыСтроительства:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбъектыСтроительства/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбъектыСтроительства/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОбъектыСтроительстваЗапрос ОбъектыСтроительстваЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбъектыСтроительства/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОбъектыСтроительстваЗапрос ОбъектыСтроительстваЗапрос = null;
			try
			{
