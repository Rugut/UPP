...
namespace V82.Rest.СправочникиТест
{
	public class ЗаявкиКандидатов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЗаявкиКандидатов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЗаявкиКандидатов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЗаявкиКандидатовЗапрос ЗаявкиКандидатовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЗаявкиКандидатов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЗаявкиКандидатовЗапрос ЗаявкиКандидатовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЗаявкиКандидатов?format=json";
			var Клиент = new JsonServiceClient(Урл);
