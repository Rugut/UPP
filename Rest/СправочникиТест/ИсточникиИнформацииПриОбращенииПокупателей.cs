...
namespace V82.Rest.СправочникиТест
{
	public class ИсточникиИнформацииПриОбращенииПокупателей:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ИсточникиИнформацииПриОбращенииПокупателей/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ИсточникиИнформацииПриОбращенииПокупателей/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ИсточникиИнформацииПриОбращенииПокупателейЗапрос ИсточникиИнформацииПриОбращенииПокупателейЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ИсточникиИнформацииПриОбращенииПокупателей/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ИсточникиИнформацииПриОбращенииПокупателейЗапрос ИсточникиИнформацииПриОбращенииПокупателейЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ИсточникиИнформацииПриОбращенииПокупателей?format=json";
			var Клиент = new JsonServiceClient(Урл);
