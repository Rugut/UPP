...
namespace V82.Rest.СправочникиТест
{
	public class НалоговыеОрганы:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НалоговыеОрганы/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НалоговыеОрганы/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НалоговыеОрганыЗапрос НалоговыеОрганыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НалоговыеОрганы/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НалоговыеОрганыЗапрос НалоговыеОрганыЗапрос = null;
			try
			{
