...
namespace V82.Rest.СправочникиТест
{
	public class СтрокиФинансовогоРасчета:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтрокиФинансовогоРасчета/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтрокиФинансовогоРасчета/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СтрокиФинансовогоРасчетаЗапрос СтрокиФинансовогоРасчетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтрокиФинансовогоРасчета/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СтрокиФинансовогоРасчетаЗапрос СтрокиФинансовогоРасчетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтрокиФинансовогоРасчета?format=json";
			var Клиент = new JsonServiceClient(Урл);
