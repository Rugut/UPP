...
namespace V82.Rest.СправочникиТест
{
	public class ПодразделенияОрганизаций:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПодразделенияОрганизаций/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПодразделенияОрганизаций/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПодразделенияОрганизацийЗапрос ПодразделенияОрганизацийЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПодразделенияОрганизаций/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПодразделенияОрганизацийЗапрос ПодразделенияОрганизацийЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПодразделенияОрганизаций?format=json";
			var Клиент = new JsonServiceClient(Урл);
