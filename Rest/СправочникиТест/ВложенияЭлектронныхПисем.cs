...
namespace V82.Rest.СправочникиТест
{
	public class ВложенияЭлектронныхПисем:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВложенияЭлектронныхПисем/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВложенияЭлектронныхПисем/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВложенияЭлектронныхПисемЗапрос ВложенияЭлектронныхПисемЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВложенияЭлектронныхПисем?format=json";
			var Клиент = new JsonServiceClient(Урл);
