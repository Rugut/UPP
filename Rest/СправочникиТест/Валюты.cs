...
namespace V82.Rest.СправочникиТест
{
	public class Валюты:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Валюты/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/Валюты/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВалютыЗапрос ВалютыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Валюты/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВалютыЗапрос ВалютыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Валюты?format=json";
			var Клиент = new JsonServiceClient(Урл);
