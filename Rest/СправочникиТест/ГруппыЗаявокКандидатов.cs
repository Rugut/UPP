...
namespace V82.Rest.СправочникиТест
{
	public class ГруппыЗаявокКандидатов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыЗаявокКандидатов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыЗаявокКандидатов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ГруппыЗаявокКандидатовЗапрос ГруппыЗаявокКандидатовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыЗаявокКандидатов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ГруппыЗаявокКандидатовЗапрос ГруппыЗаявокКандидатовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыЗаявокКандидатов?format=json";
			var Клиент = new JsonServiceClient(Урл);
