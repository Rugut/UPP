...
namespace V82.Rest.СправочникиТест
{
	public class ДокументыОбОбразовании:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДокументыОбОбразовании/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДокументыОбОбразовании/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДокументыОбОбразованииЗапрос ДокументыОбОбразованииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДокументыОбОбразовании/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДокументыОбОбразованииЗапрос ДокументыОбОбразованииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДокументыОбОбразовании?format=json";
			var Клиент = new JsonServiceClient(Урл);
