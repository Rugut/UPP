...
namespace V82.Rest.СправочникиТест
{
	public class ЕдиницыИзмерения:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЕдиницыИзмерения/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЕдиницыИзмерения/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЕдиницыИзмеренияЗапрос ЕдиницыИзмеренияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЕдиницыИзмерения/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЕдиницыИзмеренияЗапрос ЕдиницыИзмеренияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЕдиницыИзмерения?format=json";
			var Клиент = new JsonServiceClient(Урл);
