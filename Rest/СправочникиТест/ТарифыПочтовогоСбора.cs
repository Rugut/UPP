...
namespace V82.Rest.СправочникиТест
{
	public class ТарифыПочтовогоСбора:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифыПочтовогоСбора/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифыПочтовогоСбора/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТарифыПочтовогоСбораЗапрос ТарифыПочтовогоСбораЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифыПочтовогоСбора/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТарифыПочтовогоСбораЗапрос ТарифыПочтовогоСбораЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифыПочтовогоСбора?format=json";
			var Клиент = new JsonServiceClient(Урл);
