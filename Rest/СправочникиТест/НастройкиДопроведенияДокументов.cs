...
namespace V82.Rest.СправочникиТест
{
	public class НастройкиДопроведенияДокументов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НастройкиДопроведенияДокументов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НастройкиДопроведенияДокументов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НастройкиДопроведенияДокументовЗапрос НастройкиДопроведенияДокументовЗапрос = null;
			try
			{
