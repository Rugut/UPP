...
namespace V82.Rest.СправочникиТест
{
	public class ВариантыОтветовОпросов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыОтветовОпросов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыОтветовОпросов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВариантыОтветовОпросовЗапрос ВариантыОтветовОпросовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыОтветовОпросов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВариантыОтветовОпросовЗапрос ВариантыОтветовОпросовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыОтветовОпросов?format=json";
			var Клиент = new JsonServiceClient(Урл);
