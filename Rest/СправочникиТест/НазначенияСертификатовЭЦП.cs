...
namespace V82.Rest.СправочникиТест
{
	public class НазначенияСертификатовЭЦП:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НазначенияСертификатовЭЦП/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НазначенияСертификатовЭЦП/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НазначенияСертификатовЭЦПЗапрос НазначенияСертификатовЭЦПЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НазначенияСертификатовЭЦП/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НазначенияСертификатовЭЦПЗапрос НазначенияСертификатовЭЦПЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НазначенияСертификатовЭЦП?format=json";
			var Клиент = new JsonServiceClient(Урл);
