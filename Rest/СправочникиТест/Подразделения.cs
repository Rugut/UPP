...
namespace V82.Rest.СправочникиТест
{
	public class Подразделения:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Подразделения/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/Подразделения/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПодразделенияЗапрос ПодразделенияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Подразделения/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПодразделенияЗапрос ПодразделенияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Подразделения?format=json";
			var Клиент = new JsonServiceClient(Урл);
