...
namespace V82.Rest.СправочникиТест
{
	public class ОбработкиОбслуживанияТО:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбработкиОбслуживанияТО/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбработкиОбслуживанияТО/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОбработкиОбслуживанияТОЗапрос ОбработкиОбслуживанияТОЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбработкиОбслуживанияТО/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОбработкиОбслуживанияТОЗапрос ОбработкиОбслуживанияТОЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОбработкиОбслуживанияТО?format=json";
			var Клиент = new JsonServiceClient(Урл);
