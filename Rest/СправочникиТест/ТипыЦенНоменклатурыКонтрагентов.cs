...
namespace V82.Rest.СправочникиТест
{
	public class ТипыЦенНоменклатурыКонтрагентов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЦенНоменклатурыКонтрагентов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЦенНоменклатурыКонтрагентов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТипыЦенНоменклатурыКонтрагентовЗапрос ТипыЦенНоменклатурыКонтрагентовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЦенНоменклатурыКонтрагентов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТипыЦенНоменклатурыКонтрагентовЗапрос ТипыЦенНоменклатурыКонтрагентовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТипыЦенНоменклатурыКонтрагентов?format=json";
			var Клиент = new JsonServiceClient(Урл);
