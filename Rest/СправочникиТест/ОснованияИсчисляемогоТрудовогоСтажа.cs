...
namespace V82.Rest.СправочникиТест
{
	public class ОснованияИсчисляемогоТрудовогоСтажа:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияИсчисляемогоТрудовогоСтажа/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияИсчисляемогоТрудовогоСтажа/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОснованияИсчисляемогоТрудовогоСтажаЗапрос ОснованияИсчисляемогоТрудовогоСтажаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияИсчисляемогоТрудовогоСтажа/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОснованияИсчисляемогоТрудовогоСтажаЗапрос ОснованияИсчисляемогоТрудовогоСтажаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияИсчисляемогоТрудовогоСтажа?format=json";
			var Клиент = new JsonServiceClient(Урл);
