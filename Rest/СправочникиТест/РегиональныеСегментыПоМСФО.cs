...
namespace V82.Rest.СправочникиТест
{
	public class РегиональныеСегментыПоМСФО:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегиональныеСегментыПоМСФО/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегиональныеСегментыПоМСФО/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РегиональныеСегментыПоМСФОЗапрос РегиональныеСегментыПоМСФОЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегиональныеСегментыПоМСФО/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РегиональныеСегментыПоМСФОЗапрос РегиональныеСегментыПоМСФОЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегиональныеСегментыПоМСФО?format=json";
			var Клиент = new JsonServiceClient(Урл);
