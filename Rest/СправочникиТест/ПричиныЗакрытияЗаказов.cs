...
namespace V82.Rest.СправочникиТест
{
	public class ПричиныЗакрытияЗаказов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныЗакрытияЗаказов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныЗакрытияЗаказов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПричиныЗакрытияЗаказовЗапрос ПричиныЗакрытияЗаказовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныЗакрытияЗаказов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПричиныЗакрытияЗаказовЗапрос ПричиныЗакрытияЗаказовЗапрос = null;
			try
			{
