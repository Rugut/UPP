...
namespace V82.Rest.СправочникиТест
{
	public class ПрочиеДоходыИРасходы:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрочиеДоходыИРасходы/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрочиеДоходыИРасходы/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрочиеДоходыИРасходыЗапрос ПрочиеДоходыИРасходыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрочиеДоходыИРасходы/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрочиеДоходыИРасходыЗапрос ПрочиеДоходыИРасходыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрочиеДоходыИРасходы?format=json";
			var Клиент = new JsonServiceClient(Урл);
