...
namespace V82.Rest.СправочникиТест
{
	public class КлассификаторСтранМира:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторСтранМира/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторСтранМира/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КлассификаторСтранМираЗапрос КлассификаторСтранМираЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторСтранМира/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КлассификаторСтранМираЗапрос КлассификаторСтранМираЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторСтранМира?format=json";
			var Клиент = new JsonServiceClient(Урл);
