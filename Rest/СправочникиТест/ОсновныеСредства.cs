...
namespace V82.Rest.СправочникиТест
{
	public class ОсновныеСредства:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОсновныеСредства/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОсновныеСредства/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОсновныеСредстваЗапрос ОсновныеСредстваЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОсновныеСредства/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОсновныеСредстваЗапрос ОсновныеСредстваЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОсновныеСредства?format=json";
			var Клиент = new JsonServiceClient(Урл);
