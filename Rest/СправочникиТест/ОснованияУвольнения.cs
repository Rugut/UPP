...
namespace V82.Rest.СправочникиТест
{
	public class ОснованияУвольнения:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияУвольнения/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияУвольнения/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОснованияУвольненияЗапрос ОснованияУвольненияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияУвольнения/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ОснованияУвольненияЗапрос ОснованияУвольненияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ОснованияУвольнения?format=json";
			var Клиент = new JsonServiceClient(Урл);
