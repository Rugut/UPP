...
namespace V82.Rest.СправочникиТест
{
	public class ТерриториальныеУсловия:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТерриториальныеУсловия/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТерриториальныеУсловия/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТерриториальныеУсловияЗапрос ТерриториальныеУсловияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТерриториальныеУсловия/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТерриториальныеУсловияЗапрос ТерриториальныеУсловияЗапрос = null;
			try
			{
