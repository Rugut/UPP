...
namespace V82.Rest.СправочникиТест
{
	public class ЗначенияПоказателейАнализовНоменклатуры:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЗначенияПоказателейАнализовНоменклатуры/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЗначенияПоказателейАнализовНоменклатуры/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЗначенияПоказателейАнализовНоменклатурыЗапрос ЗначенияПоказателейАнализовНоменклатурыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЗначенияПоказателейАнализовНоменклатуры/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЗначенияПоказателейАнализовНоменклатурыЗапрос ЗначенияПоказателейАнализовНоменклатурыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЗначенияПоказателейАнализовНоменклатуры?format=json";
			var Клиент = new JsonServiceClient(Урл);
