...
namespace V82.Rest.СправочникиТест
{
	public class ПричиныОбслуживанияОС:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныОбслуживанияОС/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныОбслуживанияОС/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПричиныОбслуживанияОСЗапрос ПричиныОбслуживанияОСЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныОбслуживанияОС/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПричиныОбслуживанияОСЗапрос ПричиныОбслуживанияОСЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПричиныОбслуживанияОС?format=json";
			var Клиент = new JsonServiceClient(Урл);
