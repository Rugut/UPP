...
namespace V82.Rest.СправочникиТест
{
	public class ДетализацияОтчетаОПрибыляхИУбытках:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДетализацияОтчетаОПрибыляхИУбытках/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДетализацияОтчетаОПрибыляхИУбытках/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДетализацияОтчетаОПрибыляхИУбыткахЗапрос ДетализацияОтчетаОПрибыляхИУбыткахЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДетализацияОтчетаОПрибыляхИУбытках/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДетализацияОтчетаОПрибыляхИУбыткахЗапрос ДетализацияОтчетаОПрибыляхИУбыткахЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДетализацияОтчетаОПрибыляхИУбытках?format=json";
			var Клиент = new JsonServiceClient(Урл);
