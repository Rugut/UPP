...
namespace V82.Rest.СправочникиТест
{
	public class КонтактныеЛица:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КонтактныеЛица/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/КонтактныеЛица/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КонтактныеЛицаЗапрос КонтактныеЛицаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КонтактныеЛица/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КонтактныеЛицаЗапрос КонтактныеЛицаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КонтактныеЛица?format=json";
			var Клиент = new JsonServiceClient(Урл);
