...
namespace V82.Rest.СправочникиТест
{
	public class ДоговорыКонтрагентов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыКонтрагентов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыКонтрагентов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДоговорыКонтрагентовЗапрос ДоговорыКонтрагентовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыКонтрагентов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДоговорыКонтрагентовЗапрос ДоговорыКонтрагентовЗапрос = null;
			try
			{
