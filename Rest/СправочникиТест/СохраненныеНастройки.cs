...
namespace V82.Rest.СправочникиТест
{
	public class СохраненныеНастройки:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СохраненныеНастройки/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СохраненныеНастройки/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СохраненныеНастройкиЗапрос СохраненныеНастройкиЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СохраненныеНастройки?format=json";
			var Клиент = new JsonServiceClient(Урл);
