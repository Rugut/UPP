...
namespace V82.Rest.СправочникиТест
{
	public class НоменклатурныеУзлы:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НоменклатурныеУзлы/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НоменклатурныеУзлы/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НоменклатурныеУзлыЗапрос НоменклатурныеУзлыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НоменклатурныеУзлы/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НоменклатурныеУзлыЗапрос НоменклатурныеУзлыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НоменклатурныеУзлы?format=json";
			var Клиент = new JsonServiceClient(Урл);
