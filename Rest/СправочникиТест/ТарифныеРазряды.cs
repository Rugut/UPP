...
namespace V82.Rest.СправочникиТест
{
	public class ТарифныеРазряды:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифныеРазряды/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифныеРазряды/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТарифныеРазрядыЗапрос ТарифныеРазрядыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифныеРазряды/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТарифныеРазрядыЗапрос ТарифныеРазрядыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТарифныеРазряды?format=json";
			var Клиент = new JsonServiceClient(Урл);
