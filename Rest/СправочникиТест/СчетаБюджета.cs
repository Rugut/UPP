...
namespace V82.Rest.СправочникиТест
{
	public class СчетаБюджета:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СчетаБюджета/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СчетаБюджета/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СчетаБюджетаЗапрос СчетаБюджетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СчетаБюджета/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СчетаБюджетаЗапрос СчетаБюджетаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СчетаБюджета?format=json";
			var Клиент = new JsonServiceClient(Урл);
