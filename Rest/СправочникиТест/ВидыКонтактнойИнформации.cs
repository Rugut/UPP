...
namespace V82.Rest.СправочникиТест
{
	public class ВидыКонтактнойИнформации:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыКонтактнойИнформации/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыКонтактнойИнформации/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыКонтактнойИнформацииЗапрос ВидыКонтактнойИнформацииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыКонтактнойИнформации/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыКонтактнойИнформацииЗапрос ВидыКонтактнойИнформацииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыКонтактнойИнформации?format=json";
			var Клиент = new JsonServiceClient(Урл);
