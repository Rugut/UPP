...
namespace V82.Rest.СправочникиТест
{
	public class Работодатели:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Работодатели/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/Работодатели/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РаботодателиЗапрос РаботодателиЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Работодатели/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РаботодателиЗапрос РаботодателиЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/Работодатели?format=json";
			var Клиент = new JsonServiceClient(Урл);
