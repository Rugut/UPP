...
namespace V82.Rest.СправочникиТест
{
	public class ДоходыБудущихПериодов:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоходыБудущихПериодов/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоходыБудущихПериодов/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДоходыБудущихПериодовЗапрос ДоходыБудущихПериодовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоходыБудущихПериодов/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДоходыБудущихПериодовЗапрос ДоходыБудущихПериодовЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоходыБудущихПериодов?format=json";
			var Клиент = new JsonServiceClient(Урл);
