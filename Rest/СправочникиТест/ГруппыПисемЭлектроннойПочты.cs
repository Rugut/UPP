...
namespace V82.Rest.СправочникиТест
{
	public class ГруппыПисемЭлектроннойПочты:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыПисемЭлектроннойПочты/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыПисемЭлектроннойПочты/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ГруппыПисемЭлектроннойПочтыЗапрос ГруппыПисемЭлектроннойПочтыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыПисемЭлектроннойПочты/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ГруппыПисемЭлектроннойПочтыЗапрос ГруппыПисемЭлектроннойПочтыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ГруппыПисемЭлектроннойПочты?format=json";
			var Клиент = new JsonServiceClient(Урл);
