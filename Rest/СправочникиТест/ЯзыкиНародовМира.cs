...
namespace V82.Rest.СправочникиТест
{
	public class ЯзыкиНародовМира:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЯзыкиНародовМира/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЯзыкиНародовМира/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЯзыкиНародовМираЗапрос ЯзыкиНародовМираЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЯзыкиНародовМира/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЯзыкиНародовМираЗапрос ЯзыкиНародовМираЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ЯзыкиНародовМира?format=json";
			var Клиент = new JsonServiceClient(Урл);
