...
namespace V82.Rest.СправочникиТест
{
	public class ФормыОбучения:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ФормыОбучения/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ФормыОбучения/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ФормыОбученияЗапрос ФормыОбученияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ФормыОбучения/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ФормыОбученияЗапрос ФормыОбученияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Catalogs/ФормыОбучения?format=json";
			var Клиент = new JsonServiceClient(Урл);
