...
namespace V82.Rest.СправочникиТест
{
	public class ПараметрыВыпускаПродукции:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПараметрыВыпускаПродукции/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПараметрыВыпускаПродукции/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПараметрыВыпускаПродукцииЗапрос ПараметрыВыпускаПродукцииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПараметрыВыпускаПродукции/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПараметрыВыпускаПродукцииЗапрос ПараметрыВыпускаПродукцииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПараметрыВыпускаПродукции?format=json";
			var Клиент = new JsonServiceClient(Урл);
