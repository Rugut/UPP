...
namespace V82.Rest.СправочникиТест
{
	public class РолиИсполнителей:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиИсполнителей/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиИсполнителей/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РолиИсполнителейЗапрос РолиИсполнителейЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиИсполнителей/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РолиИсполнителейЗапрос РолиИсполнителейЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиИсполнителей?format=json";
			var Клиент = new JsonServiceClient(Урл);
