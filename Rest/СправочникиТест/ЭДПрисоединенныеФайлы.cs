...
namespace V82.Rest.СправочникиТест
{
	public class ЭДПрисоединенныеФайлы:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЭДПрисоединенныеФайлы/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЭДПрисоединенныеФайлы/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ЭДПрисоединенныеФайлыЗапрос ЭДПрисоединенныеФайлыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ЭДПрисоединенныеФайлы?format=json";
			var Клиент = new JsonServiceClient(Урл);
