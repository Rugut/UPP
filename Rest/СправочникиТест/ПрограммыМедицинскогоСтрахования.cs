...
namespace V82.Rest.СправочникиТест
{
	public class ПрограммыМедицинскогоСтрахования:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрограммыМедицинскогоСтрахования/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрограммыМедицинскогоСтрахования/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрограммыМедицинскогоСтрахованияЗапрос ПрограммыМедицинскогоСтрахованияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрограммыМедицинскогоСтрахования/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрограммыМедицинскогоСтрахованияЗапрос ПрограммыМедицинскогоСтрахованияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрограммыМедицинскогоСтрахования?format=json";
			var Клиент = new JsonServiceClient(Урл);
