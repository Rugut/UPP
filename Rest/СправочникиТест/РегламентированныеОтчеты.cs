...
namespace V82.Rest.СправочникиТест
{
	public class РегламентированныеОтчеты:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегламентированныеОтчеты/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегламентированныеОтчеты/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РегламентированныеОтчетыЗапрос РегламентированныеОтчетыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегламентированныеОтчеты/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РегламентированныеОтчетыЗапрос РегламентированныеОтчетыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РегламентированныеОтчеты?format=json";
			var Клиент = new JsonServiceClient(Урл);
