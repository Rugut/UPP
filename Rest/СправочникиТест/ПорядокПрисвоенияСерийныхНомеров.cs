...
namespace V82.Rest.СправочникиТест
{
	public class ПорядокПрисвоенияСерийныхНомеров:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПорядокПрисвоенияСерийныхНомеров/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПорядокПрисвоенияСерийныхНомеров/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПорядокПрисвоенияСерийныхНомеровЗапрос ПорядокПрисвоенияСерийныхНомеровЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПорядокПрисвоенияСерийныхНомеров/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПорядокПрисвоенияСерийныхНомеровЗапрос ПорядокПрисвоенияСерийныхНомеровЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПорядокПрисвоенияСерийныхНомеров?format=json";
			var Клиент = new JsonServiceClient(Урл);
