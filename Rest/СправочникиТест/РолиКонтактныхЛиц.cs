...
namespace V82.Rest.СправочникиТест
{
	public class РолиКонтактныхЛиц:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиКонтактныхЛиц/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиКонтактныхЛиц/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РолиКонтактныхЛицЗапрос РолиКонтактныхЛицЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиКонтактныхЛиц/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			РолиКонтактныхЛицЗапрос РолиКонтактныхЛицЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/РолиКонтактныхЛиц?format=json";
			var Клиент = new JsonServiceClient(Урл);
