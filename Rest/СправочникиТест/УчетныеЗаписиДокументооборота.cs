...
namespace V82.Rest.СправочникиТест
{
	public class УчетныеЗаписиДокументооборота:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчетныеЗаписиДокументооборота/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчетныеЗаписиДокументооборота/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			УчетныеЗаписиДокументооборотаЗапрос УчетныеЗаписиДокументооборотаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчетныеЗаписиДокументооборота/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			УчетныеЗаписиДокументооборотаЗапрос УчетныеЗаписиДокументооборотаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчетныеЗаписиДокументооборота?format=json";
			var Клиент = new JsonServiceClient(Урл);
