...
namespace V82.Rest.СправочникиТест
{
	public class СтепениЗнанияЯзыка:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтепениЗнанияЯзыка/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтепениЗнанияЯзыка/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СтепениЗнанияЯзыкаЗапрос СтепениЗнанияЯзыкаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтепениЗнанияЯзыка/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СтепениЗнанияЯзыкаЗапрос СтепениЗнанияЯзыкаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СтепениЗнанияЯзыка?format=json";
			var Клиент = new JsonServiceClient(Урл);
