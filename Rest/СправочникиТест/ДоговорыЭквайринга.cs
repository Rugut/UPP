...
namespace V82.Rest.СправочникиТест
{
	public class ДоговорыЭквайринга:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыЭквайринга/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыЭквайринга/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДоговорыЭквайрингаЗапрос ДоговорыЭквайрингаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыЭквайринга/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ДоговорыЭквайрингаЗапрос ДоговорыЭквайрингаЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ДоговорыЭквайринга?format=json";
			var Клиент = new JsonServiceClient(Урл);
