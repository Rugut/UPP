...
namespace V82.Rest.СправочникиТест
{
	public class УчебныеЗаведения:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчебныеЗаведения/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчебныеЗаведения/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			УчебныеЗаведенияЗапрос УчебныеЗаведенияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчебныеЗаведения/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			УчебныеЗаведенияЗапрос УчебныеЗаведенияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/УчебныеЗаведения?format=json";
			var Клиент = new JsonServiceClient(Урл);
