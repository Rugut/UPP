...
namespace V82.Rest.СправочникиТест
{
	public class КлассификаторЕдиницИзмерения:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторЕдиницИзмерения/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторЕдиницИзмерения/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КлассификаторЕдиницИзмеренияЗапрос КлассификаторЕдиницИзмеренияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторЕдиницИзмерения/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			КлассификаторЕдиницИзмеренияЗапрос КлассификаторЕдиницИзмеренияЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/КлассификаторЕдиницИзмерения?format=json";
			var Клиент = new JsonServiceClient(Урл);
