...
namespace V82.Rest.СправочникиТест
{
	public class ПрофилиРаспределенияПоПериодам:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиРаспределенияПоПериодам/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиРаспределенияПоПериодам/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрофилиРаспределенияПоПериодамЗапрос ПрофилиРаспределенияПоПериодамЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиРаспределенияПоПериодам/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрофилиРаспределенияПоПериодамЗапрос ПрофилиРаспределенияПоПериодамЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиРаспределенияПоПериодам?format=json";
			var Клиент = new JsonServiceClient(Урл);
