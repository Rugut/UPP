...
namespace V82.Rest.СправочникиТест
{
	public class ВариантыCхемМотивации:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыCхемМотивации/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыCхемМотивации/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВариантыCхемМотивацииЗапрос ВариантыCхемМотивацииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыCхемМотивации/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВариантыCхемМотивацииЗапрос ВариантыCхемМотивацииЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВариантыCхемМотивации?format=json";
			var Клиент = new JsonServiceClient(Урл);
