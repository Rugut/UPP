...
namespace V82.Rest.СправочникиТест
{
	public class ВидыОбразованияФизЛиц:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыОбразованияФизЛиц/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыОбразованияФизЛиц/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыОбразованияФизЛицЗапрос ВидыОбразованияФизЛицЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыОбразованияФизЛиц/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ВидыОбразованияФизЛицЗапрос ВидыОбразованияФизЛицЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ВидыОбразованияФизЛиц?format=json";
			var Клиент = new JsonServiceClient(Урл);
