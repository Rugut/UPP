...
namespace V82.Rest.СправочникиТест
{
	public class СемейноеПоложениеФизЛиц:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СемейноеПоложениеФизЛиц/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/СемейноеПоложениеФизЛиц/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СемейноеПоложениеФизЛицЗапрос СемейноеПоложениеФизЛицЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СемейноеПоложениеФизЛиц/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			СемейноеПоложениеФизЛицЗапрос СемейноеПоложениеФизЛицЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/СемейноеПоложениеФизЛиц?format=json";
			var Клиент = new JsonServiceClient(Урл);
