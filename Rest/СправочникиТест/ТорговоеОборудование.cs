...
namespace V82.Rest.СправочникиТест
{
	public class ТорговоеОборудование:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТорговоеОборудование/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТорговоеОборудование/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТорговоеОборудованиеЗапрос ТорговоеОборудованиеЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТорговоеОборудование/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ТорговоеОборудованиеЗапрос ТорговоеОборудованиеЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ТорговоеОборудование?format=json";
			var Клиент = new JsonServiceClient(Урл);
