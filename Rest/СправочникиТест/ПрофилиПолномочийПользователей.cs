...
namespace V82.Rest.СправочникиТест
{
	public class ПрофилиПолномочийПользователей:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиПолномочийПользователей/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиПолномочийПользователей/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПрофилиПолномочийПользователейЗапрос ПрофилиПолномочийПользователейЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПрофилиПолномочийПользователей?format=json";
			var Клиент = new JsonServiceClient(Урл);
