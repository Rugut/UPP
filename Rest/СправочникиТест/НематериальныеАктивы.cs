...
namespace V82.Rest.СправочникиТест
{
	public class НематериальныеАктивы:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НематериальныеАктивы/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НематериальныеАктивы/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НематериальныеАктивыЗапрос НематериальныеАктивыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НематериальныеАктивы/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НематериальныеАктивыЗапрос НематериальныеАктивыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НематериальныеАктивы?format=json";
			var Клиент = new JsonServiceClient(Урл);
