...
namespace V82.Rest.СправочникиТест
{
	public class ПроизвольныеОтчеты:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПроизвольныеОтчеты/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПроизвольныеОтчеты/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			ПроизвольныеОтчетыЗапрос ПроизвольныеОтчетыЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/ПроизвольныеОтчеты?format=json";
			var Клиент = new JsonServiceClient(Урл);
