...
namespace V82.Rest.СправочникиТест
{
	public class НормативыОбслуживанияОС:V82.Rest.СправочникиТест.СправочникТест
	{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НормативыОбслуживанияОС/НайтиПоСсылке/"+УникальныйИдентификатор+"?format=json";
		...
		{
			var Урл = "http://localhost:1337/Справочники/НормативыОбслуживанияОС/НайтиПоКоду/"+Код+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НормативыОбслуживанияОСЗапрос НормативыОбслуживанияОСЗапрос = null;
			try
			{
		...
		{
			var Урл = "http://localhost:1337/Справочники/НормативыОбслуживанияОС/НайтиПоНаименованию/"+Наименование+"?format=json";
			var Клиент = new JsonServiceClient(Урл);
			НормативыОбслуживанияОСЗапрос НормативыОбслуживанияОСЗапрос = null;
			try
			{
