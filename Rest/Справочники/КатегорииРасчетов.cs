...
namespace V82.Справочники
{
	...
	public partial class КатегорииРасчетовСервис : Service
	{
		...
		public object Get(КатегорииРасчетовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.КатегорииРасчетов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КатегорииРасчетовОтвет() { Ответ = "КатегорииРасчетов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
