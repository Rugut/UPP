...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/КлючиАналитикиРаспределенияЗатрат/ВыбратьПоСсылке","{___Первые}")]
	[Маршрут("Справочники/КлючиАналитикиРаспределенияЗатрат/ВыбратьПоСсылке","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/КлючиАналитикиРаспределенияЗатрат/ВыбратьПоНаименованию","{___Первые}")]
	[Маршрут("Справочники/КлючиАналитикиРаспределенияЗатрат/ВыбратьПоНаименованию","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/КлючиАналитикиРаспределенияЗатрат/СтраницаПоСсылке","{___Размер}/{___Номер}")]
	public class КлючиАналитикиРаспределенияЗатратСтраницаПоСсылке: V82.СправочникиСсылка.КлючиАналитикиРаспределенияЗатрат,IReturn<КлючиАналитикиРаспределенияЗатратСтраницаПоСсылке>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/КлючиАналитикиРаспределенияЗатрат/СтраницаПоНаименованию","{___Размер}/{___Номер}")]
	public class КлючиАналитикиРаспределенияЗатратСтраницаПоНаименованию: V82.СправочникиСсылка.КлючиАналитикиРаспределенияЗатрат,IReturn<КлючиАналитикиРаспределенияЗатратСтраницаПоНаименованию>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	...
	public partial class КлючиАналитикиРаспределенияЗатратСервис : Service
	{
		
		public object Get(КлючиАналитикиРаспределенияЗатратЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(КлючиАналитикиРаспределенияЗатратНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.КлючиАналитикиРаспределенияЗатрат.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КлючиАналитикиРаспределенияЗатратОтвет() { Ответ = "КлючиАналитикиРаспределенияЗатрат c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(КлючиАналитикиРаспределенияЗатратВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.КлючиАналитикиРаспределенияЗатрат.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(КлючиАналитикиРаспределенияЗатратСтраницаПоСсылке Запрос)
		{
			return null;
		}
		
		public object Get(КлючиАналитикиРаспределенияЗатратСтраницаПоНаименованию Запрос)
		{
			return null;
		}
