...
namespace V82.Справочники
{
	...
	public partial class ТипыСкидокНаценокСервис : Service
	{
		
		public object Get(ТипыСкидокНаценокЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ТипыСкидокНаценокНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТипыСкидокНаценок.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТипыСкидокНаценокОтвет() { Ответ = "ТипыСкидокНаценок c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ТипыСкидокНаценокВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ТипыСкидокНаценок.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
