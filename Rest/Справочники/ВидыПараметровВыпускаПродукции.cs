...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ВидыПараметровВыпускаПродукции/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/ВидыПараметровВыпускаПродукции/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/ВидыПараметровВыпускаПродукции/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class ВидыПараметровВыпускаПродукцииИерархияВыбратьПоСсылке: V82.СправочникиСсылка.ВидыПараметровВыпускаПродукции,IReturn<ВидыПараметровВыпускаПродукцииИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/ВидыПараметровВыпускаПродукции/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class ВидыПараметровВыпускаПродукцииИерархияСтраницаПоСсылке: V82.СправочникиСсылка.ВидыПараметровВыпускаПродукции,IReturn<ВидыПараметровВыпускаПродукцииИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class ВидыПараметровВыпускаПродукцииСервис : Service
	{
		...
		public object Get(ВидыПараметровВыпускаПродукцииИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.ВидыПараметровВыпускаПродукции.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(ВидыПараметровВыпускаПродукцииИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
