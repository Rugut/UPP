...
namespace V82.Справочники
{
	...
	public partial class ИсточникиИнформацииСервис : Service
	{
		...
		public object Get(ИсточникиИнформацииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ИсточникиИнформации.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ИсточникиИнформацииОтвет() { Ответ = "ИсточникиИнформации c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ИсточникиИнформацииВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ИсточникиИнформации.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
