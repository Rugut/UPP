...
namespace V82.Справочники
{
	...
	public partial class ДетализацияАналитическогоБалансаСервис : Service
	{
		
		public object Get(ДетализацияАналитическогоБалансаЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ДетализацияАналитическогоБалансаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДетализацияАналитическогоБаланса.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДетализацияАналитическогоБалансаОтвет() { Ответ = "ДетализацияАналитическогоБаланса c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ДетализацияАналитическогоБалансаВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ДетализацияАналитическогоБаланса.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
