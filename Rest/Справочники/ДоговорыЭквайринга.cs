...
namespace V82.Справочники
{
	...
	public partial class ДоговорыЭквайрингаСервис : Service
	{
		...
		public object Get(ДоговорыЭквайрингаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДоговорыЭквайринга.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДоговорыЭквайрингаОтвет() { Ответ = "ДоговорыЭквайринга c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ДоговорыЭквайрингаВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ДоговорыЭквайринга.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
