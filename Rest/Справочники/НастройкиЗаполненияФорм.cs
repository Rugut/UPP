...
namespace V82.Справочники
{
	...
	public partial class НастройкиЗаполненияФормСервис : Service
	{
		...
		public object Get(НастройкиЗаполненияФормНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НастройкиЗаполненияФорм.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НастройкиЗаполненияФормОтвет() { Ответ = "НастройкиЗаполненияФорм c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НастройкиЗаполненияФормВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НастройкиЗаполненияФорм.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
