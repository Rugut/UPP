...
namespace V82.Справочники
{
	...
	public partial class УченыеЗванияСервис : Service
	{
		...
		public object Get(УченыеЗванияНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.УченыеЗвания.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new УченыеЗванияОтвет() { Ответ = "УченыеЗвания c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(УченыеЗванияВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.УченыеЗвания.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
