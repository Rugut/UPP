...
namespace V82.Справочники
{
	...
	public partial class КонтактныеЛицаКонтрагентовСервис : Service
	{
		...
		public object Get(КонтактныеЛицаКонтрагентовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.КонтактныеЛицаКонтрагентов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КонтактныеЛицаКонтрагентовОтвет() { Ответ = "КонтактныеЛицаКонтрагентов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(КонтактныеЛицаКонтрагентовВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.КонтактныеЛицаКонтрагентов.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
