...
namespace V82.Справочники
{
	...
	public partial class СостоянияЗаявокКандидатовСервис : Service
	{
		...
		public object Get(СостоянияЗаявокКандидатовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СостоянияЗаявокКандидатов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СостоянияЗаявокКандидатовОтвет() { Ответ = "СостоянияЗаявокКандидатов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
