...
namespace V82.Справочники
{
	...
	public partial class УсловияПродажСервис : Service
	{
		...
		public object Get(УсловияПродажНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.УсловияПродаж.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new УсловияПродажОтвет() { Ответ = "УсловияПродаж c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
