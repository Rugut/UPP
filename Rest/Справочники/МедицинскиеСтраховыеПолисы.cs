...
namespace V82.Справочники
{
	...
	public partial class МедицинскиеСтраховыеПолисыСервис : Service
	{
		...
		public object Get(МедицинскиеСтраховыеПолисыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.МедицинскиеСтраховыеПолисы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new МедицинскиеСтраховыеПолисыОтвет() { Ответ = "МедицинскиеСтраховыеПолисы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(МедицинскиеСтраховыеПолисыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.МедицинскиеСтраховыеПолисы.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
