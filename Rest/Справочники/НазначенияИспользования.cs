...
namespace V82.Справочники
{
	...
	public partial class НазначенияИспользованияСервис : Service
	{
		...
		public object Get(НазначенияИспользованияНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НазначенияИспользования.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НазначенияИспользованияОтвет() { Ответ = "НазначенияИспользования c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НазначенияИспользованияВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НазначенияИспользования.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
