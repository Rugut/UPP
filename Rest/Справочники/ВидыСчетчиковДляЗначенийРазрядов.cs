...
namespace V82.Справочники
{
	...
	public partial class ВидыСчетчиковДляЗначенийРазрядовСервис : Service
	{
		...
		public object Get(ВидыСчетчиковДляЗначенийРазрядовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыСчетчиковДляЗначенийРазрядов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыСчетчиковДляЗначенийРазрядовОтвет() { Ответ = "ВидыСчетчиковДляЗначенийРазрядов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
