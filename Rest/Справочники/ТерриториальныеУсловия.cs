...
namespace V82.Справочники
{
	...
	public partial class ТерриториальныеУсловияСервис : Service
	{
		...
		public object Get(ТерриториальныеУсловияНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТерриториальныеУсловия.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТерриториальныеУсловияОтвет() { Ответ = "ТерриториальныеУсловия c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
