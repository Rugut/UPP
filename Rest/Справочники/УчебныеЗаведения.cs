...
namespace V82.Справочники
{
	...
	public partial class УчебныеЗаведенияСервис : Service
	{
		...
		public object Get(УчебныеЗаведенияНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.УчебныеЗаведения.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new УчебныеЗаведенияОтвет() { Ответ = "УчебныеЗаведения c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(УчебныеЗаведенияВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.УчебныеЗаведения.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
