...
namespace V82.Справочники
{
	...
	public partial class КоэффициентыСтажаСервис : Service
	{
		...
		public object Get(КоэффициентыСтажаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.КоэффициентыСтажа.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КоэффициентыСтажаОтвет() { Ответ = "КоэффициентыСтажа c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
