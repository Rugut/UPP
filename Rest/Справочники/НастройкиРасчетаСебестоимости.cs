...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/НастройкиРасчетаСебестоимости/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/НастройкиРасчетаСебестоимости/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/НастройкиРасчетаСебестоимости/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class НастройкиРасчетаСебестоимостиИерархияВыбратьПоСсылке: V82.СправочникиСсылка.НастройкиРасчетаСебестоимости,IReturn<НастройкиРасчетаСебестоимостиИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/НастройкиРасчетаСебестоимости/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class НастройкиРасчетаСебестоимостиИерархияСтраницаПоСсылке: V82.СправочникиСсылка.НастройкиРасчетаСебестоимости,IReturn<НастройкиРасчетаСебестоимостиИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class НастройкиРасчетаСебестоимостиСервис : Service
	{
		...
		public object Get(НастройкиРасчетаСебестоимостиИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.НастройкиРасчетаСебестоимости.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(НастройкиРасчетаСебестоимостиИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
