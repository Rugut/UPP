...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/Резервы/ВыбратьПоСсылке","{___Первые}")]
	[Маршрут("Справочники/Резервы/ВыбратьПоСсылке","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/Резервы/ВыбратьПоКоду","{___Первые}")]
	[Маршрут("Справочники/Резервы/ВыбратьПоКоду","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/Резервы/ВыбратьПоНаименованию","{___Первые}")]
	[Маршрут("Справочники/Резервы/ВыбратьПоНаименованию","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/Резервы/СтраницаПоСсылке","{___Размер}/{___Номер}")]
	public class РезервыСтраницаПоСсылке: V82.СправочникиСсылка.Резервы,IReturn<РезервыСтраницаПоСсылке>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/Резервы/СтраницаПоКоду","{___Размер}/{___Номер}")]
	public class РезервыСтраницаПоКоду: V82.СправочникиСсылка.Резервы,IReturn<РезервыСтраницаПоКоду>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/Резервы/СтраницаПоНаименованию","{___Размер}/{___Номер}")]
	public class РезервыСтраницаПоНаименованию: V82.СправочникиСсылка.Резервы,IReturn<РезервыСтраницаПоНаименованию>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	...
	public partial class РезервыСервис : Service
	{
		
		public object Get(РезервыЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(РезервыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.Резервы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new РезервыОтвет() { Ответ = "Резервы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(РезервыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.Резервы.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(РезервыСтраницаПоСсылке Запрос)
		{
			return null;
		}
		
		public object Get(РезервыСтраницаПоКоду Запрос)
		{
			return null;
		}
		
		public object Get(РезервыСтраницаПоНаименованию Запрос)
		{
			return null;
		}
