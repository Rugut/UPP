...
namespace V82.Справочники
{
	...
	public partial class ОснованияУвольненияСервис : Service
	{
		
		public object Get(ОснованияУвольненияЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ОснованияУвольненияНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ОснованияУвольнения.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ОснованияУвольненияОтвет() { Ответ = "ОснованияУвольнения c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ОснованияУвольненияВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ОснованияУвольнения.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
