...
namespace V82.Справочники
{
	...
	public partial class ПерепискаСКонтролирующимиОрганамиСервис : Service
	{
		...
		public object Get(ПерепискаСКонтролирующимиОрганамиНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПерепискаСКонтролирующимиОрганами.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПерепискаСКонтролирующимиОрганамиОтвет() { Ответ = "ПерепискаСКонтролирующимиОрганами c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ПерепискаСКонтролирующимиОрганамиВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ПерепискаСКонтролирующимиОрганами.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
