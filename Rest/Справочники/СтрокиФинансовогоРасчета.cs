...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/ВыбратьПоСсылке","{___Первые}")]
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/ВыбратьПоСсылке","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/ВыбратьПоКоду","{___Первые}")]
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/ВыбратьПоКоду","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/ВыбратьПоНаименованию","{___Первые}")]
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/ВыбратьПоНаименованию","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/СтраницаПоСсылке","{___Размер}/{___Номер}")]
	public class СтрокиФинансовогоРасчетаСтраницаПоСсылке: V82.СправочникиСсылка.СтрокиФинансовогоРасчета,IReturn<СтрокиФинансовогоРасчетаСтраницаПоСсылке>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/СтраницаПоКоду","{___Размер}/{___Номер}")]
	public class СтрокиФинансовогоРасчетаСтраницаПоКоду: V82.СправочникиСсылка.СтрокиФинансовогоРасчета,IReturn<СтрокиФинансовогоРасчетаСтраницаПоКоду>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/СтрокиФинансовогоРасчета/СтраницаПоНаименованию","{___Размер}/{___Номер}")]
	public class СтрокиФинансовогоРасчетаСтраницаПоНаименованию: V82.СправочникиСсылка.СтрокиФинансовогоРасчета,IReturn<СтрокиФинансовогоРасчетаСтраницаПоНаименованию>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	...
	public partial class СтрокиФинансовогоРасчетаСервис : Service
	{
		
		public object Get(СтрокиФинансовогоРасчетаЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(СтрокиФинансовогоРасчетаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СтрокиФинансовогоРасчета.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СтрокиФинансовогоРасчетаОтвет() { Ответ = "СтрокиФинансовогоРасчета c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СтрокиФинансовогоРасчетаВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СтрокиФинансовогоРасчета.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(СтрокиФинансовогоРасчетаСтраницаПоСсылке Запрос)
		{
			return null;
		}
		
		public object Get(СтрокиФинансовогоРасчетаСтраницаПоКоду Запрос)
		{
			return null;
		}
		
		public object Get(СтрокиФинансовогоРасчетаСтраницаПоНаименованию Запрос)
		{
			return null;
		}
