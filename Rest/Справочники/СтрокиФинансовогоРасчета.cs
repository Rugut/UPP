...
namespace V82.Справочники
{
	...
	[Route("/Catalogs/StrokiFinansovogoRascheta/FindById/{Id}")]
	[Route("/Catalogs/StrokiFinansovogoRascheta/FindByCode/{Code}")]
	[Route("/Catalogs/StrokiFinansovogoRascheta/FindByDescr/{Descr}")]
