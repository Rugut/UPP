...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ДолжностиОрганизаций/ВыбратьПоСсылке","{___Первые}")]
	[Маршрут("Справочники/ДолжностиОрганизаций/ВыбратьПоСсылке","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ДолжностиОрганизаций/ВыбратьПоКоду","{___Первые}")]
	[Маршрут("Справочники/ДолжностиОрганизаций/ВыбратьПоКоду","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ДолжностиОрганизаций/ВыбратьПоНаименованию","{___Первые}")]
	[Маршрут("Справочники/ДолжностиОрганизаций/ВыбратьПоНаименованию","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ДолжностиОрганизаций/СтраницаПоСсылке","{___Размер}/{___Номер}")]
	public class ДолжностиОрганизацийСтраницаПоСсылке: V82.СправочникиСсылка.ДолжностиОрганизаций,IReturn<ДолжностиОрганизацийСтраницаПоСсылке>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/ДолжностиОрганизаций/СтраницаПоКоду","{___Размер}/{___Номер}")]
	public class ДолжностиОрганизацийСтраницаПоКоду: V82.СправочникиСсылка.ДолжностиОрганизаций,IReturn<ДолжностиОрганизацийСтраницаПоКоду>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/ДолжностиОрганизаций/СтраницаПоНаименованию","{___Размер}/{___Номер}")]
	public class ДолжностиОрганизацийСтраницаПоНаименованию: V82.СправочникиСсылка.ДолжностиОрганизаций,IReturn<ДолжностиОрганизацийСтраницаПоНаименованию>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	...
	public partial class ДолжностиОрганизацийСервис : Service
	{
		
		public object Get(ДолжностиОрганизацийЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ДолжностиОрганизацийНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДолжностиОрганизаций.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДолжностиОрганизацийОтвет() { Ответ = "ДолжностиОрганизаций c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ДолжностиОрганизацийВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ДолжностиОрганизаций.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(ДолжностиОрганизацийСтраницаПоСсылке Запрос)
		{
			return null;
		}
		
		public object Get(ДолжностиОрганизацийСтраницаПоКоду Запрос)
		{
			return null;
		}
		
		public object Get(ДолжностиОрганизацийСтраницаПоНаименованию Запрос)
		{
			return null;
		}
