...
namespace V82.Справочники
{
	...
	public partial class ПричиныОтсутствияНаРаботеСервис : Service
	{
		...
		public object Get(ПричиныОтсутствияНаРаботеНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПричиныОтсутствияНаРаботе.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПричиныОтсутствияНаРаботеОтвет() { Ответ = "ПричиныОтсутствияНаРаботе c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ПричиныОтсутствияНаРаботеВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ПричиныОтсутствияНаРаботе.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
