...
namespace V82.Справочники
{
	...
	public partial class ЛичныеКонтактыСервис : Service
	{
		...
		public object Get(ЛичныеКонтактыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ЛичныеКонтакты.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ЛичныеКонтактыОтвет() { Ответ = "ЛичныеКонтакты c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ЛичныеКонтактыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ЛичныеКонтакты.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
