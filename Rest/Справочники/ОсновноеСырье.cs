...
namespace V82.Справочники
{
	...
	public partial class ОсновноеСырьеСервис : Service
	{
		
		public object Get(ОсновноеСырьеЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ОсновноеСырьеНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ОсновноеСырье.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ОсновноеСырьеОтвет() { Ответ = "ОсновноеСырье c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ОсновноеСырьеВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ОсновноеСырье.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
