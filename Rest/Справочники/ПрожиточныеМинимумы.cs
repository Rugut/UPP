...
namespace V82.Справочники
{
	...
	public partial class ПрожиточныеМинимумыСервис : Service
	{
		...
		public object Get(ПрожиточныеМинимумыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПрожиточныеМинимумы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПрожиточныеМинимумыОтвет() { Ответ = "ПрожиточныеМинимумы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
