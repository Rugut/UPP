...
namespace V82.Справочники
{
	...
	public partial class ПоказателиСхемМотивацииСервис : Service
	{
		...
		public object Get(ПоказателиСхемМотивацииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПоказателиСхемМотивации.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПоказателиСхемМотивацииОтвет() { Ответ = "ПоказателиСхемМотивации c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ПоказателиСхемМотивацииВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ПоказателиСхемМотивации.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
