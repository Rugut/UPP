...
namespace V82.Справочники
{
	...
	public partial class ПорядокПрисвоенияСерийныхНомеровСервис : Service
	{
		...
		public object Get(ПорядокПрисвоенияСерийныхНомеровНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПорядокПрисвоенияСерийныхНомеров.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПорядокПрисвоенияСерийныхНомеровОтвет() { Ответ = "ПорядокПрисвоенияСерийныхНомеров c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
