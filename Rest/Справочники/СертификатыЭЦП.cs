...
namespace V82.Справочники
{
	...
	public partial class СертификатыЭЦПСервис : Service
	{
		
		public object Get(СертификатыЭЦПЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(СертификатыЭЦПНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СертификатыЭЦП.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СертификатыЭЦПОтвет() { Ответ = "СертификатыЭЦП c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СертификатыЭЦПВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СертификатыЭЦП.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
