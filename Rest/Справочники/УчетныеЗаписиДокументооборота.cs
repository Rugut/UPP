...
namespace V82.Справочники
{
	...
	public partial class УчетныеЗаписиДокументооборотаСервис : Service
	{
		...
		public object Get(УчетныеЗаписиДокументооборотаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.УчетныеЗаписиДокументооборота.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new УчетныеЗаписиДокументооборотаОтвет() { Ответ = "УчетныеЗаписиДокументооборота c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(УчетныеЗаписиДокументооборотаВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.УчетныеЗаписиДокументооборота.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
