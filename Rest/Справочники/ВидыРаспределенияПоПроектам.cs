...
namespace V82.Справочники
{
	...
	public partial class ВидыРаспределенияПоПроектамСервис : Service
	{
		...
		public object Get(ВидыРаспределенияПоПроектамНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыРаспределенияПоПроектам.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыРаспределенияПоПроектамОтвет() { Ответ = "ВидыРаспределенияПоПроектам c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
