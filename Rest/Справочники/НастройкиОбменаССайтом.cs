...
namespace V82.Справочники
{
	...
	public partial class НастройкиОбменаССайтомСервис : Service
	{
		...
		public object Get(НастройкиОбменаССайтомНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НастройкиОбменаССайтом.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НастройкиОбменаССайтомОтвет() { Ответ = "НастройкиОбменаССайтом c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НастройкиОбменаССайтомВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НастройкиОбменаССайтом.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
