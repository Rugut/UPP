...
namespace V82.Справочники
{
	...
	public partial class ТарифыБанковНаДенежныеПереводыСервис : Service
	{
		...
		public object Get(ТарифыБанковНаДенежныеПереводыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТарифыБанковНаДенежныеПереводы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТарифыБанковНаДенежныеПереводыОтвет() { Ответ = "ТарифыБанковНаДенежныеПереводы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ТарифыБанковНаДенежныеПереводыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ТарифыБанковНаДенежныеПереводы.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
