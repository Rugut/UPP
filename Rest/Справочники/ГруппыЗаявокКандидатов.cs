...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ГруппыЗаявокКандидатов/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/ГруппыЗаявокКандидатов/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/ГруппыЗаявокКандидатов/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class ГруппыЗаявокКандидатовИерархияВыбратьПоСсылке: V82.СправочникиСсылка.ГруппыЗаявокКандидатов,IReturn<ГруппыЗаявокКандидатовИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/ГруппыЗаявокКандидатов/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class ГруппыЗаявокКандидатовИерархияСтраницаПоСсылке: V82.СправочникиСсылка.ГруппыЗаявокКандидатов,IReturn<ГруппыЗаявокКандидатовИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class ГруппыЗаявокКандидатовСервис : Service
	{
		...
		public object Get(ГруппыЗаявокКандидатовИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.ГруппыЗаявокКандидатов.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(ГруппыЗаявокКандидатовИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
