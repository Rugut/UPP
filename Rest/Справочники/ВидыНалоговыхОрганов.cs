...
namespace V82.Справочники
{
	...
	public partial class ВидыНалоговыхОргановСервис : Service
	{
		
		public object Get(ВидыНалоговыхОргановЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ВидыНалоговыхОргановНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыНалоговыхОрганов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыНалоговыхОргановОтвет() { Ответ = "ВидыНалоговыхОрганов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВидыНалоговыхОргановВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ВидыНалоговыхОрганов.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
