...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ДоговорыКонтрагентов/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/ДоговорыКонтрагентов/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/ДоговорыКонтрагентов/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class ДоговорыКонтрагентовИерархияВыбратьПоСсылке: V82.СправочникиСсылка.ДоговорыКонтрагентов,IReturn<ДоговорыКонтрагентовИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/ДоговорыКонтрагентов/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class ДоговорыКонтрагентовИерархияСтраницаПоСсылке: V82.СправочникиСсылка.ДоговорыКонтрагентов,IReturn<ДоговорыКонтрагентовИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class ДоговорыКонтрагентовСервис : Service
	{
		...
		public object Get(ДоговорыКонтрагентовИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.ДоговорыКонтрагентов.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(ДоговорыКонтрагентовИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
