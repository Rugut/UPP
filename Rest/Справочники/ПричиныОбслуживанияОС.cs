...
namespace V82.Справочники
{
	...
	public partial class ПричиныОбслуживанияОССервис : Service
	{
		
		public object Get(ПричиныОбслуживанияОСЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ПричиныОбслуживанияОСНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПричиныОбслуживанияОС.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПричиныОбслуживанияОСОтвет() { Ответ = "ПричиныОбслуживанияОС c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ПричиныОбслуживанияОСВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ПричиныОбслуживанияОС.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
