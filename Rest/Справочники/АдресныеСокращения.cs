...
namespace V82.Справочники
{
	...
	public partial class АдресныеСокращенияСервис : Service
	{
		...
		public object Get(АдресныеСокращенияНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.АдресныеСокращения.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new АдресныеСокращенияОтвет() { Ответ = "АдресныеСокращения c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(АдресныеСокращенияВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.АдресныеСокращения.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
