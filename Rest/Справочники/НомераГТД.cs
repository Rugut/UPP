...
namespace V82.Справочники
{
	...
	public partial class НомераГТДСервис : Service
	{
		
		public object Get(НомераГТДЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(НомераГТДНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НомераГТД.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НомераГТДОтвет() { Ответ = "НомераГТД c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НомераГТДВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НомераГТД.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
