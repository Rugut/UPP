...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/НематериальныеАктивы/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/НематериальныеАктивы/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/НематериальныеАктивы/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class НематериальныеАктивыИерархияВыбратьПоСсылке: V82.СправочникиСсылка.НематериальныеАктивы,IReturn<НематериальныеАктивыИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/НематериальныеАктивы/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class НематериальныеАктивыИерархияСтраницаПоСсылке: V82.СправочникиСсылка.НематериальныеАктивы,IReturn<НематериальныеАктивыИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class НематериальныеАктивыСервис : Service
	{
		...
		public object Get(НематериальныеАктивыИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.НематериальныеАктивы.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(НематериальныеАктивыИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
