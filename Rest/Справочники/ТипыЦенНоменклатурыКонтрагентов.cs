...
namespace V82.Справочники
{
	...
	public partial class ТипыЦенНоменклатурыКонтрагентовСервис : Service
	{
		...
		public object Get(ТипыЦенНоменклатурыКонтрагентовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТипыЦенНоменклатурыКонтрагентов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТипыЦенНоменклатурыКонтрагентовОтвет() { Ответ = "ТипыЦенНоменклатурыКонтрагентов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
