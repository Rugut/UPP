...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ПараметрыВыпускаПродукции/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/ПараметрыВыпускаПродукции/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/ПараметрыВыпускаПродукции/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class ПараметрыВыпускаПродукцииИерархияВыбратьПоСсылке: V82.СправочникиСсылка.ПараметрыВыпускаПродукции,IReturn<ПараметрыВыпускаПродукцииИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/ПараметрыВыпускаПродукции/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class ПараметрыВыпускаПродукцииИерархияСтраницаПоСсылке: V82.СправочникиСсылка.ПараметрыВыпускаПродукции,IReturn<ПараметрыВыпускаПродукцииИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class ПараметрыВыпускаПродукцииСервис : Service
	{
		...
		public object Get(ПараметрыВыпускаПродукцииИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.ПараметрыВыпускаПродукции.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(ПараметрыВыпускаПродукцииИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
