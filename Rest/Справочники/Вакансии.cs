...
namespace V82.Справочники
{
	...
	public partial class ВакансииСервис : Service
	{
		...
		public object Get(ВакансииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.Вакансии.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВакансииОтвет() { Ответ = "Вакансии c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВакансииВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.Вакансии.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
