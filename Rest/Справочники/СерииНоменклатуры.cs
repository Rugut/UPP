...
namespace V82.Справочники
{
	...
	public partial class СерииНоменклатурыСервис : Service
	{
		...
		public object Get(СерииНоменклатурыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СерииНоменклатуры.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СерииНоменклатурыОтвет() { Ответ = "СерииНоменклатуры c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
