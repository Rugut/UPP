...
namespace V82.Справочники
{
	...
	public partial class ЗваниеГражданскогоВоинскогоУчетаСервис : Service
	{
		...
		public object Get(ЗваниеГражданскогоВоинскогоУчетаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ЗваниеГражданскогоВоинскогоУчета.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ЗваниеГражданскогоВоинскогоУчетаОтвет() { Ответ = "ЗваниеГражданскогоВоинскогоУчета c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
