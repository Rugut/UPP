...
namespace V82.Справочники
{
	...
	public partial class ЯзыкиНародовМираСервис : Service
	{
		...
		public object Get(ЯзыкиНародовМираНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ЯзыкиНародовМира.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ЯзыкиНародовМираОтвет() { Ответ = "ЯзыкиНародовМира c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ЯзыкиНародовМираВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ЯзыкиНародовМира.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
