...
namespace V82.Справочники
{
	...
	public partial class ТипыЗаписейЗаметокСервис : Service
	{
		
		public object Get(ТипыЗаписейЗаметокЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ТипыЗаписейЗаметокНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТипыЗаписейЗаметок.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТипыЗаписейЗаметокОтвет() { Ответ = "ТипыЗаписейЗаметок c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ТипыЗаписейЗаметокВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ТипыЗаписейЗаметок.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
