...
namespace V82.Справочники
{
	...
	public partial class ВидыОбщественноПолезнойДеятельностиСервис : Service
	{
		...
		public object Get(ВидыОбщественноПолезнойДеятельностиНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыОбщественноПолезнойДеятельности.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыОбщественноПолезнойДеятельностиОтвет() { Ответ = "ВидыОбщественноПолезнойДеятельности c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
