...
namespace V82.Справочники
{
	...
	public partial class СпособыОтраженияРасходовПоАмортизацииСервис : Service
	{
		
		public object Get(СпособыОтраженияРасходовПоАмортизацииЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(СпособыОтраженияРасходовПоАмортизацииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СпособыОтраженияРасходовПоАмортизации.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СпособыОтраженияРасходовПоАмортизацииОтвет() { Ответ = "СпособыОтраженияРасходовПоАмортизации c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СпособыОтраженияРасходовПоАмортизацииВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СпособыОтраженияРасходовПоАмортизации.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
