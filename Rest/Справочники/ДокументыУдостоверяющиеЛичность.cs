...
namespace V82.Справочники
{
	...
	public partial class ДокументыУдостоверяющиеЛичностьСервис : Service
	{
		...
		public object Get(ДокументыУдостоверяющиеЛичностьНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДокументыУдостоверяющиеЛичность.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДокументыУдостоверяющиеЛичностьОтвет() { Ответ = "ДокументыУдостоверяющиеЛичность c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ДокументыУдостоверяющиеЛичностьВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ДокументыУдостоверяющиеЛичность.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
