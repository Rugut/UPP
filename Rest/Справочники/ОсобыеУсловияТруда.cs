...
namespace V82.Справочники
{
	...
	public partial class ОсобыеУсловияТрудаСервис : Service
	{
		...
		public object Get(ОсобыеУсловияТрудаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ОсобыеУсловияТруда.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ОсобыеУсловияТрудаОтвет() { Ответ = "ОсобыеУсловияТруда c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ОсобыеУсловияТрудаВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ОсобыеУсловияТруда.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
