...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/СтатьиАналитическогоБаланса/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/СтатьиАналитическогоБаланса/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/СтатьиАналитическогоБаланса/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class СтатьиАналитическогоБалансаИерархияВыбратьПоСсылке: V82.СправочникиСсылка.СтатьиАналитическогоБаланса,IReturn<СтатьиАналитическогоБалансаИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/СтатьиАналитическогоБаланса/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class СтатьиАналитическогоБалансаИерархияСтраницаПоСсылке: V82.СправочникиСсылка.СтатьиАналитическогоБаланса,IReturn<СтатьиАналитическогоБалансаИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class СтатьиАналитическогоБалансаСервис : Service
	{
		...
		public object Get(СтатьиАналитическогоБалансаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СтатьиАналитическогоБаланса.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СтатьиАналитическогоБалансаОтвет() { Ответ = "СтатьиАналитическогоБаланса c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СтатьиАналитическогоБалансаВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СтатьиАналитическогоБаланса.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(СтатьиАналитическогоБалансаИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.СтатьиАналитическогоБаланса.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(СтатьиАналитическогоБалансаИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
