...
namespace V82.Справочники
{
	...
	public partial class ГруппыЗаменяемостиРабочихЦентровСервис : Service
	{
		...
		public object Get(ГруппыЗаменяемостиРабочихЦентровНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ГруппыЗаменяемостиРабочихЦентров.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ГруппыЗаменяемостиРабочихЦентровОтвет() { Ответ = "ГруппыЗаменяемостиРабочихЦентров c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ГруппыЗаменяемостиРабочихЦентровВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ГруппыЗаменяемостиРабочихЦентров.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
