...
namespace V82.Справочники
{
	...
	public partial class ЗаявкиКандидатовСервис : Service
	{
		...
		public object Get(ЗаявкиКандидатовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ЗаявкиКандидатов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ЗаявкиКандидатовОтвет() { Ответ = "ЗаявкиКандидатов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
