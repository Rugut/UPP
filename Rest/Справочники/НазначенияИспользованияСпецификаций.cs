...
namespace V82.Справочники
{
	...
	public partial class НазначенияИспользованияСпецификацийСервис : Service
	{
		...
		public object Get(НазначенияИспользованияСпецификацийНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НазначенияИспользованияСпецификаций.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НазначенияИспользованияСпецификацийОтвет() { Ответ = "НазначенияИспользованияСпецификаций c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
