...
namespace V82.Справочники
{
	...
	public partial class РолиИсполнителейСервис : Service
	{
		...
		public object Get(РолиИсполнителейНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.РолиИсполнителей.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new РолиИсполнителейОтвет() { Ответ = "РолиИсполнителей c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
