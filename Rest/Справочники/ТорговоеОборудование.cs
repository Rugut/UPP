...
namespace V82.Справочники
{
	...
	public partial class ТорговоеОборудованиеСервис : Service
	{
		...
		public object Get(ТорговоеОборудованиеНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТорговоеОборудование.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТорговоеОборудованиеОтвет() { Ответ = "ТорговоеОборудование c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ТорговоеОборудованиеВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ТорговоеОборудование.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
