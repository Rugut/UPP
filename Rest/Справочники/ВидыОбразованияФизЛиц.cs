...
namespace V82.Справочники
{
	...
	public partial class ВидыОбразованияФизЛицСервис : Service
	{
		...
		public object Get(ВидыОбразованияФизЛицНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыОбразованияФизЛиц.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыОбразованияФизЛицОтвет() { Ответ = "ВидыОбразованияФизЛиц c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВидыОбразованияФизЛицВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ВидыОбразованияФизЛиц.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
