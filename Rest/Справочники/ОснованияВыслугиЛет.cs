...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ОснованияВыслугиЛет/ВыбратьПоСсылке","{___Первые}")]
	[Маршрут("Справочники/ОснованияВыслугиЛет/ВыбратьПоСсылке","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ОснованияВыслугиЛет/ВыбратьПоКоду","{___Первые}")]
	[Маршрут("Справочники/ОснованияВыслугиЛет/ВыбратьПоКоду","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ОснованияВыслугиЛет/ВыбратьПоНаименованию","{___Первые}")]
	[Маршрут("Справочники/ОснованияВыслугиЛет/ВыбратьПоНаименованию","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ОснованияВыслугиЛет/СтраницаПоСсылке","{___Размер}/{___Номер}")]
	public class ОснованияВыслугиЛетСтраницаПоСсылке: V82.СправочникиСсылка.ОснованияВыслугиЛет,IReturn<ОснованияВыслугиЛетСтраницаПоСсылке>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/ОснованияВыслугиЛет/СтраницаПоКоду","{___Размер}/{___Номер}")]
	public class ОснованияВыслугиЛетСтраницаПоКоду: V82.СправочникиСсылка.ОснованияВыслугиЛет,IReturn<ОснованияВыслугиЛетСтраницаПоКоду>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/ОснованияВыслугиЛет/СтраницаПоНаименованию","{___Размер}/{___Номер}")]
	public class ОснованияВыслугиЛетСтраницаПоНаименованию: V82.СправочникиСсылка.ОснованияВыслугиЛет,IReturn<ОснованияВыслугиЛетСтраницаПоНаименованию>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	...
	public partial class ОснованияВыслугиЛетСервис : Service
	{
		
		public object Get(ОснованияВыслугиЛетЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ОснованияВыслугиЛетНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ОснованияВыслугиЛет.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ОснованияВыслугиЛетОтвет() { Ответ = "ОснованияВыслугиЛет c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ОснованияВыслугиЛетВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ОснованияВыслугиЛет.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(ОснованияВыслугиЛетСтраницаПоСсылке Запрос)
		{
			return null;
		}
		
		public object Get(ОснованияВыслугиЛетСтраницаПоКоду Запрос)
		{
			return null;
		}
		
		public object Get(ОснованияВыслугиЛетСтраницаПоНаименованию Запрос)
		{
			return null;
		}
