...
namespace V82.Справочники
{
	...
	public partial class БланкиСтрогойОтчетностиСервис : Service
	{
		
		public object Get(БланкиСтрогойОтчетностиЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(БланкиСтрогойОтчетностиНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.БланкиСтрогойОтчетности.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new БланкиСтрогойОтчетностиОтвет() { Ответ = "БланкиСтрогойОтчетности c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(БланкиСтрогойОтчетностиВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.БланкиСтрогойОтчетности.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
