...
namespace V82.Справочники
{
	...
	public partial class ХарактеристикиНоменклатурыСервис : Service
	{
		...
		public object Get(ХарактеристикиНоменклатурыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ХарактеристикиНоменклатуры.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ХарактеристикиНоменклатурыОтвет() { Ответ = "ХарактеристикиНоменклатуры c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ХарактеристикиНоменклатурыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ХарактеристикиНоменклатуры.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
