...
namespace V82.Справочники
{
	...
	public partial class ВидыОбслуживанияОсновныхСредствСервис : Service
	{
		...
		public object Get(ВидыОбслуживанияОсновныхСредствНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыОбслуживанияОсновныхСредств.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыОбслуживанияОсновныхСредствОтвет() { Ответ = "ВидыОбслуживанияОсновныхСредств c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВидыОбслуживанияОсновныхСредствВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ВидыОбслуживанияОсновныхСредств.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
