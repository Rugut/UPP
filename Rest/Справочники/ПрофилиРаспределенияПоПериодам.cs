...
namespace V82.Справочники
{
	...
	public partial class ПрофилиРаспределенияПоПериодамСервис : Service
	{
		...
		public object Get(ПрофилиРаспределенияПоПериодамНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ПрофилиРаспределенияПоПериодам.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ПрофилиРаспределенияПоПериодамОтвет() { Ответ = "ПрофилиРаспределенияПоПериодам c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
