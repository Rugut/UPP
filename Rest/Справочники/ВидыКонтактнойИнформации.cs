...
namespace V82.Справочники
{
	...
	public partial class ВидыКонтактнойИнформацииСервис : Service
	{
		
		public object Get(ВидыКонтактнойИнформацииЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ВидыКонтактнойИнформацииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыКонтактнойИнформации.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыКонтактнойИнформацииОтвет() { Ответ = "ВидыКонтактнойИнформации c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВидыКонтактнойИнформацииВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ВидыКонтактнойИнформации.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
