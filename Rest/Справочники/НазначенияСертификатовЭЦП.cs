...
namespace V82.Справочники
{
	...
	public partial class НазначенияСертификатовЭЦПСервис : Service
	{
		...
		public object Get(НазначенияСертификатовЭЦПНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НазначенияСертификатовЭЦП.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НазначенияСертификатовЭЦПОтвет() { Ответ = "НазначенияСертификатовЭЦП c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НазначенияСертификатовЭЦПВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НазначенияСертификатовЭЦП.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
