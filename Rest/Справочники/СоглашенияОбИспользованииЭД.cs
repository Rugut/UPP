...
namespace V82.Справочники
{
	...
	public partial class СоглашенияОбИспользованииЭДСервис : Service
	{
		...
		public object Get(СоглашенияОбИспользованииЭДНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СоглашенияОбИспользованииЭД.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СоглашенияОбИспользованииЭДОтвет() { Ответ = "СоглашенияОбИспользованииЭД c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СоглашенияОбИспользованииЭДВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СоглашенияОбИспользованииЭД.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
