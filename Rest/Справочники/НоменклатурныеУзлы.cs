...
namespace V82.Справочники
{
	...
	public partial class НоменклатурныеУзлыСервис : Service
	{
		
		public object Get(НоменклатурныеУзлыЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(НоменклатурныеУзлыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НоменклатурныеУзлы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НоменклатурныеУзлыОтвет() { Ответ = "НоменклатурныеУзлы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НоменклатурныеУзлыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НоменклатурныеУзлы.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
