...
namespace V82.Справочники
{
	...
	public partial class ДоверенностиНалогоплательщикаСервис : Service
	{
		...
		public object Get(ДоверенностиНалогоплательщикаНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДоверенностиНалогоплательщика.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДоверенностиНалогоплательщикаОтвет() { Ответ = "ДоверенностиНалогоплательщика c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
