...
namespace V82.Справочники
{
	...
	public partial class НастройкаИнтерваловСервис : Service
	{
		...
		public object Get(НастройкаИнтерваловНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.НастройкаИнтервалов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new НастройкаИнтерваловОтвет() { Ответ = "НастройкаИнтервалов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(НастройкаИнтерваловВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.НастройкаИнтервалов.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
