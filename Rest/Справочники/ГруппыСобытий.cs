...
namespace V82.Справочники
{
	...
	public partial class ГруппыСобытийСервис : Service
	{
		...
		public object Get(ГруппыСобытийНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ГруппыСобытий.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ГруппыСобытийОтвет() { Ответ = "ГруппыСобытий c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
