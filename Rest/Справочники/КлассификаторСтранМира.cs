...
namespace V82.Справочники
{
	...
	public partial class КлассификаторСтранМираСервис : Service
	{
		...
		public object Get(КлассификаторСтранМираНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.КлассификаторСтранМира.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КлассификаторСтранМираОтвет() { Ответ = "КлассификаторСтранМира c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(КлассификаторСтранМираВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.КлассификаторСтранМира.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
