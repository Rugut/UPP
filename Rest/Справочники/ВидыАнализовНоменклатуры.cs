...
namespace V82.Справочники
{
	...
	public partial class ВидыАнализовНоменклатурыСервис : Service
	{
		...
		public object Get(ВидыАнализовНоменклатурыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыАнализовНоменклатуры.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыАнализовНоменклатурыОтвет() { Ответ = "ВидыАнализовНоменклатуры c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
