...
namespace V82.Справочники
{
	...
	public partial class ВидыЗадачПользователейСервис : Service
	{
		...
		public object Get(ВидыЗадачПользователейНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыЗадачПользователей.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыЗадачПользователейОтвет() { Ответ = "ВидыЗадачПользователей c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
