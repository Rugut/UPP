...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ВидыОплатЧекаККМ/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/ВидыОплатЧекаККМ/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/ВидыОплатЧекаККМ/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class ВидыОплатЧекаККМИерархияВыбратьПоСсылке: V82.СправочникиСсылка.ВидыОплатЧекаККМ,IReturn<ВидыОплатЧекаККМИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/ВидыОплатЧекаККМ/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class ВидыОплатЧекаККМИерархияСтраницаПоСсылке: V82.СправочникиСсылка.ВидыОплатЧекаККМ,IReturn<ВидыОплатЧекаККМИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class ВидыОплатЧекаККМСервис : Service
	{
		...
		public object Get(ВидыОплатЧекаККМНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыОплатЧекаККМ.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыОплатЧекаККМОтвет() { Ответ = "ВидыОплатЧекаККМ c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВидыОплатЧекаККМИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.ВидыОплатЧекаККМ.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(ВидыОплатЧекаККМИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
