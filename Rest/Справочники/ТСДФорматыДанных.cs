...
namespace V82.Справочники
{
	...
	public partial class ТСДФорматыДанныхСервис : Service
	{
		...
		public object Get(ТСДФорматыДанныхНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТСДФорматыДанных.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТСДФорматыДанныхОтвет() { Ответ = "ТСДФорматыДанных c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ТСДФорматыДанныхВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ТСДФорматыДанных.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
