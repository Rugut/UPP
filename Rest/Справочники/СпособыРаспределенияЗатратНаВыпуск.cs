...
namespace V82.Справочники
{
	...
	public partial class СпособыРаспределенияЗатратНаВыпускСервис : Service
	{
		...
		public object Get(СпособыРаспределенияЗатратНаВыпускНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СпособыРаспределенияЗатратНаВыпуск.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СпособыРаспределенияЗатратНаВыпускОтвет() { Ответ = "СпособыРаспределенияЗатратНаВыпуск c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СпособыРаспределенияЗатратНаВыпускВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СпособыРаспределенияЗатратНаВыпуск.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
