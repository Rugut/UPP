...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/ВыбратьПоСсылке","{___Первые}")]
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/ВыбратьПоСсылке","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/ВыбратьПоКоду","{___Первые}")]
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/ВыбратьПоКоду","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/ВыбратьПоНаименованию","{___Первые}")]
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/ВыбратьПоНаименованию","{___Первые}/{___Мин}")]
	...
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/СтраницаПоСсылке","{___Размер}/{___Номер}")]
	public class ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоСсылке: V82.СправочникиСсылка.ДокументыРеализацииПолномочийНалоговыхОрганов,IReturn<ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоСсылке>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/СтраницаПоКоду","{___Размер}/{___Номер}")]
	public class ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоКоду: V82.СправочникиСсылка.ДокументыРеализацииПолномочийНалоговыхОрганов,IReturn<ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоКоду>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	[Маршрут("Справочники/ДокументыРеализацииПолномочийНалоговыхОрганов/СтраницаПоНаименованию","{___Размер}/{___Номер}")]
	public class ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоНаименованию: V82.СправочникиСсылка.ДокументыРеализацииПолномочийНалоговыхОрганов,IReturn<ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоНаименованию>
	{
		public int ___Размер {get; set;}
		public int ___Номер {get; set;}
	}
	...
	public partial class ДокументыРеализацииПолномочийНалоговыхОргановСервис : Service
	{
		
		public object Get(ДокументыРеализацииПолномочийНалоговыхОргановЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ДокументыРеализацииПолномочийНалоговыхОргановНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДокументыРеализацииПолномочийНалоговыхОрганов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДокументыРеализацииПолномочийНалоговыхОргановОтвет() { Ответ = "ДокументыРеализацииПолномочийНалоговыхОрганов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ДокументыРеализацииПолномочийНалоговыхОргановВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ДокументыРеализацииПолномочийНалоговыхОрганов.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
		...
		public object Get(ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоСсылке Запрос)
		{
			return null;
		}
		
		public object Get(ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоКоду Запрос)
		{
			return null;
		}
		
		public object Get(ДокументыРеализацииПолномочийНалоговыхОргановСтраницаПоНаименованию Запрос)
		{
			return null;
		}
