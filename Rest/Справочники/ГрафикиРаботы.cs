...
namespace V82.Справочники
{
	...
	public partial class ГрафикиРаботыСервис : Service
	{
		...
		public object Get(ГрафикиРаботыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ГрафикиРаботы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ГрафикиРаботыОтвет() { Ответ = "ГрафикиРаботы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
