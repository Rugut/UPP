...
namespace V82.Справочники
{
	...
	public partial class ХранилищеДополнительнойИнформацииСервис : Service
	{
		...
		public object Get(ХранилищеДополнительнойИнформацииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ХранилищеДополнительнойИнформации.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ХранилищеДополнительнойИнформацииОтвет() { Ответ = "ХранилищеДополнительнойИнформации c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ХранилищеДополнительнойИнформацииВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ХранилищеДополнительнойИнформации.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
