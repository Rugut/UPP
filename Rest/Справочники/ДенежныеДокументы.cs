...
namespace V82.Справочники
{
	...
	[Маршрут("Справочники/ДенежныеДокументы/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}")]
	[Маршрут("Справочники/ДенежныеДокументы/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}")]
	[Маршрут("Справочники/ДенежныеДокументы/ИерархияВыбратьПоСсылке","{___Родитель}/{___Режим}/{___Первые}/{___Мин}/{___Макс}")]
	public class ДенежныеДокументыИерархияВыбратьПоСсылке: V82.СправочникиСсылка.ДенежныеДокументы,IReturn<ДенежныеДокументыИерархияВыбратьПоСсылке>
	{
	...
	[Маршрут("Справочники/ДенежныеДокументы/ИерархияСтраницаПоСсылке","{___Родитель}/{___Режим}/{___Размер}/{___Номер}")]
	public class ДенежныеДокументыИерархияСтраницаПоСсылке: V82.СправочникиСсылка.ДенежныеДокументы,IReturn<ДенежныеДокументыИерархияСтраницаПоСсылке>
	{
		public Guid ___Родитель {get; set;}
		public int ___Режим {get; set;}
		public int ___Размер {get; set;}
	...
	public partial class ДенежныеДокументыСервис : Service
	{
		...
		public object Get(ДенежныеДокументыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДенежныеДокументы.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДенежныеДокументыОтвет() { Ответ = "ДенежныеДокументы c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ДенежныеДокументыИерархияВыбратьПоСсылке Запрос)
		{
			if (Запрос.___Макс == Guid.Empty)
			{
				Запрос.___Макс = Guid.Parse("ffffffff-ffff-ffff-ffff-ffffffffffff");
			...
			var Коллекция = new List<object>();
			foreach (var Ссылка in V82.Справочники.ДенежныеДокументы.ИерархияВыбратьПоСсылке(Запрос.___Родитель,Запрос.___Режим,Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
				Коллекция.Add(Ссылка.ПолучитьОбъект());
			}
			return Коллекция;
		...
		public object Get(ДенежныеДокументыИерархияСтраницаПоСсылке Запрос)
		{
			return null;
		}
