...
namespace V82.Справочники
{
	...
	public partial class ДокументыОбОбразованииСервис : Service
	{
		...
		public object Get(ДокументыОбОбразованииНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ДокументыОбОбразовании.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ДокументыОбОбразованииОтвет() { Ответ = "ДокументыОбОбразовании c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
