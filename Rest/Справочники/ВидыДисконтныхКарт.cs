...
namespace V82.Справочники
{
	...
	public partial class ВидыДисконтныхКартСервис : Service
	{
		
		public object Get(ВидыДисконтныхКартЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(ВидыДисконтныхКартНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ВидыДисконтныхКарт.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ВидыДисконтныхКартОтвет() { Ответ = "ВидыДисконтныхКарт c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ВидыДисконтныхКартВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ВидыДисконтныхКарт.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
