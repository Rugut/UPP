...
namespace V82.Справочники
{
	...
	public partial class ГодовыеГрафикиАмортизацииОССервис : Service
	{
		...
		public object Get(ГодовыеГрафикиАмортизацииОСНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ГодовыеГрафикиАмортизацииОС.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ГодовыеГрафикиАмортизацииОСОтвет() { Ответ = "ГодовыеГрафикиАмортизацииОС c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ГодовыеГрафикиАмортизацииОСВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ГодовыеГрафикиАмортизацииОС.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
