...
namespace V82.Справочники
{
	...
	public partial class ГруппыДоступностиСкладовСервис : Service
	{
		...
		public object Get(ГруппыДоступностиСкладовНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ГруппыДоступностиСкладов.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ГруппыДоступностиСкладовОтвет() { Ответ = "ГруппыДоступностиСкладов c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ГруппыДоступностиСкладовВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ГруппыДоступностиСкладов.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
