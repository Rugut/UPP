...
namespace V82.Справочники
{
	...
	public partial class СохраненныеНастройкиСервис : Service
	{
		...
		public object Get(СохраненныеНастройкиНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.СохраненныеНастройки.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new СохраненныеНастройкиОтвет() { Ответ = "СохраненныеНастройки c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(СохраненныеНастройкиВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.СохраненныеНастройки.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
