...
namespace V82.Справочники
{
	...
	public partial class ТипыЦенНоменклатурыСервис : Service
	{
		...
		public object Get(ТипыЦенНоменклатурыНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ТипыЦенНоменклатуры.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ТипыЦенНоменклатурыОтвет() { Ответ = "ТипыЦенНоменклатуры c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(ТипыЦенНоменклатурыВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.ТипыЦенНоменклатуры.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
