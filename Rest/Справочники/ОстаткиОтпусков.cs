...
namespace V82.Справочники
{
	...
	public partial class ОстаткиОтпусковСервис : Service
	{
		...
		public object Get(ОстаткиОтпусковНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.ОстаткиОтпусков.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new ОстаткиОтпусковОтвет() { Ответ = "ОстаткиОтпусков c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
