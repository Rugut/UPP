...
namespace V82.Справочники
{
	...
	public partial class КачествоСервис : Service
	{
		...
		public object Get(КачествоНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.Качество.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КачествоОтвет() { Ответ = "Качество c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(КачествоВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.Качество.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
