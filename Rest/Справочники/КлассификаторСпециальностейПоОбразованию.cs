...
namespace V82.Справочники
{
	...
	public partial class КлассификаторСпециальностейПоОбразованиюСервис : Service
	{
		
		public object Get(КлассификаторСпециальностейПоОбразованиюЗапрос Запрос)
		{
			return null;
		}
		...
		public object Get(КлассификаторСпециальностейПоОбразованиюНайтиПоСсылке Запрос)
		{
			...
			var Ссылка = V82.Справочники.КлассификаторСпециальностейПоОбразованию.НайтиПоСсылке(Запрос.Ссылка);
			if (Ссылка == null)
			{
				return new КлассификаторСпециальностейПоОбразованиюОтвет() { Ответ = "КлассификаторСпециальностейПоОбразованию c ссылкой '" + Запрос.Ссылка + "' не найден." };
			}
		...
		public object Get(КлассификаторСпециальностейПоОбразованиюВыбратьПоСсылке Запрос)
		{
			...
			foreach (var Ссылка in V82.Справочники.КлассификаторСпециальностейПоОбразованию.ВыбратьПоСсылке(Запрос.___Первые, Запрос.___Мин, Запрос.___Макс))
			{
