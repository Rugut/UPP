Ext.define('Отчеты.ОборотыСчетаНалоговый.Форма',
	...
	[
		...
		},
		{
			...
			name: 'НадписьСчет',
			text: 'Счет:',
			style: 'position:absolute;left:273px;top:33px;width:32px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Организация:',
			style: 'position:absolute;left:393px;top:33px;width:76px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Вид учета:',
			style: 'position:absolute;left:607px;top:33px;width:56px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
