Ext.require(['Данные.Отчеты.РеестрПолучателейСтраховогоОбеспечения'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/РеестрПолучателейСтраховогоОбеспечения/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РеестрПолучателейСтраховогоОбеспечения.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РеестрПолучателейСтраховогоОбеспечения.ФормаОтчетаСобытия");
