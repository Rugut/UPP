...
{
	Ext.define('Отчеты.РегламентированныйОтчетАлкоПриложение5.ФормаОтчета2006Кв2',
	{
	...
	[{
		...
		{
			xtype: 'combobox',
			style: 'position:absolute;left:199px;top:22px;width:116px;height:19px;',
			width: 116,
			height: 19,
		},
		{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАлкоПриложение5.ФормаОтчета2006Кв2События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАлкоПриложение5.ФормаОтчета2006Кв2События");
