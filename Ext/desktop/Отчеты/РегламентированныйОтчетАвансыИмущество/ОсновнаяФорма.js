...
{
	Ext.define('Отчеты.РегламентированныйОтчетАвансыИмущество.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Авансы по налогу на имущество',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАвансыИмущество.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАвансыИмущество.ОсновнаяФормаСобытия");
