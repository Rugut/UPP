Ext.require(['Данные.Отчеты.РегламентированныйОтчетДоходыИностраннымОрганизациям'], function () 
{
	Ext.define('Отчеты.РегламентированныйОтчетДоходыИностраннымОрганизациям.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Доходы, выплаченные иностранным организациям',
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:14px;top:158px;width:248px;height:40px;text-align:left;',
		},
		{
			xtype: 'button',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетДоходыИностраннымОрганизациям.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетДоходыИностраннымОрганизациям.ОсновнаяФормаСобытия");
