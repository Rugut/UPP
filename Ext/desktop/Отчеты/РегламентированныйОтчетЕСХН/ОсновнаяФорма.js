...
{
	Ext.define('Отчеты.РегламентированныйОтчетЕСХН.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Декларация по единому с/х налогу',
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:8px;top:60px;width:253px;height:15px;',
		},
		{
			xtype: 'fieldset',
			title: 'Форма',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЕСХН.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЕСХН.ОсновнаяФормаСобытия");
