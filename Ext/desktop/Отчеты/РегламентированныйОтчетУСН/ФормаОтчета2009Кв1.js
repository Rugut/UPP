Ext.require(['Данные.Отчеты.РегламентированныйОтчетУСН'], function () 
{
	...
	[{
		...
		{
			xtype: 'combobox',
			style: 'position:absolute;left:6px;top:267px;width:220px;height:19px;',
			width: 220,
			height: 19,
		},
		{
			...
			style: 'position:absolute;left:233px;top:267px;width:117px;height:19px;',
			width: 117,
			height: 19,
		},
		{
			...
			width: 291,
			height: 19,
			style: 'position:absolute;left:355px;top:267px;width:291px;height:19px;',
		},
					]
				},
			]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетУСН.ФормаОтчета2009Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетУСН.ФормаОтчета2009Кв1События");
