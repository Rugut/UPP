	...
	[{
					...
					[
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Нижняя: { Элемент: 'ПолеВыбораВариантЗаполненияРаздел2', Граница: 'Верхняя', Номер: 407, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: 'Форма', Граница: 'Правая', Номер: 0, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'ПолеВводаЗначениеКорректировкиРаздел2', Граница: 'Левая', Номер: 408, Координата: 0},
					Левая: { Элемент: '', Граница: 'Правая', Номер: 407, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 51, Координата: 0},
					Нижняя: { Элемент: 'ПолеВводаЗначениеКорректировкиРаздел2', Граница: 'Верхняя', Номер: 408, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Правая', Номер: 407, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 51, Координата: 0},
					Нижняя: { Элемент: 'ПолеВводаКомментарийРаздел2', Граница: 'Верхняя', Номер: 409, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: 'Форма', Граница: 'Левая', Номер: 0, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'Статус', Граница: 'Верхняя', Номер: 411, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
