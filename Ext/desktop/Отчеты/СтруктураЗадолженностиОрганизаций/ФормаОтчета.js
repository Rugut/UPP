Ext.require(['Данные.Отчеты.СтруктураЗадолженностиОрганизаций'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СтруктураЗадолженностиОрганизаций/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СтруктураЗадолженностиОрганизаций.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СтруктураЗадолженностиОрганизаций.ФормаОтчетаСобытия");
