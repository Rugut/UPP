...
{
	Ext.define('Отчеты.РегламентированныйОтчетНДС0.ФормаОтчета2004Кв1',
	{
	...
	[{
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:8px;top:123px;width:654px;height:312px;',
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:8px;top:74px;width:654px;height:49px;',
			height: 49,width: 654,
			tabBar:{hidden:true},
			items:
			[
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетНДС0.ФормаОтчета2004Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетНДС0.ФормаОтчета2004Кв1События");
