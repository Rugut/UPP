...
{
	Ext.define('Отчеты.РегламентированныйОтчетСтатистика1Квотирование.ФормаОтчета2009Кв3',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетСтатистика1Квотирование.ФормаОтчета2009Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетСтатистика1Квотирование.ФормаОтчета2009Кв3События");
