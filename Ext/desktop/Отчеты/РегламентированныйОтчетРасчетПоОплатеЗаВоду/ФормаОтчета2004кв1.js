Ext.require(['Данные.Отчеты.РегламентированныйОтчетРасчетПоОплатеЗаВоду'], function () 
{
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:0px;top:24px;width:246px;height:19px;',
		},
		{
			xtype: 'combobox',
			style: 'position:absolute;left:257px;top:23px;width:116px;height:19px;',
		},
		{
			xtype: 'numberfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетРасчетПоОплатеЗаВоду.ФормаОтчета2004кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетРасчетПоОплатеЗаВоду.ФормаОтчета2004кв1События");
