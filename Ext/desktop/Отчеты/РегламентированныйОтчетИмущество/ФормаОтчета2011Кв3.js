...
{
	Ext.define('Отчеты.РегламентированныйОтчетИмущество.ФормаОтчета2011Кв3',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетИмущество.ФормаОтчета2011Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетИмущество.ФормаОтчета2011Кв3События");
