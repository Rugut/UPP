...
{
	Ext.define('Отчеты.РегламентированныйОтчетИмущество.ФормаОтчета2004Кв1',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетИмущество.ФормаОтчета2004Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетИмущество.ФормаОтчета2004Кв1События");
