...
{
	Ext.define('Отчеты.РегламентированныйОтчетСтатистикаФормаП5М.ФормаОтчета2008Кв1',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетСтатистикаФормаП5М.ФормаОтчета2008Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетСтатистикаФормаП5М.ФормаОтчета2008Кв1События");
