	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.АнализСубконтоНалоговый.ФормаНастройкаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.АнализСубконтоНалоговый.ФормаНастройкаСобытия");
		...
		},
		{
			...
			style: 'position:absolute;left:266px;top:120px;width:142px;height:15px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			height: 19,
			Хранилище:'Ссылка',
			style: 'position:absolute;left:348px;top:31px;width:60px;height:19px;',
			onTriggerClick : function(ЭтотОбъект)
			{
				var СтрокаЗнч = ЭтотОбъект.target.className;
				var Элемент = this.up('window');
