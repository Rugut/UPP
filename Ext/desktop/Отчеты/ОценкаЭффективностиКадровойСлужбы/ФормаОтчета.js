Ext.require(['Данные.Отчеты.ОценкаЭффективностиКадровойСлужбы'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ОценкаЭффективностиКадровойСлужбы/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОценкаЭффективностиКадровойСлужбы.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОценкаЭффективностиКадровойСлужбы.ФормаОтчетаСобытия");
