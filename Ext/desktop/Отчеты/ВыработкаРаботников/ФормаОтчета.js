Ext.require(['Данные.Отчеты.ВыработкаРаботников'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ВыработкаРаботников/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВыработкаРаботников.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВыработкаРаботников.ФормаОтчетаСобытия");
