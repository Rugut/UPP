Ext.require(['Данные.Отчеты.ИсполнениеКадровогоПлана'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ИсполнениеКадровогоПлана/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ИсполнениеКадровогоПлана.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ИсполнениеКадровогоПлана.ФормаОтчетаСобытия");
