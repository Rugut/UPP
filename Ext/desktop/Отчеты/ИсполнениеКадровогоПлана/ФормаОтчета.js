Ext.define('Отчеты.ИсполнениеКадровогоПлана.ФормаОтчета',
	{
	extend: 'Ext.window.Window',
	style: 'position:absolute;width:838px;height:540px;',
	iconCls: 'bogus',
	minimizable: true,
	maximizable: true,
	...
	[
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:674px;top:101px;width:157px;height:24px;',
			items:
			[
				{
					text:'',
