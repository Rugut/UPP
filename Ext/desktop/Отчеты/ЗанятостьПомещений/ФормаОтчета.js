Ext.require(['Данные.Отчеты.ЗанятостьПомещений'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ЗанятостьПомещений/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ЗанятостьПомещений.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ЗанятостьПомещений.ФормаОтчетаСобытия");
