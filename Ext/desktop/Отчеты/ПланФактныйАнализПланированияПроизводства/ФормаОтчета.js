Ext.require(['Данные.Отчеты.ПланФактныйАнализПланированияПроизводства'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ПланФактныйАнализПланированияПроизводства/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПланФактныйАнализПланированияПроизводства.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПланФактныйАнализПланированияПроизводства.ФормаОтчетаСобытия");
