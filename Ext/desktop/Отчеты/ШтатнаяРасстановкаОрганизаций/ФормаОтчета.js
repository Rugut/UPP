Ext.define('Отчеты.ШтатнаяРасстановкаОрганизаций.ФормаОтчета',
	{
	...
	[
		...
		},
		{
			...
			name: 'Сформировать',
			text: 'Сформировать',
			style: 'position:absolute;left:5px;top:99px;width:124px;height:30px;',
		},
		{
			xtype: 'tabpanel',
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:572px;top:101px;width:259px;height:24px;',
			items:
			[
				{
					text:'',
