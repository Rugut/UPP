Ext.require(['Данные.Отчеты.ШтатнаяРасстановкаОрганизаций'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ШтатнаяРасстановкаОрганизаций/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ШтатнаяРасстановкаОрганизаций.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ШтатнаяРасстановкаОрганизаций.ФормаОтчетаСобытия");
