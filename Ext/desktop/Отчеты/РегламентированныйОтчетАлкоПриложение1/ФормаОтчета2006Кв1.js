...
{
	Ext.define('Отчеты.РегламентированныйОтчетАлкоПриложение1.ФормаОтчета2006Кв1',
	{
	...
	[{
		...
		{
			xtype: 'combobox',
			style: 'position:absolute;left:199px;top:24px;width:116px;height:19px;',
			width: 116,
			height: 19,
		},
		{
			...
			style: 'position:absolute;left:331px;top:24px;width:49px;height:19px;',
			width: 49,
			height: 19,
		},
					]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАлкоПриложение1.ФормаОтчета2006Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАлкоПриложение1.ФормаОтчета2006Кв1События");
