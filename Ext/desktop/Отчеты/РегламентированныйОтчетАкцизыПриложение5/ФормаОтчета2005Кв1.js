Ext.require(['Данные.Отчеты.РегламентированныйОтчетАкцизыПриложение5'], function () 
{
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:344px;top:265px;width:136px;height:19px;text-align:left;',
		},
					]
				},
				{
		...
		},
		{
			...
			text: '999 из 999',
			style: 'position:absolute;left:286px;top:239px;width:80px;height:19px;text-align:center;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАкцизыПриложение5.ФормаОтчета2005Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАкцизыПриложение5.ФормаОтчета2005Кв1События");
