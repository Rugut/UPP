Ext.require(['Данные.Отчеты.РегламентированныйОтчетПрибыльИностраннойОрганизации'], function () 
{
	...
	[{
		...
		{
			xtype: 'label',
			name: 'НадписьСтатикСтраницРаздел11_Прил2',
			text: '999 из 999',
			style: 'position:absolute;left:287px;top:265px;width:80px;height:19px;text-align:center;',
		},
		{
			xtype: 'label',
			name: 'НадписьСтатикСтраницРаздел11_Прил1',
			text: '999 из 999',
			style: 'position:absolute;left:287px;top:265px;width:80px;height:19px;text-align:center;',
		},
		{
		...
		{
			xtype: 'label',
			name: 'НадписьСтатикСтраницРаздел7',
			text: '999 из 999',
			style: 'position:absolute;left:286px;top:241px;width:80px;height:19px;text-align:center;',
		},
					]
