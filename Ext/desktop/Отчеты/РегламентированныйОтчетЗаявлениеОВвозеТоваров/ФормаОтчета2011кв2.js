...
{
	Ext.define('Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ФормаОтчета2011кв2',
	{
	...
	[{
		...
		{
			xtype: 'label',
			name: 'НадписьСтатикСтраницЗачет',
			text: '999 из 999',
			style: 'position:absolute;left:288px;top:241px;width:80px;height:19px;text-align:center;',
		},
					]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ФормаОтчета2011кв2События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ФормаОтчета2011кв2События");
