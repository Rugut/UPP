...
{
	Ext.define('Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ФормаОтчета2011кв3',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ФормаОтчета2011кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЗаявлениеОВвозеТоваров.ФормаОтчета2011кв3События");
