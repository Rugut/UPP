Ext.define('Отчеты.ДанныеДляКарточкиУчетаОрганизацииВВоенкомате.ОсновнаяФормаОтчета',
	{
	...
	[
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:667px;top:101px;width:164px;height:24px;',
			items:
			[
				{
					text:'',
