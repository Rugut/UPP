Ext.require(['Данные.Отчеты.СводНачисленнойЗарплаты'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СводНачисленнойЗарплаты/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СводНачисленнойЗарплаты.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СводНачисленнойЗарплаты.ФормаОтчетаСобытия");
