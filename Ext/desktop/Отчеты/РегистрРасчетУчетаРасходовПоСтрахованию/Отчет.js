Ext.require(['Данные.Отчеты.РегистрРасчетУчетаРасходовПоСтрахованию'], function () 
{
	...
	[{
		...
		[
		{
			...
			name: 'Надпись1',
			text: 'Организация:',
			style: 'position:absolute;left:290px;top:33px;width:76px;height:19px;text-align:left;',
		},
		{
			xtype: 'trigger',
			hideLabel: true,
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрРасчетУчетаРасходовПоСтрахованию.ОтчетСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрРасчетУчетаРасходовПоСтрахованию.ОтчетСобытия");
