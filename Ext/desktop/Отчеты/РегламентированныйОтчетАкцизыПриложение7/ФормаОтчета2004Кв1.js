Ext.require(['Данные.Отчеты.РегламентированныйОтчетАкцизыПриложение7'], function () 
{
	Ext.define('Отчеты.РегламентированныйОтчетАкцизыПриложение7.ФормаОтчета2004Кв1',
	{
	...
	[{
		...
		{
			xtype: 'combobox',
			style: 'position:absolute;left:425px;top:25px;width:116px;height:19px;',
			width: 116,
			height: 19,
		},
		{
			...
			style: 'position:absolute;left:556px;top:25px;width:49px;height:19px;',
			width: 49,
			height: 19,
		},
					]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАкцизыПриложение7.ФормаОтчета2004Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАкцизыПриложение7.ФормаОтчета2004Кв1События");
