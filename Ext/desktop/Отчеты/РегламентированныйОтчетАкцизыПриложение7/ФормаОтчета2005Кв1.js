...
{
	Ext.define('Отчеты.РегламентированныйОтчетАкцизыПриложение7.ФормаОтчета2005Кв1',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Декларация по акцизу на подакцизное минеральное сырье (природный газ)',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАкцизыПриложение7.ФормаОтчета2005Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАкцизыПриложение7.ФормаОтчета2005Кв1События");
