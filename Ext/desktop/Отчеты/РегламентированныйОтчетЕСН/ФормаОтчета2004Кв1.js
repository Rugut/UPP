Ext.require(['Данные.Отчеты.РегламентированныйОтчетЕСН'], function () 
{
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:171px;top:29px;width:247px;height:19px;',
		},
		{
			xtype: 'combobox',
			style: 'position:absolute;left:428px;top:29px;width:116px;height:19px;',
			width: 116,
			height: 19,
		},
		{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЕСН.ФормаОтчета2004Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЕСН.ФормаОтчета2004Кв1События");
