Ext.require(['Данные.Отчеты.РегламентированныйОтчетЕСН'], function () 
{
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:160px;top:265px;width:148px;height:19px;text-align:left;',
		},
		{
			xtype: 'panel',
					...
					[
		{
			...
			text: '999 из 999',
			style: 'position:absolute;left:332px;top:265px;width:80px;height:19px;text-align:center;',
		},
		{
			xtype: 'panel',
			style: 'position:absolute;left:6px;top:260px;width:691px;height:24px;',
		...
		},
		{
			...
			style: 'position:absolute;left:270px;top:0px;width:105px;height:19px;',
		},
					]
				},
			]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЕСН.ФормаОтчета2006Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЕСН.ФормаОтчета2006Кв1События");
