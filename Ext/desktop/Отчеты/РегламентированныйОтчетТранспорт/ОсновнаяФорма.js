Ext.require(['Данные.Отчеты.РегламентированныйОтчетТранспорт'], function () 
{
	...
	[{
		...
		[
		{
			...
			style: 'position:absolute;left:36px;top:105px;width:203px;height:19px;text-align:center;',
		},
		{
			xtype: 'button',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетТранспорт.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетТранспорт.ОсновнаяФормаСобытия");
