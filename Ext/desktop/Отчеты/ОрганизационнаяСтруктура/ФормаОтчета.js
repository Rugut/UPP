Ext.require(['Данные.Отчеты.ОрганизационнаяСтруктура'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ОрганизационнаяСтруктура/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОрганизационнаяСтруктура.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОрганизационнаяСтруктура.ФормаОтчетаСобытия");
