	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрИнформацииОбОбъектеНематериальныхАктивов.ОтчетСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрИнформацииОбОбъектеНематериальныхАктивов.ОтчетСобытия");
		...
		},
		{
			...
			name: 'Надпись5',
			text: 'Период с:',
			style: 'position:absolute;left:9px;top:33px;width:56px;height:19px;text-align:left;',
		},
		{
			xtype: 'label',
			name: 'Надпись6',
		...
		},
		{
			...
			style: 'position:absolute;left:9px;top:57px;width:128px;height:19px;text-align:left;',
		},
		{
			xtype: 'trigger',
			hideLabel: true,
