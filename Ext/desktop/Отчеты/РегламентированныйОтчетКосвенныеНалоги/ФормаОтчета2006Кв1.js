...
{
	Ext.define('Отчеты.РегламентированныйОтчетКосвенныеНалоги.ФормаОтчета2006Кв1',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетКосвенныеНалоги.ФормаОтчета2006Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетКосвенныеНалоги.ФормаОтчета2006Кв1События");
