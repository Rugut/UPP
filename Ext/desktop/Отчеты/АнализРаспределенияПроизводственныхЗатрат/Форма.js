Ext.require(['Данные.Отчеты.АнализРаспределенияПроизводственныхЗатрат'], function () 
{
	...
	[{
		...
		{
			xtype: 'checkbox',
			boxLabel: 'Показывать только расхождение',
			style: 'position:absolute;left:8px;top:33px;width:191px;height:19px;',
		},
		{
			xtype: 'checkbox',
