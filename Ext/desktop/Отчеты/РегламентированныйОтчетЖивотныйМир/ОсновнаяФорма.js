...
{
	Ext.define('Отчеты.РегламентированныйОтчетЖивотныйМир.ОсновнаяФорма',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЖивотныйМир.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЖивотныйМир.ОсновнаяФормаСобытия");
