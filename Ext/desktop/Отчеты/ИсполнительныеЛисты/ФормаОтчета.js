Ext.require(['Данные.Отчеты.ИсполнительныеЛисты'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ИсполнительныеЛисты/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ИсполнительныеЛисты.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ИсполнительныеЛисты.ФормаОтчетаСобытия");
