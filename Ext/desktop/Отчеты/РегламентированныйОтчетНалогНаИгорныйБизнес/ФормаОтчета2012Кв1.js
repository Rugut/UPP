Ext.require(['Данные.Отчеты.РегламентированныйОтчетНалогНаИгорныйБизнес'], function () 
{
	...
	[{
		...
		{
			xtype: 'label',
			name: 'НадписьРаздел21ДополнительныеСтраницы',
		...
		{
			xtype: 'label',
			name: 'НадписьРаздел31ДополнительныеСтраницы',
			text: 'Дополнительные страницы:',
			style: 'position:absolute;left:116px;top:265px;width:148px;height:19px;text-align:left;',
		},
					]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетНалогНаИгорныйБизнес.ФормаОтчета2012Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетНалогНаИгорныйБизнес.ФормаОтчета2012Кв1События");
