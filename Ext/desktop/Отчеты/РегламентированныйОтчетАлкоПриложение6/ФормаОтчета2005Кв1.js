Ext.require(['Данные.Отчеты.РегламентированныйОтчетАлкоПриложение6'], function () 
{
	...
	[{
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:8px;top:83px;width:654px;height:300px;',
			height: 300,width: 654,
			tabBar:{hidden:true},
			items:
			[
				{
					...
					[
		{
			...
			text: 'Добавить',
			style: 'position:absolute;left:398px;top:251px;width:80px;height:19px;',
		},
		{
			xtype: 'button',
		...
		},
		{
			...
			style: 'position:absolute;left:118px;top:251px;width:148px;height:19px;text-align:left;',
		},
		{
			xtype: 'button',
		...
		},
		{
			...
			text: '999 из 999',
			style: 'position:absolute;left:290px;top:251px;width:80px;height:19px;text-align:center;',
		},
		{
			xtype: 'button',
			name: 'КнопкаСледующаяСтраницаРаздел1',
			text: '',
			style: 'position:absolute;left:372px;top:251px;width:20px;height:19px;',
		},
		{
			xtype: 'button',
			name: 'КнопкаПерейтиНаСтраницуРаздел1',
			text: 'Перейти',
			style: 'position:absolute;left:568px;top:251px;width:80px;height:19px;',
		},
		{
			xtype: 'button',
			name: 'КнопкаДобавитьДопСтрокиРаздел1',
			text: 'Добавить',
			style: 'position:absolute;left:483px;top:275px;width:80px;height:19px;',
		},
		{
			xtype: 'button',
		...
		},
		{
			...
			style: 'position:absolute;left:349px;top:275px;width:132px;height:19px;text-align:left;',
		},
					]
				},
			]
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:8px;top:383px;width:654px;height:24px;',
			height: 24,width: 654,
			tabBar:{hidden:true},
			items:
			[
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАлкоПриложение6.ФормаОтчета2005Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАлкоПриложение6.ФормаОтчета2005Кв1События");
