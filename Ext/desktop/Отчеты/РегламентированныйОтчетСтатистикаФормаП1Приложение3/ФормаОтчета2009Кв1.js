...
{
	Ext.define('Отчеты.РегламентированныйОтчетСтатистикаФормаП1Приложение3.ФормаОтчета2009Кв1',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетСтатистикаФормаП1Приложение3.ФормаОтчета2009Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетСтатистикаФормаП1Приложение3.ФормаОтчета2009Кв1События");
