Ext.require(['Данные.Отчеты.РегламентированныйОтчетАвансыТранспорт'], function () 
{
	Ext.define('Отчеты.РегламентированныйОтчетАвансыТранспорт.ФормаОтчета2007кв1',
	{
	...
	[{
		...
		[
		{
			...
			[
				...
				{
					text:'Настройка...',
					tooltip:'Кнопка настройка страниц',
				},
				'-',
				{
					text:'Поиск',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАвансыТранспорт.ФормаОтчета2007кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАвансыТранспорт.ФормаОтчета2007кв1События");
