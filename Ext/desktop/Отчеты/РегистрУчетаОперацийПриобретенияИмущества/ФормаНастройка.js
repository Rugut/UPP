Ext.require(['Данные.Отчеты.РегистрУчетаОперацийПриобретенияИмущества'], function () 
{
	...
	[{
					...
					[
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрУчетаОперацийПриобретенияИмущества.ФормаНастройкаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрУчетаОперацийПриобретенияИмущества.ФормаНастройкаСобытия");
