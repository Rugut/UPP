Ext.require(['Данные.Отчеты.КонтрольОтветовНаРассылку'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/КонтрольОтветовНаРассылку/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.КонтрольОтветовНаРассылку.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.КонтрольОтветовНаРассылку.ФормаОтчетаСобытия");
