...
{
	Ext.define('Отчеты.КарточкаСчетаБюджетирование.ФормаНастройка',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.КарточкаСчетаБюджетирование.ФормаНастройкаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.КарточкаСчетаБюджетирование.ФормаНастройкаСобытия");
		...
		},
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/КарточкаСчетаБюджетирование/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
