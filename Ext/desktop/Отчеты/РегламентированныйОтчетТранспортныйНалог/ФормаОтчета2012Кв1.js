	...
	[{
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'СобратьДанныеРаздел1_1', Граница: 'Левая', Номер: 477, Координата: 0},
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 50, Координата: 0},
					Нижняя: { Элемент: 'СобратьДанныеРаздел1_1', Граница: 'Верхняя', Номер: 477, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
