...
{
	Ext.define('Отчеты.РегламентированныйОтчетИзвещениеОбУплатеАвансовогоПлатежаАкциза.ОсновнаяФорма',
	{
	...
	[{
		...
		},
		{
			xtype: 'fieldset',
			title: 'Форма',
			style: 'position:absolute;left:8px;top:113px;width:260px;height:15px;',
		},
		{
			xtype: 'fieldset',
			title: 'Организация',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетИзвещениеОбУплатеАвансовогоПлатежаАкциза.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетИзвещениеОбУплатеАвансовогоПлатежаАкциза.ОсновнаяФормаСобытия");
