Ext.require(['Данные.Отчеты.ШтатнаяРасстановка'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ШтатнаяРасстановка/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ШтатнаяРасстановка.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ШтатнаяРасстановка.ФормаОтчетаСобытия");
