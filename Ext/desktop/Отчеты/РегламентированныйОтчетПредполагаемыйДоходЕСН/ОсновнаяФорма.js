...
{
	Ext.define('Отчеты.РегламентированныйОтчетПредполагаемыйДоходЕСН.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Декларация о предполагаемом доходе',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетПредполагаемыйДоходЕСН.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетПредполагаемыйДоходЕСН.ОсновнаяФормаСобытия");
