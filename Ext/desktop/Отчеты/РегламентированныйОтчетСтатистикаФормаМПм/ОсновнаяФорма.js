...
{
	Ext.define('Отчеты.РегламентированныйОтчетСтатистикаФормаМПм.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Статистика: Форма МП(микро)',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетСтатистикаФормаМПм.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетСтатистикаФормаМПм.ОсновнаяФормаСобытия");
