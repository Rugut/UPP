Ext.require(['Данные.Отчеты.РегистрУчетаРасходаДенежныхСредств'], function () 
{
	...
	[{
		...
		[
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрУчетаРасходаДенежныхСредств.ФормаНастройкаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрУчетаРасходаДенежныхСредств.ФормаНастройкаСобытия");
	...
	[
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:0px;top:62px;width:312px;height:25px;',
			dock: 'bottom',
			items:
			[
				{
