...
{
	Ext.define('Отчеты.РегламентированныйОтчетНедра.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Платежи за пользование недрами',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетНедра.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетНедра.ОсновнаяФормаСобытия");
