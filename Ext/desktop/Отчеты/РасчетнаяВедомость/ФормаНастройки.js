Ext.require(['Данные.Отчеты.РасчетнаяВедомость'], function () 
{
	...
	[{
		...
		},
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/РасчетнаяВедомость/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РасчетнаяВедомость.ФормаНастройкиСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РасчетнаяВедомость.ФормаНастройкиСобытия");
