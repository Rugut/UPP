Ext.require(['Данные.Отчеты.РасчетнаяВедомость'], function () 
{
	...
	[{
		...
		{
			xtype: 'label',
			id: 'РамкаГруппыГруппировкиСтрокСтраницаНеТаблица',
			text: 'Строки',
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'РамкаГруппыГруппировкиСтрокСтраницаНеТаблица', Граница: 'Верхняя', Номер: 19, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		{
			xtype: 'toolbar',
			id: КоманднаяПанельГруппировкиСтрокСтраницаНеТаблица,
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'КоманднаяПанельГруппировкиСтрокСтраницаНеТаблица', Граница: 'Верхняя', Номер: 20, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		{
			xtype: 'toolbar',
			id: КоманднаяПанельПоказателиСтраницаНеТаблица,
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 124, Координата: 0},
					Нижняя: { Элемент: 'КоманднаяПанельПоказателиСтраницаНеТаблица', Граница: 'Верхняя', Номер: 26, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		{
			xtype: 'label',
			id: 'РамкаГруппыПоказателиСтраницаНеТаблица',
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 124, Координата: 0},
					Нижняя: { Элемент: 'РамкаГруппыПоказателиСтраницаНеТаблица', Граница: 'Верхняя', Номер: 30, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		{
			xtype: 'toolbar',
			id: КоманднаяПанельСтраницаНеТаблицаПоказателиКонтекстноеМеню,
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 124, Координата: 0},
					Нижняя: { Элемент: 'КоманднаяПанельСтраницаНеТаблицаПоказателиКонтекстноеМеню', Граница: 'Верхняя', Номер: 242, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					...
					[
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'ФлажокОтрицательноеКрасным', Граница: 'Левая', Номер: 133, Координата: 0},
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'ФлажокОтрицательноеКрасным', Граница: 'Верхняя', Номер: 133, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Верхняя', Номер: 187, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'Вправо33', Граница: 'Левая', Номер: 191, Координата: 0},
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Верхняя', Номер: 192, Координата: 0},
					Нижняя: { Элемент: '', Граница: 'Верхняя', Номер: 192, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'Влево33', Граница: 'Левая', Номер: 192, Координата: 0},
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: 'Влево33', Граница: 'Нижняя', Номер: 192, Координата: 0},
					Нижняя: { Элемент: 'Форма', Граница: 'Верхняя', Номер: 0, Координата: 0},
				},
				ОбъектПропорций: 
				{
