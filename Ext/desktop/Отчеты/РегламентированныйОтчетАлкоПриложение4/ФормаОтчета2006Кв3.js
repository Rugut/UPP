...
{
	Ext.define('Отчеты.РегламентированныйОтчетАлкоПриложение4.ФормаОтчета2006Кв3',
	{
	...
	[{
					...
					[
		{
			...
			width: 80,
			height: 19,
			style: 'position:absolute;left:103px;top:22px;width:80px;height:19px;',
		},
		{
			xtype: 'checkbox',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАлкоПриложение4.ФормаОтчета2006Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАлкоПриложение4.ФормаОтчета2006Кв3События");
