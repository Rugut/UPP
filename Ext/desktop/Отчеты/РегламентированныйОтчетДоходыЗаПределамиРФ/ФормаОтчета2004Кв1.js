...
{
	Ext.define('Отчеты.РегламентированныйОтчетДоходыЗаПределамиРФ.ФормаОтчета2004Кв1',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетДоходыЗаПределамиРФ.ФормаОтчета2004Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетДоходыЗаПределамиРФ.ФормаОтчета2004Кв1События");
