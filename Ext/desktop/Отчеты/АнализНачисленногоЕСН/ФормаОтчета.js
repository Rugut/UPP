Ext.require(['Данные.Отчеты.АнализНачисленногоЕСН'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/АнализНачисленногоЕСН/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АнализНачисленногоЕСН.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АнализНачисленногоЕСН.ФормаОтчетаСобытия");
