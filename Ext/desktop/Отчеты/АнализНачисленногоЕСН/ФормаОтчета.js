Ext.define('Отчеты.АнализНачисленногоЕСН.ФормаОтчета',
	{
	extend: 'Ext.window.Window',
	style: 'position:absolute;width:838px;height:580px;',
	iconCls: 'bogus',
	minimizable: true,
	maximizable: true,
	...
	[
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:525px;top:134px;width:306px;height:438px;',
			height: 438,width: 306,
			tabBar:{hidden:true},
			items:
			[
				{
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:0px;top:0px;width:306px;height:412px;',
			height: 412,width: 306,
			items:
			[
				{
					title:'Параметры',
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:0px;top:412px;width:306px;height:26px;',
			items:
			[
				{
					xtype: 'tbfill'
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:96px;top:0px;width:220px;height:25px;',
			items:
			[
				{
		...
		},
		{
			...
			name: 'Сформировать',
			text: 'Сформировать',
			style: 'position:absolute;left:9px;top:98px;width:124px;height:30px;',
		},
		{
			xtype: 'tabpanel',
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:726px;top:101px;width:105px;height:24px;',
			items:
			[
				{
					xtype: 'tbfill'
