...
{
	Ext.define('Отчеты.РегламентированныйОтчетРСВ1.ФормаОтчета2010Кв4',
	{
	...
	[{
		...
		},
		{
			...
			width: 289,
			height: 19,
			style: 'position:absolute;left:357px;top:265px;width:289px;height:19px;',
		},
					]
				},
				{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетРСВ1.ФормаОтчета2010Кв4События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетРСВ1.ФормаОтчета2010Кв4События");
