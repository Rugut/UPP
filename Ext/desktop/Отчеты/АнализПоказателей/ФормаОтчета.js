Ext.require(['Данные.Отчеты.АнализПоказателей'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/АнализПоказателей/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АнализПоказателей.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АнализПоказателей.ФормаОтчетаСобытия");
