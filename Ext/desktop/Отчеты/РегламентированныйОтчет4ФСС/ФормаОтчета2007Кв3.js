...
{
	Ext.define('Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2007Кв3',
	{
	...
	[{
		...
		{
			xtype: 'panel',
			style: 'position:absolute;left:6px;top:234px;width:640px;height:26px;',
			height: 26,width: 640,
			tabBar:{hidden:true},
			items:
			[
					...
					[
		{
			...
			text: 'Комментарий:',
			style: 'position:absolute;left:183px;top:7px;width:78px;height:19px;text-align:left;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2007Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2007Кв3События");
