Ext.require(['Данные.Отчеты.РегламентированныйОтчет4ФСС'], function () 
{
	...
	[{
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:6px;top:235px;width:640px;height:26px;',
			height: 26,width: 640,
			tabBar:{hidden:true},
			items:
			[
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:6px;top:238px;width:640px;height:26px;',
			height: 26,width: 640,
			tabBar:{hidden:true},
			items:
			[
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2007Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2007Кв1События");
