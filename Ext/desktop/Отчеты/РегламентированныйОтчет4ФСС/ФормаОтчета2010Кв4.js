Ext.require(['Данные.Отчеты.РегламентированныйОтчет4ФСС'], function () 
{
	...
	[{
		...
		},
		{
			...
			width: 287,
			height: 19,
			style: 'position:absolute;left:359px;top:265px;width:287px;height:19px;',
		},
					]
				},
				{
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:6px;top:237px;width:640px;height:26px;',
			height: 26,width: 640,
			tabBar:{hidden:true},
			items:
			[
					...
					[
		{
			...
			style: 'position:absolute;left:226px;top:4px;width:120px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
			...
			width: 289,
			height: 19,
			style: 'position:absolute;left:351px;top:4px;width:289px;height:19px;',
		},
		{
			xtype: 'combobox',
			style: 'position:absolute;left:0px;top:4px;width:220px;height:19px;',
			width: 220,
			height: 19,
		},
					]
		...
		{
			xtype: 'tabpanel',
			style: 'position:absolute;left:6px;top:239px;width:640px;height:22px;',
			height: 22,width: 640,
			tabBar:{hidden:true},
			items:
			[
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2010Кв4События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчет4ФСС.ФормаОтчета2010Кв4События");
