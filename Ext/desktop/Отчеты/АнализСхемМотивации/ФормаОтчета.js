Ext.require(['Данные.Отчеты.АнализСхемМотивации'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/АнализСхемМотивации/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АнализСхемМотивации.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АнализСхемМотивации.ФормаОтчетаСобытия");
