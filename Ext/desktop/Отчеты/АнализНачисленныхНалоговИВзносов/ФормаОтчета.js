Ext.define('Отчеты.АнализНачисленныхНалоговИВзносов.ФормаОтчета',
	{
	...
	[
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:13px;top:16px;width:147px;height:25px;',
			items:
			[
				{
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:694px;top:101px;width:137px;height:24px;',
			items:
			[
				{
					text:'',
