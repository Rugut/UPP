Ext.require(['Данные.Отчеты.АнализНачисленныхНалоговИВзносов'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/АнализНачисленныхНалоговИВзносов/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АнализНачисленныхНалоговИВзносов.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АнализНачисленныхНалоговИВзносов.ФормаОтчетаСобытия");
