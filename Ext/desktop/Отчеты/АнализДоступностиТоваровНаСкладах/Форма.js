Ext.require(['Данные.Отчеты.АнализДоступностиТоваровНаСкладах'], function () 
{
	Ext.define('Отчеты.АнализДоступностиТоваровНаСкладах.Форма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Анализ доступности товаров на складах',
