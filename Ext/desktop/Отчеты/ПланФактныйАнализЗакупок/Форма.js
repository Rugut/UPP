Ext.require(['Данные.Отчеты.ПланФактныйАнализЗакупок'], function () 
{
	Ext.define('Отчеты.ПланФактныйАнализЗакупок.Форма',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПланФактныйАнализЗакупок.ФормаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПланФактныйАнализЗакупок.ФормаСобытия");
