...
{
	Ext.define('Отчеты.РегламентированныйОтчетФорма2.ОсновнаяФорма',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетФорма2.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетФорма2.ОсновнаяФормаСобытия");
