...
{
	Ext.define('Отчеты.РегламентированныйОтчет4аФСС.ОсновнаяФорма',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчет4аФСС.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчет4аФСС.ОсновнаяФормаСобытия");
