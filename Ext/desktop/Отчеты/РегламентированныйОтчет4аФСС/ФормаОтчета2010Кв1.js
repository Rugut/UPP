	...
	[{
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'ПолеВыбораВариантЗаполненияРаздел2', Граница: 'Верхняя', Номер: 364, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: 'Форма', Граница: 'Правая', Номер: 0, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'ПолеВводаЗначениеКорректировкиРаздел2', Граница: 'Левая', Номер: 365, Координата: 0},
					Левая: { Элемент: '', Граница: 'Правая', Номер: 315, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'ПолеВводаЗначениеКорректировкиРаздел2', Граница: 'Верхняя', Номер: 365, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Правая', Номер: 315, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'ПолеВводаКомментарийРаздел2', Граница: 'Верхняя', Номер: 366, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
