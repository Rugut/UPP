...
{
	Ext.define('Отчеты.РегламентированныйОтчетЗемельныйНалог.ФормаОтчета2009Кв1',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЗемельныйНалог.ФормаОтчета2009Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЗемельныйНалог.ФормаОтчета2009Кв1События");
