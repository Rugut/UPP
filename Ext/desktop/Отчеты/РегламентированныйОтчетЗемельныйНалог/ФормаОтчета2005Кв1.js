...
{
	Ext.define('Отчеты.РегламентированныйОтчетЗемельныйНалог.ФормаОтчета2005Кв1',
	{
	...
	[{
		...
		},
		{
			...
			name: 'Заполнить',
			text: 'Импортировать',
			style: 'position:absolute;left:6px;top:265px;width:98px;height:19px;',
		},
					]
				},
			]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетЗемельныйНалог.ФормаОтчета2005Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетЗемельныйНалог.ФормаОтчета2005Кв1События");
