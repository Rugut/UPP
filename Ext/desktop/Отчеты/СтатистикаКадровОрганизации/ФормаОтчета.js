Ext.require(['Данные.Отчеты.СтатистикаКадровОрганизации'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СтатистикаКадровОрганизации/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СтатистикаКадровОрганизации.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СтатистикаКадровОрганизации.ФормаОтчетаСобытия");
