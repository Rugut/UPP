Ext.require(['Данные.Отчеты.ОтчетПоСистемеПрав'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ОтчетПоСистемеПрав/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОтчетПоСистемеПрав.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОтчетПоСистемеПрав.ФормаОтчетаСобытия");
