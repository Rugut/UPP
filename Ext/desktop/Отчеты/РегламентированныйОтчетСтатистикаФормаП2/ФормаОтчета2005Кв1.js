...
{
	Ext.define('Отчеты.РегламентированныйОтчетСтатистикаФормаП2.ФормаОтчета2005Кв1',
	{
	...
	[{
		...
		{
			xtype: 'combobox',
			style: 'position:absolute;left:172px;top:0px;width:116px;height:19px;',
			width: 116,
			height: 19,
		},
		{
			...
			style: 'position:absolute;left:303px;top:0px;width:49px;height:19px;',
			width: 49,
			height: 19,
		},
					]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетСтатистикаФормаП2.ФормаОтчета2005Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетСтатистикаФормаП2.ФормаОтчета2005Кв1События");
