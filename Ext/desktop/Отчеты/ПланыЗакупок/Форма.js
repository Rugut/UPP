Ext.require(['Данные.Отчеты.ПланыЗакупок'], function () 
{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.ПланыЗакупок.ФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.ПланыЗакупок.ФормаСобытия");
