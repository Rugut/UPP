Ext.require(['Данные.Отчеты.РегламентированныйОтчетАлкоПриложение7'], function () 
{
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:473px;top:264px;width:136px;height:19px;text-align:left;',
		},
		{
			xtype: 'label',
			name: 'Надпись41',
			text: 'Дополнительные страницы:',
			style: 'position:absolute;left:246px;top:264px;width:148px;height:19px;text-align:left;',
		},
		{
			xtype: 'button',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАлкоПриложение7.ФормаОтчета2006Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАлкоПриложение7.ФормаОтчета2006Кв3События");
