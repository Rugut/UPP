Ext.require(['Данные.Отчеты.СтатистикаКадров'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СтатистикаКадров/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СтатистикаКадров.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СтатистикаКадров.ФормаОтчетаСобытия");
