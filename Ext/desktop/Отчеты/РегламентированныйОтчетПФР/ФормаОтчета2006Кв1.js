Ext.require(['Данные.Отчеты.РегламентированныйОтчетПФР'], function () 
{
	...
	[{
		...
		},
		{
			...
			style: 'position:absolute;left:269px;top:0px;width:105px;height:19px;',
		},
					]
				},
			]
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетПФР.ФормаОтчета2006Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетПФР.ФормаОтчета2006Кв1События");
