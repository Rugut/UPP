...
{
	Ext.define('Отчеты.РегламентированныйОтчетПФР.ФормаОтчета2004Кв1',
	{
	...
	[{
		...
		},
		{
			...
			disabled: false,
			value: 0,
			name: 'ПолеВводаЗначениеКорректировкиРаздел24',
			style: 'position:absolute;left:237px;top:5px;width:117px;height:19px;',
			width: 117,
			height: 19,
		},
		{
			...
			hideLabel: true,
			disabled: false,
			name: 'ПолеВводаКомментарийРаздел24',
			width: 333,
			height: 19,
			style: 'position:absolute;left:358px;top:5px;width:333px;height:19px;',
		},
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетПФР.ФормаОтчета2004Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетПФР.ФормаОтчета2004Кв1События");
