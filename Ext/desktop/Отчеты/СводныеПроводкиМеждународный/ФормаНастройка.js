	...
	[{
					...
					[
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.СводныеПроводкиМеждународный.ФормаНастройкаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.СводныеПроводкиМеждународный.ФормаНастройкаСобытия");
