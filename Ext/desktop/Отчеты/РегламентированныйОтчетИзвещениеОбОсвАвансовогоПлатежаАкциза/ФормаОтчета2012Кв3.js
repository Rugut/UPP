Ext.require(['Данные.Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза'], function () 
{
	...
	[{
		...
		{
			xtype: 'button',
			id: 'КнопкаДобавитьДопСтрокиИзвещение',
			text: 'Добавить',
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Нижняя: { Элемент: 'КнопкаДобавитьДопСтрокиИзвещение', Граница: 'Верхняя', Номер: 436, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		{
			xtype: 'button',
			id: 'КнопкаУдалитьДопСтрокиИзвещение',
			text: 'Удалить',
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: 'Форма', Граница: 'Правая', Номер: 0, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 50, Координата: 0},
					Нижняя: { Элемент: 'КнопкаУдалитьДопСтрокиИзвещение', Граница: 'Верхняя', Номер: 437, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'Форма', Граница: 'Правая', Номер: 0, Координата: 0},
					Левая: { Элемент: 'Форма', Граница: 'Левая', Номер: 0, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Нижняя', Номер: 494, Координата: 0},
