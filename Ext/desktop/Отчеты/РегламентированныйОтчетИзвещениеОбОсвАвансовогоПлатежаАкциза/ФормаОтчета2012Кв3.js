...
{
	Ext.define('Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза.ФормаОтчета2012Кв3',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза.ФормаОтчета2012Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза.ФормаОтчета2012Кв3События");
