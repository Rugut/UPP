Ext.require(['Данные.Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза'], function () 
{
	Ext.define('Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза.ФормаОтчета2011кв2',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза.ФормаОтчета2011кв2События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетИзвещениеОбОсвАвансовогоПлатежаАкциза.ФормаОтчета2011кв2События");
