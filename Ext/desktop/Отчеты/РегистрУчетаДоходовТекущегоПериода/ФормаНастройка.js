	...
	[{
					...
					[
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрУчетаДоходовТекущегоПериода.ФормаНастройкаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрУчетаДоходовТекущегоПериода.ФормаНастройкаСобытия");
