Ext.require(['Данные.Отчеты.АнализРезультатовАнкетирования'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/АнализРезультатовАнкетирования/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АнализРезультатовАнкетирования.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АнализРезультатовАнкетирования.ФормаОтчетаСобытия");
