Ext.require(['Данные.Отчеты.ПланыПродаж'], function () 
{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.ПланыПродаж.ФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.ПланыПродаж.ФормаСобытия");
