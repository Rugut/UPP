...
{
	Ext.define('Отчеты.РегистрУчетаПоступленийДенежныхСредств.Отчет',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрУчетаПоступленийДенежныхСредств.ОтчетСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрУчетаПоступленийДенежныхСредств.ОтчетСобытия");
