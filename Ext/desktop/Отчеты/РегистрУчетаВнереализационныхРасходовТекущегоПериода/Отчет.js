...
{
	Ext.define('Отчеты.РегистрУчетаВнереализационныхРасходовТекущегоПериода.Отчет',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Регистр учета внереализационных расходов текущего периода',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегистрУчетаВнереализационныхРасходовТекущегоПериода.ОтчетСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегистрУчетаВнереализационныхРасходовТекущегоПериода.ОтчетСобытия");
