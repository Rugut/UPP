...
{
	Ext.define('Отчеты.РегламентированныйОтчетАкцизыПриложение3.ОсновнаяФорма',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Акцизы на алкогольную продукцию',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАкцизыПриложение3.ОсновнаяФормаСобытия'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАкцизыПриложение3.ОсновнаяФормаСобытия");
