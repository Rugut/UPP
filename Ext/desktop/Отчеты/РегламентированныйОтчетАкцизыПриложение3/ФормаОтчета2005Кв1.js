Ext.require(['Данные.Отчеты.РегламентированныйОтчетАкцизыПриложение3'], function () 
{
	Ext.define('Отчеты.РегламентированныйОтчетАкцизыПриложение3.ФормаОтчета2005Кв1',
	{
	...
	minimizable: true,
	maximizable: true,
	title: 'Декларация по акцизам на алкогольную продукцию, реализуемую с акцизных складов оптовых организаций',
	...
	[{
		...
		{
			xtype: 'button',
			name: 'кнЗаполнитьРаздел2',
			text: 'Заполнить',
			style: 'position:absolute;left:7px;top:265px;width:104px;height:20px;',
		},
					]
				},
				{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетАкцизыПриложение3.ФормаОтчета2005Кв1События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетАкцизыПриложение3.ФормаОтчета2005Кв1События");
