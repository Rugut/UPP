Ext.require(['Данные.Отчеты.ПланФактныйАнализСебестоимостиВыпуска'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ПланФактныйАнализСебестоимостиВыпуска/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПланФактныйАнализСебестоимостиВыпуска.ФормаОтчетаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПланФактныйАнализСебестоимостиВыпуска.ФормаОтчетаСобытия");
