...
{
	Ext.define('Отчеты.РегламентированныйОтчетРасчетПлатыОкрСредаСвод.ФормаОтчета2007Кв3',
	{
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Отчеты.РегламентированныйОтчетРасчетПлатыОкрСредаСвод.ФормаОтчета2007Кв3События'], function ()
					{
						var объект = Ext.create("Отчеты.РегламентированныйОтчетРасчетПлатыОкрСредаСвод.ФормаОтчета2007Кв3События");
