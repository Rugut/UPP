	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Обработки.РегистрацияСчетовФактурНаАванс.ФормаСобытия'], function ()
					{
						var объект = Ext.create("Обработки.РегистрацияСчетовФактурНаАванс.ФормаСобытия");
		...
		},
		{
			xtype: 'label',
			text: 'Список',
			style: 'position:absolute;left:8px;top:100px;width:720px;height:16px;border-bottom: 2px solid maroon; color: #9F6500; border-width:thin ; border-color: #B3AC86; font-weight: 600;'
		},
		{
			id: 'Список',
			xtype: 'grid',
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/РегистрацияСчетовФактурНаАванс/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
