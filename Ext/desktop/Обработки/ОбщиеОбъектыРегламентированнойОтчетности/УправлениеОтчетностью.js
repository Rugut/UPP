Ext.define('Обработки.ОбщиеОбъектыРегламентированнойОтчетности.УправлениеОтчетностью',
	...
	[
		...
		},
		{
			...
			text: 'с',
			style: 'position:absolute;left:113px;top:23px;width:10px;height:20px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц1',
			text: 'Янв',
			style: 'position:absolute;left:91px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц3',
			text: 'I кв',
			style: 'position:absolute;left:148px;top:33px;width:28px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц5',
			text: 'Май',
			style: 'position:absolute;left:209px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц7',
			text: 'Июл',
			style: 'position:absolute;left:268px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц9',
			text: 'III кв',
			style: 'position:absolute;left:324px;top:33px;width:32px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц11',
			text: 'Ноя',
			style: 'position:absolute;left:387px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц2',
			text: 'Фев',
			style: 'position:absolute;left:120px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц4',
			text: 'Апр',
			style: 'position:absolute;left:179px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц6',
			text: 'II кв',
			style: 'position:absolute;left:237px;top:33px;width:28px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц8',
			text: 'Авг',
			style: 'position:absolute;left:298px;top:33px;width:25px;height:17px;',
		},
		{
			xtype: 'label',
			name: 'НадписьМесяц10',
			text: 'Окт',
			style: 'position:absolute;left:357px;top:33px;width:25px;height:17px;',
		},
					]
				},
				{
		...
		},
		{
			...
			name: 'НадписьМесяц12',
			text: 'IV кв',
			style: 'position:absolute;left:414px;top:33px;width:32px;height:17px;',
		},
					]
				},
			]
