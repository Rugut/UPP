Ext.require(['Данные.Обработки.ФормированиеДокументовПоДаннымОрдеров'], function () 
{
	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ФормированиеДокументовПоДаннымОрдеров/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ФормированиеДокументовПоДаннымОрдеров.ФормаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ФормированиеДокументовПоДаннымОрдеров.ФормаСобытия");
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Обработки.ФормированиеДокументовПоДаннымОрдеров.ФормаСобытия'], function ()
					{
						var объект = Ext.create("Обработки.ФормированиеДокументовПоДаннымОрдеров.ФормаСобытия");
