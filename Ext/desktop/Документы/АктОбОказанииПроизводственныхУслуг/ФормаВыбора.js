			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АктОбОказанииПроизводственныхУслуг.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АктОбОказанииПроизводственныхУслуг.ФормаВыбораСобытия");
