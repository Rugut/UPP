			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АктОбОказанииПроизводственныхУслуг.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АктОбОказанииПроизводственныхУслуг.ФормаСпискаСобытия");
