			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ИнкассовоеПоручениеПереданное.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ИнкассовоеПоручениеПереданное.ФормаВыбораСобытия");
