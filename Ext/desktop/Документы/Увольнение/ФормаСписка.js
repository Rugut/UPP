			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.Увольнение.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.Увольнение.ФормаСпискаСобытия");
		...
		},
		{
			...
			[
					...
					menu: [
				{
					...
					tooltip:'Увольнение из организаций',
				},
				{
