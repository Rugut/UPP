			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПередачаОборудованияВМонтаж.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПередачаОборудованияВМонтаж.ФормаВыбораСобытия");
