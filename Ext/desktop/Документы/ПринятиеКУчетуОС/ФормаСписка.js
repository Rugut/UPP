...
{
	Ext.define('Документы.ПринятиеКУчетуОС.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПринятиеКУчетуОС.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПринятиеКУчетуОС.ФормаСпискаСобытия");
