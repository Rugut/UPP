		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'120',
					dataIndex:'ПричинаПроведенияИнвентаризации',
					flex:1,
				},
				{
					text:'Ответственный',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ИнвентаризацияОС.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ИнвентаризацияОС.ФормаСпискаСобытия");
