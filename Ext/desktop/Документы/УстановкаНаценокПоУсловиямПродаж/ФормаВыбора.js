			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УстановкаНаценокПоУсловиямПродаж.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УстановкаНаценокПоУсловиямПродаж.ФормаВыбораСобытия");
