			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПрохождениеКурсаОбучения.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПрохождениеКурсаОбучения.ФормаВыбораСобытия");
