			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПланированиеОтпуска.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПланированиеОтпуска.ФормаСпискаСобытия");
