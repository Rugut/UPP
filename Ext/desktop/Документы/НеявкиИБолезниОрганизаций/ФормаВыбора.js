			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.НеявкиИБолезниОрганизаций.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.НеявкиИБолезниОрганизаций.ФормаВыбораСобытия");
