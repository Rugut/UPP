			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПоступлениеДенежныхДокументов.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПоступлениеДенежныхДокументов.ФормаВыбораСобытия");
