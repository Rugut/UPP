		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'96',
					dataIndex:'ОтразитьВКнигеПокупок',
					flex:1,
				},
				{
					text:'Получен счет-фактура',
					width:'96',
					dataIndex:'ПокупателемВыставляетсяСчетФактураНаВозврат',
					flex:1,
				},
				{
					text:'Склад',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВозвратТоваровОтПокупателя.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВозвратТоваровОтПокупателя.ФормаСпискаСобытия");
