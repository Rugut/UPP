			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВозвратТоваровОтПокупателя.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВозвратТоваровОтПокупателя.ФормаВыбораСобытия");
