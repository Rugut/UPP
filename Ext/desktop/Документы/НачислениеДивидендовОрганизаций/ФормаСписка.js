		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'120',
					dataIndex:'ДивидендыНачисляемые',
					flex:1,
				},
				{
					text:'На одну акцию',
					width:'80',
					dataIndex:'НаОднуАкцию',
					flex:1,
				},
				{
					text:'Дивиденды полученные',
					width:'120',
					dataIndex:'ДивидендыПолученные',
					flex:1,
				},
				{
					text:'Сотрудники',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.НачислениеДивидендовОрганизаций.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.НачислениеДивидендовОрганизаций.ФормаСпискаСобытия");
