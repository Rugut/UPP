			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПравоНаДополнительныеДниОтпуска.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПравоНаДополнительныеДниОтпуска.ФормаВыбораСобытия");
