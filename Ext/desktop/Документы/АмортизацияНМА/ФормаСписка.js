...
{
	Ext.define('Документы.АмортизацияНМА.ФормаСписка',
	{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/АмортизацияНМА/ВыбратьПоСсылке/100', timeout: 3},
				fields:
				[
					{
						name:'Картинка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АмортизацияНМА.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АмортизацияНМА.ФормаСпискаСобытия");
