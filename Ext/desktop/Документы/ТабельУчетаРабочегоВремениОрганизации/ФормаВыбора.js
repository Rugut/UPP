			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ТабельУчетаРабочегоВремениОрганизации.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ТабельУчетаРабочегоВремениОрганизации.ФормаВыбораСобытия");
