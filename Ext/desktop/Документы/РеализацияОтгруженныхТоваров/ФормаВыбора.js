...
{
	Ext.define('Документы.РеализацияОтгруженныхТоваров.ФормаВыбора',
	{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/РеализацияОтгруженныхТоваров/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РеализацияОтгруженныхТоваров.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РеализацияОтгруженныхТоваров.ФормаВыбораСобытия");
