...
{
	Ext.define('Документы.ВозвратПереданныхТоваров.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВозвратПереданныхТоваров.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВозвратПереданныхТоваров.ФормаВыбораСобытия");
