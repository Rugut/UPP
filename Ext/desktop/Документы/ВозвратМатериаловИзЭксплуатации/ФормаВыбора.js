			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВозвратМатериаловИзЭксплуатации.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВозвратМатериаловИзЭксплуатации.ФормаВыбораСобытия");
