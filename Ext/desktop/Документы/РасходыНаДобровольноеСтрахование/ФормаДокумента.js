	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Документы.РасходыНаДобровольноеСтрахование.ФормаДокументаСобытия'], function ()
					{
						var объект = Ext.create("Документы.РасходыНаДобровольноеСтрахование.ФормаДокументаСобытия");
