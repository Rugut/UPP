			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РассылкаАнкет.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РассылкаАнкет.ФормаВыбораСобытия");
