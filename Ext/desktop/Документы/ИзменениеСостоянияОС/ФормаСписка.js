...
{
	Ext.define('Документы.ИзменениеСостоянияОС.ФормаСписка',
	{
		...
		[
		{
			...
			store:
			{
				...
				[
					...
					{
						name:'ВлияетНаНачислениеАмортизации',
					},
					{
						name:'НачислятьАмортизацию',
					},
					{
						name:'НачислятьАмортизациюВТекущемМесяце',
					},
				]
			},
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ИзменениеСостоянияОС.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ИзменениеСостоянияОС.ФормаСпискаСобытия");
