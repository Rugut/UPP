Ext.define('Документы.ПлатежныйОрдерПоступлениеДенежныхСредств.ФормаНазначениеПлатежа',
	{
	...
	minimizable: true,
	maximizable: true,
	title: 'Платежный ордер на поступление денежных средств: Назначение платежа',
