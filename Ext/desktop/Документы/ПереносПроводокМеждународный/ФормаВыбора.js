			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПереносПроводокМеждународный.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПереносПроводокМеждународный.ФормаВыбораСобытия");
