...
{
	Ext.define('Документы.ВыпускПродукции.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВыпускПродукции.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВыпускПродукции.ФормаВыбораСобытия");
