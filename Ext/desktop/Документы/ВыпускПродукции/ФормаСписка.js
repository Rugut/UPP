...
{
	Ext.define('Документы.ВыпускПродукции.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВыпускПродукции.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВыпускПродукции.ФормаСпискаСобытия");
