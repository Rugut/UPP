...
{
	Ext.define('Документы.ОтчетКомитентуОПродажах.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОтчетКомитентуОПродажах.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОтчетКомитентуОПродажах.ФормаВыбораСобытия");
