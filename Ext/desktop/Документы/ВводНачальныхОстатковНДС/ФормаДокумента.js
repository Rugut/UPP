Ext.define('Документы.ВводНачальныхОстатковНДС.ФормаДокумента',
	...
	[
		...
		},
		{
			...
			text: 'Комментарий:',
			style: 'position:absolute;left:8px;top:468px;width:80px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Организация:',
			style: 'position:absolute;left:362px;top:33px;width:88px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			[
				{
					text:'Заполнить реквизит """"Счет-фактура""""',
				},
				{
					text:'Заполнить по основным данным',
				},
				'-',
			]
		},
					...
					[
		{
			...
			[
				...
				{
					text:'Заполнить реквизит """"Документ оплаты""""',
				},
				'-',
			]
		},
		...
		},
		{
			...
			text: 'Ответственный:',
			style: 'position:absolute;left:8px;top:444px;width:82px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
