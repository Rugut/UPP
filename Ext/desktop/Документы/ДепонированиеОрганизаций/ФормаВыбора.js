			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ДепонированиеОрганизаций.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ДепонированиеОрганизаций.ФормаВыбораСобытия");
