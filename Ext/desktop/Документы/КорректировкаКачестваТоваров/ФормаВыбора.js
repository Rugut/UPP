...
{
	Ext.define('Документы.КорректировкаКачестваТоваров.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.КорректировкаКачестваТоваров.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.КорректировкаКачестваТоваров.ФормаВыбораСобытия");
