...
{
	Ext.define('Документы.ЗакрытиеВнутреннихЗаказов.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ЗакрытиеВнутреннихЗаказов.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ЗакрытиеВнутреннихЗаказов.ФормаСпискаСобытия");
