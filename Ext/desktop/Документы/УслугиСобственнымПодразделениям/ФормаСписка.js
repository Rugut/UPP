...
{
	Ext.define('Документы.УслугиСобственнымПодразделениям.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УслугиСобственнымПодразделениям.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УслугиСобственнымПодразделениям.ФормаСпискаСобытия");
