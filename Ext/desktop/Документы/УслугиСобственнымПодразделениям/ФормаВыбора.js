...
{
	Ext.define('Документы.УслугиСобственнымПодразделениям.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УслугиСобственнымПодразделениям.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УслугиСобственнымПодразделениям.ФормаВыбораСобытия");
