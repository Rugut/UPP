...
{
	Ext.define('Документы.АмортизацияНМАМеждународный.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.АмортизацияНМАМеждународный.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.АмортизацияНМАМеждународный.ФормаСпискаСобытия");
