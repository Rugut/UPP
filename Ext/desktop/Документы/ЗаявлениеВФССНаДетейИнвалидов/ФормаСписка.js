			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ЗаявлениеВФССНаДетейИнвалидов.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ЗаявлениеВФССНаДетейИнвалидов.ФормаСпискаСобытия");
