Ext.define('Документы.ЗаявлениеВФССНаДетейИнвалидов.ФормаДокумента',
	...
	[
		...
		},
		{
			...
			name: 'НадписьДата',
			text: 'от',
			style: 'position:absolute;left:599px;top:33px;width:26px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
					...
					[
		{
			...
			text: 'Руководитель:',
			style: 'position:absolute;left:12px;top:276px;width:106px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Должность:',
			style: 'position:absolute;left:444px;top:276px;width:106px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'БИК:',
			style: 'position:absolute;left:550px;top:159px;width:29px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Сумма пособий:',
			style: 'position:absolute;left:226px;top:81px;width:82px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
