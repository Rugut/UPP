			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УстановкаБазыРаспределенияЗатрат.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УстановкаБазыРаспределенияЗатрат.ФормаВыбораСобытия");
