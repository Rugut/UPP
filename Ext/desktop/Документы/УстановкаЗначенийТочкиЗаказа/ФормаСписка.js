...
{
	Ext.define('Документы.УстановкаЗначенийТочкиЗаказа.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УстановкаЗначенийТочкиЗаказа.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УстановкаЗначенийТочкиЗаказа.ФормаСпискаСобытия");
