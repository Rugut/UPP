	...
	[
					...
					[
		{
			...
			[
				...
				{
					text:'Заполнить по расчетным данным',
				},
				{
		...
		},
		{
			...
			text: 'по:',
			style: 'position:absolute;left:178px;top:57px;width:16px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьПодразделениеОрганизации',
			text: 'Подразделение организации:',
			style: 'position:absolute;left:336px;top:103px;width:88px;height:27px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
