			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РаспределениеМатериаловНаВыпуск.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РаспределениеМатериаловНаВыпуск.ФормаВыбораСобытия");
