	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ОбъявлениеНаВзносНаличными/ВыбратьПоСсылке/100', timeout: 3},
				fields:
				[
					{
						name:'Картинка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОбъявлениеНаВзносНаличными.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОбъявлениеНаВзносНаличными.ФормаВыбораСобытия");
