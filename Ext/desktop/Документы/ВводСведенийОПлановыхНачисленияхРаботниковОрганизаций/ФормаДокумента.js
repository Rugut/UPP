Ext.define('Документы.ВводСведенийОПлановыхНачисленияхРаботниковОрганизаций.ФормаДокумента',
	...
	[
		...
		},
		{
			...
			text: 'Организация:',
			style: 'position:absolute;left:287px;top:33px;width:84px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Комментарий:',
			style: 'position:absolute;left:8px;top:524px;width:88px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			name: 'Надпись1',
			text: 'Ответственный:',
			style: 'position:absolute;left:287px;top:56px;width:84px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
