	...
	[{
		...
		[
		{
			...
			[
				...
				{
					text:'Реверсирование расходов',
					width:'120',
					dataIndex:'РеверсированиеРасходов',
					flex:1,
				},
				{
					text:'Комментарий',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.НачислениеРасходовМеждународный.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.НачислениеРасходовМеждународный.ФормаВыбораСобытия");
