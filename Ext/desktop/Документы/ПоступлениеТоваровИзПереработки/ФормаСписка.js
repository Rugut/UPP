			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПоступлениеТоваровИзПереработки.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПоступлениеТоваровИзПереработки.ФормаСпискаСобытия");
