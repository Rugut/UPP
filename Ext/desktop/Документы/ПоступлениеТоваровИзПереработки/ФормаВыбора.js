			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПоступлениеТоваровИзПереработки.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПоступлениеТоваровИзПереработки.ФормаВыбораСобытия");
