		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'186',
					dataIndex:'ВидРаспределенияПоПроектам',
					flex:1,
				},
				{
					text:'Комментарий',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УстановкаДолейРаспределенияПоПроектам.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УстановкаДолейРаспределенияПоПроектам.ФормаВыбораСобытия");
