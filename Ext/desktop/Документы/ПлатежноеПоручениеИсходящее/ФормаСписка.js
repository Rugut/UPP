			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПлатежноеПоручениеИсходящее.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПлатежноеПоручениеИсходящее.ФормаСпискаСобытия");
