			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПлатежноеПоручениеИсходящее.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПлатежноеПоручениеИсходящее.ФормаВыбораСобытия");
