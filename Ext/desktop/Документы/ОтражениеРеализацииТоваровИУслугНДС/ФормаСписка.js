	...
	[{
		...
		[
		{
			...
			[
				...
				{
					text:'Запись в книгу продаж',
					width:'80',
					dataIndex:'ЗаписьВКнигуПродаж',
					flex:1,
				},
				{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОтражениеРеализацииТоваровИУслугНДС.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОтражениеРеализацииТоваровИУслугНДС.ФормаСпискаСобытия");
