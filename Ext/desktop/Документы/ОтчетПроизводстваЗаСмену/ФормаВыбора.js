...
{
	Ext.define('Документы.ОтчетПроизводстваЗаСмену.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОтчетПроизводстваЗаСмену.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОтчетПроизводстваЗаСмену.ФормаВыбораСобытия");
