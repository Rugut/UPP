			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ABCКлассификацияПокупателей.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ABCКлассификацияПокупателей.ФормаВыбораСобытия");
