			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПеремещениеМатериаловВЭксплуатации.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПеремещениеМатериаловВЭксплуатации.ФормаСпискаСобытия");
