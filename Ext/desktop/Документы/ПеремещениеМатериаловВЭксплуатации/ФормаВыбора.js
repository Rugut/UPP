			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПеремещениеМатериаловВЭксплуатации.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПеремещениеМатериаловВЭксплуатации.ФормаВыбораСобытия");
