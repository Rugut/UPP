...
{
	Ext.define('Документы.ПрочиеЗатраты.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПрочиеЗатраты.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПрочиеЗатраты.ФормаСпискаСобытия");
