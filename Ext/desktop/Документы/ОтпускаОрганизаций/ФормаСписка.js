		...
		[
		{
			...
			[
				...
				'-',
				{
					...
					tooltip:'Ввести документы-начисления на основании',
				},
					]
				},
				{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОтпускаОрганизаций.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОтпускаОрганизаций.ФормаСпискаСобытия");
