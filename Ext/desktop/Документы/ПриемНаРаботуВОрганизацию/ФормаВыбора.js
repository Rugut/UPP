			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПриемНаРаботуВОрганизацию.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПриемНаРаботуВОрганизацию.ФормаВыбораСобытия");
