			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПриемНаРаботуВОрганизацию.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПриемНаРаботуВОрганизацию.ФормаСпискаСобытия");
