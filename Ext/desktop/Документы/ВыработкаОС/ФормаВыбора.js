...
{
	Ext.define('Документы.ВыработкаОС.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВыработкаОС.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВыработкаОС.ФормаВыбораСобытия");
