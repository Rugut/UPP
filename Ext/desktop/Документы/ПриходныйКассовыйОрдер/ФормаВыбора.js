...
{
	Ext.define('Документы.ПриходныйКассовыйОрдер.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПриходныйКассовыйОрдер.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПриходныйКассовыйОрдер.ФормаВыбораСобытия");
