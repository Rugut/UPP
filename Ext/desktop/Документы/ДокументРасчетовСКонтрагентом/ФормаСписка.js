			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ДокументРасчетовСКонтрагентом.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ДокументРасчетовСКонтрагентом.ФормаСпискаСобытия");
