...
{
	Ext.define('Документы.ВводНачальныхОстатковНДСпоПартиям.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВводНачальныхОстатковНДСпоПартиям.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВводНачальныхОстатковНДСпоПартиям.ФормаСпискаСобытия");
