...
{
	Ext.define('Документы.ПеремещениеОС.ФормаВыбора',
	{
	...
	[{
		...
		[
		{
			...
			[
				...
				{
					text:'МОЛ Организации',
					width:'120',
					dataIndex:'МОЛОрганизации',
					flex:1,
				},
				{
					text:'Ответственный',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПеремещениеОС.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПеремещениеОС.ФормаВыбораСобытия");
