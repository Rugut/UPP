...
{
	Ext.define('Документы.ИнвентаризацияНЗП.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ИнвентаризацияНЗП.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ИнвентаризацияНЗП.ФормаСпискаСобытия");
