			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.КорректировкаДолгаПоВозвратнойТаре.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.КорректировкаДолгаПоВозвратнойТаре.ФормаСпискаСобытия");
