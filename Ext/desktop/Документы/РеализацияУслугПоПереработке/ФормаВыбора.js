...
{
	Ext.define('Документы.РеализацияУслугПоПереработке.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РеализацияУслугПоПереработке.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РеализацияУслугПоПереработке.ФормаВыбораСобытия");
