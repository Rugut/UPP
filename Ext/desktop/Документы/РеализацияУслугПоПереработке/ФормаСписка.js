...
{
	Ext.define('Документы.РеализацияУслугПоПереработке.ФормаСписка',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Реализации услуг по переработке',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РеализацияУслугПоПереработке.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РеализацияУслугПоПереработке.ФормаСпискаСобытия");
