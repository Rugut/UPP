			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СписаниеМатериаловИзЭксплуатации.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СписаниеМатериаловИзЭксплуатации.ФормаВыбораСобытия");
