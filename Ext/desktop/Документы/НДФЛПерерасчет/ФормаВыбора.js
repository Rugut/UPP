	...
	[{
		...
		[
		{
			...
			[
				...
				{
					text:'Период взаиморасчетов',
					width:'80',
					dataIndex:'ПериодВзаиморасчетов',
					flex:1,
				},
				{
					text:'Ответственный',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.НДФЛПерерасчет.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.НДФЛПерерасчет.ФормаВыбораСобытия");
