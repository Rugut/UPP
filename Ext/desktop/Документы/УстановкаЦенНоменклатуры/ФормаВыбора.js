...
{
	Ext.define('Документы.УстановкаЦенНоменклатуры.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УстановкаЦенНоменклатуры.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УстановкаЦенНоменклатуры.ФормаВыбораСобытия");
