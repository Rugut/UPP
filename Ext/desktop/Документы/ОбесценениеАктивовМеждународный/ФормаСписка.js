			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОбесценениеАктивовМеждународный.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОбесценениеАктивовМеждународный.ФормаСпискаСобытия");
