Ext.require(['Данные.Документы.ВыбытиеОсновныхСредствМеждународный'], function () 
{
	...
	style: 'position:absolute;width:524px;height:421px;',
	iconCls: 'bogus',
	minimizable: true,
	maximizable: true,
	resizable: false,
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВыбытиеОсновныхСредствМеждународный.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВыбытиеОсновныхСредствМеждународный.ФормаВыбораСобытия");
