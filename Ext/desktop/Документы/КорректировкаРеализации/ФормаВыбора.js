...
{
	Ext.define('Документы.КорректировкаРеализации.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.КорректировкаРеализации.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.КорректировкаРеализации.ФормаВыбораСобытия");
