		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'100',
					dataIndex:'СтатьяПрочихДоходовИРасходов',
					flex:1,
				},
				{
					text:'Ответственный',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.КорректировкаРеализации.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.КорректировкаРеализации.ФормаСпискаСобытия");
