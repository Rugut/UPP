...
{
	Ext.define('Документы.ТребованиеНакладная.ФормаСписка',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ТребованиеНакладная.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ТребованиеНакладная.ФормаСпискаСобытия");
