		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'129',
					dataIndex:'СертифицирующееПодразделение',
					flex:1,
				},
			],
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ЗаявкаНаСертификациюНоменклатуры/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ЗаявкаНаСертификациюНоменклатуры.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ЗаявкаНаСертификациюНоменклатуры.ФормаСпискаСобытия");
