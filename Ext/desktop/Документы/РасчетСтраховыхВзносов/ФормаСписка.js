...
{
	Ext.define('Документы.РасчетСтраховыхВзносов.ФормаСписка',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Документы начисления страховых взносов в ПФР, ФОМС и ФСС',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РасчетСтраховыхВзносов.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РасчетСтраховыхВзносов.ФормаСпискаСобытия");
