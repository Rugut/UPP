			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.УчетЗатратНаИсточникиПерсонала.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.УчетЗатратНаИсточникиПерсонала.ФормаВыбораСобытия");
