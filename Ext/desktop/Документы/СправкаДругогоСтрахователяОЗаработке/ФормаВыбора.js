			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СправкаДругогоСтрахователяОЗаработке.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СправкаДругогоСтрахователяОЗаработке.ФормаВыбораСобытия");
