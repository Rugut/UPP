	...
	[{
					...
					[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ОприходованиеНЗП/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Документы.ОприходованиеНЗП.ФормаДокументаСобытия'], function ()
					{
						var объект = Ext.create("Документы.ОприходованиеНЗП.ФормаДокументаСобытия");
