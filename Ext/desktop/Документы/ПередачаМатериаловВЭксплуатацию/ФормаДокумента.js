	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Документы.ПередачаМатериаловВЭксплуатацию.ФормаДокументаСобытия'], function ()
					{
						var объект = Ext.create("Документы.ПередачаМатериаловВЭксплуатацию.ФормаДокументаСобытия");
		...
		},
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ПередачаМатериаловВЭксплуатацию/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
