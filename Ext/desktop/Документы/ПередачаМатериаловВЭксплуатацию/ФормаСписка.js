			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПередачаМатериаловВЭксплуатацию.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПередачаМатериаловВЭксплуатацию.ФормаСпискаСобытия");
