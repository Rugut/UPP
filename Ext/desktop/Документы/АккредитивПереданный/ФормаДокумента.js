Ext.define('Документы.АккредитивПереданный.ФормаДокумента',
	...
	[
		...
		},
		{
			...
			style: 'position:absolute;left:180px;top:24px;width:117px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			style: 'position:absolute;left:0px;top:120px;width:71px;height:27px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Статья движ. ден. средств:',
			style: 'position:absolute;left:322px;top:48px;width:74px;height:27px;',
		},
		{
			xtype: 'button',
			name: 'КнопкаПодбор',
		...
		},
		{
			...
			text: 'Субконто Дт1:',
			style: 'position:absolute;left:0px;top:48px;width:75px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Субконто Дт1:',
			style: 'position:absolute;left:0px;top:72px;width:75px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'ИНН:',
			style: 'position:absolute;left:6px;top:25px;width:77px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Ответственный:',
			style: 'position:absolute;left:336px;top:396px;width:84px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
