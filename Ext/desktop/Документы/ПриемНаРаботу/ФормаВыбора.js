			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПриемНаРаботу.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПриемНаРаботу.ФормаВыбораСобытия");
		...
		},
		{
			...
			[
					...
					menu: [
				{
					...
					tooltip:'Прием на работу в организацию',
				},
				{
