		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'120',
					dataIndex:'КонтактныйТелефонОтветственного',
					flex:1,
				},
				{
					text:'Комментарий',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СведенияОДоходахФизлиц.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СведенияОДоходахФизлиц.ФормаСпискаСобытия");
