		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'80',
					dataIndex:'НачалоПогашения',
					flex:1,
				},
				{
					text:'Срок погашения',
					width:'80',
					dataIndex:'СрокПогашения',
					flex:1,
				},
				{
					text:'Комментарий',
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ДоговорЗаймаСРаботником/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ДоговорЗаймаСРаботником.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ДоговорЗаймаСРаботником.ФормаСпискаСобытия");
