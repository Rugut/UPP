	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/РезультатИспытательногоСрока/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РезультатИспытательногоСрока.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РезультатИспытательногоСрока.ФормаСпискаСобытия");
