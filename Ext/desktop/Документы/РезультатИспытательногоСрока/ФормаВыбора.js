			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РезультатИспытательногоСрока.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РезультатИспытательногоСрока.ФормаВыбораСобытия");
