Ext.require(['Данные.Справочники.Склады'], function () 
{
	...
	[{
		...
		[
		{
			...
			name: 'НадписьКод',
			text: 'Код:',
			style: 'position:absolute;left:456px;top:57px;width:40px;height:19px;text-align:center;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.Склады.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.Склады.ФормаГруппыСобытия");
