...
{
	Ext.define('Справочники.ДоходыБудущихПериодов.ФормаВыбора',
	{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ДоходыБудущихПериодов/ВыбратьПоСсылке/100', timeout: 3},
				fields:
				[
					{
						name:'Картинка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ДоходыБудущихПериодов.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ДоходыБудущихПериодов.ФормаВыбораСобытия");
