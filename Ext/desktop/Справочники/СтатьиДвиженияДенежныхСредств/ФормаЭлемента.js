Ext.require(['Данные.Справочники.СтатьиДвиженияДенежныхСредств'], function () 
{
	...
	[{
		...
		{
			xtype: 'label',
			id: 'НадписьВидДвиженияДенежныхСредств',
			text: 'Вид движения \r\nденежных средств:',
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					Правая: { Элемент: 'НадписьВидДвиженияДенежныхСредств', Граница: 'Левая', Номер: 7, Координата: 0},
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'НадписьВидДвиженияДенежныхСредств', Граница: 'Верхняя', Номер: 7, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
		...
		},
		{
			...
			Привязка:
			{
				...
				ОбъектПривязки: 
				{
					...
					Левая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Верхняя: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
					Нижняя: { Элемент: 'ВидДвиженияДенежныхСредств', Граница: 'Верхняя', Номер: 8, Координата: 0},
				},
				ОбъектПропорций: 
				{
					Правая: { Элемент: '', Граница: 'Пустая', Номер: -1, Координата: 0},
