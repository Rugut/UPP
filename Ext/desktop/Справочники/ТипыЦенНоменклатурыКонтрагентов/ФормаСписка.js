		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Код','Владелец','Наименование','ВалютаЦены.Представление','ТипЦеныНоменклатуры.Представление','ЦенаВключаетНДС','ОписаниеТипаЦеныНоменклатурыКонтрагента','Комментарий',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
