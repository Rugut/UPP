		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Код','Наименование','ВалютаЦены.Представление','ЦенаВключаетНДС','Комментарий','ТипЦеныНоменклатуры.Представление','ОписаниеТипаЦеныНоменклатурыКонтрагента',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
