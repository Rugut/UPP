	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.НастройкиРасчетаЦеныНоменклатуры.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.НастройкиРасчетаЦеныНоменклатуры.ФормаГруппыСобытия");
