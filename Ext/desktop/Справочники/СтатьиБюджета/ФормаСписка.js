		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'120',
					dataIndex:'СтатьяОборотов.Представление',
					flex:1,
				},
				{
					text:'Знак',
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Ссылка','Родитель.Представление','Картинка','Код','Наименование','СтатьяОборотов.Представление','Знак',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СтатьиБюджета.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СтатьиБюджета.ФормаСпискаСобытия");
