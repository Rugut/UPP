		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'220',
					dataIndex:'ВидОбъектаКонтактнойИнформации.Представление',
					flex:1,
				},
			],
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ВидыКонтактнойИнформации/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
