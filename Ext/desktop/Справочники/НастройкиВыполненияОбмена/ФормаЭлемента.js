Ext.define('Справочники.НастройкиВыполненияОбмена.ФормаЭлемента',
	...
	[
		...
		},
		{
			...
			name: 'НадписьКод',
			text: 'Код:',
			style: 'position:absolute;left:409px;top:33px;width:40px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
					...
					[
		{
			...
			text: 'Пользователь:',
			style: 'position:absolute;left:6px;top:26px;width:81px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Комментарий:',
			style: 'position:absolute;left:8px;top:528px;width:90px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
