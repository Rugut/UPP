	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.ПрофессииРабочих").data,
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ПрофессииРабочих/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПрофессииРабочих.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПрофессииРабочих.ФормаВыбораСобытия");
		...
		},
		{
			...
			[
				...
				'-',
				{
					...
					tooltip:'Подбор информации из классификатора профессий и должностей',
				},
			]
		},
		],
