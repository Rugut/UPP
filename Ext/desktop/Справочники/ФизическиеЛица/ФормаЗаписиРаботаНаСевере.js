	...
	[
		{
			...
			style: 'position:absolute;left:8px;top:113px;width:163px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			style: 'position:absolute;left:8px;top:8px;width:163px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Дней:',
			style: 'position:absolute;left:209px;top:73px;width:37px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			style: 'position:absolute;left:8px;top:32px;width:163px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Месяцев:',
			style: 'position:absolute;left:99px;top:73px;width:54px;height:19px;',
		},
		{
			xtype: 'toolbar',
		...
		},
		{
			...
			text: 'Лет:',
			style: 'position:absolute;left:13px;top:73px;width:29px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
