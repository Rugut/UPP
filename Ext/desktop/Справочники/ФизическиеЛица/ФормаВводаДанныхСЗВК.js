	...
	[{
		...
		},
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.ФизическиеЛица").data,
					fields: ['ВидСтажа','КодСтажа','Лет','Месяцев','Дней',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
		...
		},
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.ФизическиеЛица").data,
					fields: ['Организация','ВидДеятельности','Период',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
