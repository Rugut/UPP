		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Код','Наименование','ЗагрузкаДанных','ВыгрузкаДанных','АдресДляОбмена','Комментарий','HTTPОбменАдресСайта','КаталогВыгрузки','ВыгружатьНаСайт','УзелОбменаТоварами.Представление','УзелОбменаЗаказами.Представление',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
