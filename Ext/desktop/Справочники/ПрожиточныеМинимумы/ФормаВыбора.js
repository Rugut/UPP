Ext.require(['Данные.Справочники.ПрожиточныеМинимумы'], function () 
{
	...
	style: 'position:absolute;width:482px;height:300px;',
	iconCls: 'bogus',
	minimizable: true,
	maximizable: true,
	resizable: false,
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ПрожиточныеМинимумы.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ПрожиточныеМинимумы.ФормаВыбораСобытия");
