			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ГруппыДоступаКонтрагентов.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ГруппыДоступаКонтрагентов.ФормаВыбораСобытия");
