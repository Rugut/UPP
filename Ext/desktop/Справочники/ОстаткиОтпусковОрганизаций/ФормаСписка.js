	...
	[{
		...
		[
		{
			...
			[
				...
				},
				{
					text:'Сотрудник',
					width:'120',
					dataIndex:'Сотрудник.Представление',
					flex:1,
				},
				{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Ссылка','Картинка','Сотрудник.Представление','ДатаАктуальности',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ОстаткиОтпусковОрганизаций.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ОстаткиОтпусковОрганизаций.ФормаСпискаСобытия");
		...
		},
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.ОстаткиОтпусковОрганизаций").data,
					fields: ['Ссылка','ВидЕжегодногоОтпуска','Количество','ДатаНачалаРабочегоГода','ДатаОкончанияРабочегоГода',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
