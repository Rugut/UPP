		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Ссылка','Картинка','Владелец','Код','ЕдиницаПоКлассификатору.Представление','Наименование','Коэффициент','Вес','Объем','ШтрихКод','ПорогОкругления','ПредупреждатьОНецелыхМестах',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
