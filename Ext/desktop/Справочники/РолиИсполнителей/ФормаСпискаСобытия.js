Ext.define('Справочники.РолиИсполнителей.ФормаСпискаСобытия',
{
	ПередатьСсылку: function (строкаЗначений)
	{
		...
		var хранилище = Ext.create('Ext.data.Store',
		{
			...
			proxy: new Ext.data.ScriptTagProxy({ url: 'https://as-msk-n7077:1337/Справочники/РолиИсполнителей/НайтиПоСсылке/' + ссылка, timeout:200}),
		});
		хранилище.load(
		{
			callback: function (records, operation, success)
			{
				Ext.require(['Справочники.РолиИсполнителей.ФормаЭлемента'], function ()
				{
					...
					var окно = Ext.create('Справочники.РолиИсполнителей.ФормаЭлемента',
					{
