	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ЯзыкиНародовМира/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
		...
		},
		{
			...
			[
				...
				{
					text:'Подбор из ОКИН',
					tooltip:'Подбор информации о сотруднике из фасета """"Языки народов РФ и иностранные языки"""" Общероссийского классификатора информации о населении',
				},
			]
		},
		],
