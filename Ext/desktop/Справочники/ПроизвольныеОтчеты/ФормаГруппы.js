...
{
	Ext.define('Справочники.ПроизвольныеОтчеты.ФормаГруппы',
	{
	...
	maximizable: true,
	resizable: false,
	title: 'Группа Аналитические отчеты',
	...
	[{
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.ПроизвольныеОтчеты.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.ПроизвольныеОтчеты.ФормаГруппыСобытия");
