			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.РегиональныеСегментыПоМСФО.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.РегиональныеСегментыПоМСФО.ФормаСпискаСобытия");
