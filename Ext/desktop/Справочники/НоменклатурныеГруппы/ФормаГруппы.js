Ext.require(['Данные.Справочники.НоменклатурныеГруппы'], function () 
{
	...
	[{
		...
		[
		{
			...
			name: 'НадписьКод',
			text: 'Код:',
			style: 'position:absolute;left:284px;top:59px;width:40px;height:19px;text-align:center;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.НоменклатурныеГруппы.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.НоменклатурныеГруппы.ФормаГруппыСобытия");
