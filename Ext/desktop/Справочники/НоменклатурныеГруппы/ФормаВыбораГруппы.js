			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.НоменклатурныеГруппы.ФормаВыбораГруппыСобытия'], function ()
						{
							var obj = Ext.create("Справочники.НоменклатурныеГруппы.ФормаВыбораГруппыСобытия");
