	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения").data,
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения.ФормаСпискаСобытия");
		...
		},
		{
			...
			[
				...
				'-',
				{
					...
					tooltip:'Подбор должности из списка """"вредных"""" должностей №1',
				},
				{
					text:'Подбор из списка №2',
					tooltip:'Подбор должности из списка """"вредных"""" должностей №2',
				},
			]
		},
		],
