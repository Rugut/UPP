...
{
	Ext.define('Справочники.ТипыЗаписейЗаметок.ФормаВыбора',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ТипыЗаписейЗаметок.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ТипыЗаписейЗаметок.ФормаВыбораСобытия");
