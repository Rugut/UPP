		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Код','Наименование','БазоваяЕдиницаИзмерения.Представление','Коэффициент','Расценка','НормаВремени','Валюта.Представление','ОсновнаяСтатьяЗатратНаПроизводство.Представление','ОсновнаяНоменклатурнаяГруппа.Представление','СпособОтраженияЗарплатыВБухучете.Представление','ОсновнойСпособРаспределенияЗатратНаВыпуск.Представление',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
