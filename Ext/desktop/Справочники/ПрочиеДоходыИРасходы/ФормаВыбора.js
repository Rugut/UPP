		...
		[
		{
			...
			[
				...
				},
				{
					...
					width:'250',
					dataIndex:'ВидПрочихДоходовИРасходов.Представление',
					flex:1,
				},
				{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Ссылка','Родитель.Представление','Картинка','Код','Наименование','ВидПрочихДоходовИРасходов.Представление','ПринятиеКналоговомуУчету',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
