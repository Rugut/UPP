	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СтепениЗнанияЯзыка/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СтепениЗнанияЯзыка.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СтепениЗнанияЯзыка.ФормаВыбораСобытия");
		...
		},
		{
			...
			[
				...
				{
					text:'Подбор из ОКИН',
					tooltip:'Подбор информации о сотруднике из фасета """"Степень знания иностранных языков и языков народов РФ"""" Общероссийского классификатора информации о населении',
				},
			]
		},
		],
