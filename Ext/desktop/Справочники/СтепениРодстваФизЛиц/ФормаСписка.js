	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.СтепениРодстваФизЛиц").data,
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/СтепениРодстваФизЛиц/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СтепениРодстваФизЛиц.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СтепениРодстваФизЛиц.ФормаСпискаСобытия");
		...
		},
		{
			...
			[
				...
				{
					text:'Подбор из ОКИН',
					tooltip:'Подбор информации о сотруднике из фасета """"Родство, свойство"""" Общероссийского классификатора информации о населении',
				},
			]
		},
		],
