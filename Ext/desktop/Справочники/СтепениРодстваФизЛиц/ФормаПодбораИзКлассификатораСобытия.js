Ext.define('Справочники.СтепениРодстваФизЛиц.ФормаПодбораИзКлассификатораСобытия',
{
	ПередатьСсылку: function (строкаЗначений)
	{
		...
		var хранилище = Ext.create('Ext.data.Store',
		{
			...
			proxy: new Ext.data.ScriptTagProxy({ url: 'https://as-msk-n7077:1337/Справочники/СтепениРодстваФизЛиц/НайтиПоСсылке/' + ссылка, timeout:200}),
		});
		хранилище.load(
		{
			callback: function (records, operation, success)
			{
				Ext.require(['Справочники.СтепениРодстваФизЛиц.ФормаЭлемента'], function ()
				{
					...
					var окно = Ext.create('Справочники.СтепениРодстваФизЛиц.ФормаЭлемента',
					{
