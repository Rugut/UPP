Ext.require(['Данные.Справочники.ВидыВзаиморасчетов'], function () 
{
	...
	style: 'position:absolute;width:356px;height:300px;',
	iconCls: 'bogus',
	minimizable: true,
	maximizable: true,
	resizable: false,
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВидыВзаиморасчетов.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВидыВзаиморасчетов.ФормаСпискаСобытия");
