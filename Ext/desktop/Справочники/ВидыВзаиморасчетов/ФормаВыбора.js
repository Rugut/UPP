...
{
	Ext.define('Справочники.ВидыВзаиморасчетов.ФормаВыбора',
	{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.ВидыВзаиморасчетов").data,
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ВидыВзаиморасчетов/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВидыВзаиморасчетов.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВидыВзаиморасчетов.ФормаВыбораСобытия");
