Ext.require(['Данные.Справочники.ПрофилиИзмененияПлановПоИзмерениям'], function () 
{
	...
	[{
		...
		[
		{
			...
			name: 'Надпись1',
			text: 'Код:',
			style: 'position:absolute;left:275px;top:61px;width:40px;height:19px;text-align:center;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.ПрофилиИзмененияПлановПоИзмерениям.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.ПрофилиИзмененияПлановПоИзмерениям.ФормаГруппыСобытия");
