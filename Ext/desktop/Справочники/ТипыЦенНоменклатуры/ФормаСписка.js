		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Код','Наименование','ВалютаЦены.Представление','Рассчитывается','БазовыйТипЦен.Представление','ПроцентСкидкиНаценки','ЦенаВключаетНДС','ПорядокОкругления.Представление','ОкруглятьВБольшуюСторону','СпособРасчетаЦены.Представление',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
