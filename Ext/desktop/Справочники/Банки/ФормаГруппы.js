Ext.require(['Данные.Справочники.Банки'], function () 
{
	...
	style: 'position:absolute;width:446px;height:113px;',
	iconCls: 'bogus',
	minimizable: true,
	maximizable: true,
	title: 'Группа Банки',
	...
	[{
		...
		[
		{
			...
			name: 'НадписьКод',
			text: 'Код:',
			style: 'position:absolute;left:316px;top:61px;width:40px;height:19px;text-align:center;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.Банки.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.Банки.ФормаГруппыСобытия");
	...
	[
		...
		{
			xtype: 'toolbar',
			style: 'position:absolute;left:0px;top:88px;width:446px;height:25px;',
			dock: 'bottom',
			items:
			[
				{
