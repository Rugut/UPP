		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Ссылка','Родитель.Представление','Картинка','Код','Наименование','Подразделение.Представление','РабочийЦентр',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ТочкиМаршрута/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ТочкиМаршрута.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ТочкиМаршрута.ФормаВыбораСобытия");
