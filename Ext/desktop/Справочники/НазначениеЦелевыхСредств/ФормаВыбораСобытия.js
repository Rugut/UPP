Ext.define('Справочники.НазначениеЦелевыхСредств.ФормаВыбораСобытия',
{
	ПередатьСсылку: function (строкаЗначений)
	{
		...
		var хранилище = Ext.create('Ext.data.Store',
		{
			...
			proxy: new Ext.data.ScriptTagProxy({ url: 'https://as-msk-n7077:1337/Справочники/НазначениеЦелевыхСредств/НайтиПоСсылке/' + ссылка, timeout:200}),
		});
		хранилище.load(
		{
			callback: function (records, operation, success)
			{
				Ext.require(['Справочники.НазначениеЦелевыхСредств.ФормаЭлемента'], function ()
				{
					...
					var окно = Ext.create('Справочники.НазначениеЦелевыхСредств.ФормаЭлемента',
					{
