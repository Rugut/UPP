...
{
	Ext.define('Справочники.НазначениеЦелевыхСредств.ФормаВыбора',
	{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/НазначениеЦелевыхСредств/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.НазначениеЦелевыхСредств.ФормаВыбораСобытия'], function ()
						{
							var obj = Ext.create("Справочники.НазначениеЦелевыхСредств.ФормаВыбораСобытия");
