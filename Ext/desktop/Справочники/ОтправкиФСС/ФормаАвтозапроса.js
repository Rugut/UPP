	...
	[
		{
			...
			name: 'НадписьОтчет',
			text: 'Отчет:',
			style: 'position:absolute;left:8px;top:8px;width:33px;height:15px;',
		},
		{
			xtype: 'label',
			name: 'НадписьДатаОтправки1',
			text: 'Дата отправки:',
			style: 'position:absolute;left:8px;top:26px;width:79px;height:15px;',
		},
		{
			xtype: 'label',
			name: 'НадписьОтчетПредставление',
			text: '',
			style: 'position:absolute;left:45px;top:8px;width:314px;height:15px;',
		},
		{
			xtype: 'label',
			name: 'ДатаОтправки',
			text: '',
			style: 'position:absolute;left:91px;top:26px;width:268px;height:15px;',
		},
		{
			xtype: 'tabpanel',
...
Через некоторое время будет предпринята ещё одна попытка (15 с)',
			style: 'position:absolute;left:0px;top:0px;width:351px;height:30px;',
		},
					]
				},
				{
					...
					[
		{
			...
			text: '',
			style: 'position:absolute;left:0px;top:18px;width:351px;height:15px;',
		},
					]
				},
			]
