Ext.require(['Данные.Справочники.ТарифныеРазряды'], function () 
{
	...
	[{
		...
		[
		{
			...
			name: 'НадписьКод',
			text: 'Код:',
			style: 'position:absolute;left:311px;top:57px;width:32px;height:19px;text-align:left;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.ТарифныеРазряды.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.ТарифныеРазряды.ФормаГруппыСобытия");
