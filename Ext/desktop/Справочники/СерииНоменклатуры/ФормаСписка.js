		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Владелец','Код','Наименование','СерийныйНомер','НомерИДатаСертификата','СрокГодности','НомерГТД.Представление','СтранаПроисхождения.Представление','Комментарий',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
