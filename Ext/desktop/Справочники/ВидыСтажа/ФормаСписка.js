Ext.require(['Данные.Справочники.ВидыСтажа'], function () 
{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.ВидыСтажа").data,
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/ВидыСтажа/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ВидыСтажа.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ВидыСтажа.ФормаСпискаСобытия");
