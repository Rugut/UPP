Ext.define('Справочники.СотрудникиОрганизаций.ФормаЭлемента',
	...
	[
					...
					[
		{
			...
			style: 'position:absolute;left:0px;top:403px;width:210px;height:35px;',
		},
					]
				},
			]
		...
		},
		{
			...
			name: 'НадписьИНН',
			text: 'ИНН:',
			style: 'position:absolute;left:338px;top:49px;width:28px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьКодИМНС',
		...
		},
		{
			...
			text: 'Табельный №:',
			style: 'position:absolute;left:11px;top:209px;width:82px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			text: 'Организация:',
			style: 'position:absolute;left:11px;top:162px;width:82px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			name: 'НадписьОт',
			text: 'от:',
			style: 'position:absolute;left:174px;top:6px;width:16px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			name: 'НадписьПо',
			text: 'по',
			style: 'position:absolute;left:174px;top:29px;width:16px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			text: 'Должность:',
			style: 'position:absolute;left:6px;top:98px;width:84px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьИспытательныйСрок',
			text: 'Испытание на срок, мес.:',
			style: 'position:absolute;left:280px;top:29px;width:141px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьЗанимаемыхСтавок',
			text: 'Кол. ставок:',
			style: 'position:absolute;left:348px;top:121px;width:64px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьГрафикРаботы',
			text: 'График работы:',
			style: 'position:absolute;left:6px;top:121px;width:84px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьВалютаТарифнойСтавки',
			text: 'Валюта:',
			style: 'position:absolute;left:220px;top:187px;width:43px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьВидРасчета',
			text: 'Вид расчета:',
			style: 'position:absolute;left:11px;top:164px;width:83px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьТарифнаяСтавка',
			text: 'Тариф \ Оклад:',
			style: 'position:absolute;left:11px;top:187px;width:83px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			name: 'НадписьИмя',
			text: 'Имя:',
			style: 'position:absolute;left:0px;top:79px;width:43px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			name: 'НадписьФИО',
			text: 'ФИО:',
			style: 'position:absolute;left:0px;top:101px;width:43px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			style: 'position:absolute;left:0px;top:421px;width:101px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			name: 'НадписьКод1',
			text: 'Табельный №:',
			style: 'position:absolute;left:0px;top:23px;width:82px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			text: 'Организация:',
			style: 'position:absolute;left:0px;top:71px;width:82px;height:19px;',
		},
		{
			xtype: 'tabpanel',
		...
		},
		{
			...
			text: 'Гражданство:',
			style: 'position:absolute;left:6px;top:74px;width:90px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Стандартные:',
			style: 'position:absolute;left:11px;top:141px;width:90px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Имущественные:',
			style: 'position:absolute;left:11px;top:166px;width:90px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			text: 'Статус:',
			style: 'position:absolute;left:11px;top:191px;width:90px;height:19px;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			name: 'НадписьПо1',
			text: 'по',
			style: 'position:absolute;left:174px;top:52px;width:16px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьИспытательныйСрок1',
			text: 'Испытание на срок, мес.:',
			style: 'position:absolute;left:279px;top:52px;width:142px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			text: 'График работы:',
			style: 'position:absolute;left:6px;top:144px;width:84px;height:19px;',
		},
		{
			xtype: 'label',
			name: 'НадписьВалютаТарифнойСтавки1',
			text: 'Валюта:',
			style: 'position:absolute;left:220px;top:210px;width:43px;height:19px;',
		},
		{
			xtype: 'label',
		...
		},
		{
			...
			text: 'Тариф \ Оклад:',
			style: 'position:absolute;left:11px;top:210px;width:83px;height:19px;',
		},
		{
			xtype: 'label',
					...
					[
		{
			...
			name: 'НадписьИНН1',
			text: 'ИНН:',
			style: 'position:absolute;left:338px;top:29px;width:28px;height:19px;',
		},
		{
			xtype: 'grid',
