		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Ссылка','Картинка','Код','Владелец','Наименование','СпособПогашенияСтоимости.Представление','СрокПолезногоИспользования','Количество','ЕдиницаИзмерения.Представление','СпособОтраженияРасходов.Представление',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
