Ext.require(['Данные.Справочники.Проекты'], function () 
{
	...
	[{
		...
		[
		{
			...
			name: 'НадписьКод',
			text: 'Код:',
			style: 'position:absolute;left:276px;top:57px;width:40px;height:19px;text-align:center;',
		},
		{
			xtype: 'textfield',
			hideLabel: true,
		...
		},
		{
			...
			onTriggerClick : function(ЭтотОбъект)
			{
				...
				{
					Ext.require(['Справочники.Проекты.ФормаГруппыСобытия'], function ()
					{
						var объект = Ext.create("Справочники.Проекты.ФормаГруппыСобытия");
