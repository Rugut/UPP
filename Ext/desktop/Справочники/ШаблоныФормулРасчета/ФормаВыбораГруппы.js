...
{
	Ext.define('Справочники.ШаблоныФормулРасчета.ФормаВыбораГруппы',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.ШаблоныФормулРасчета.ФормаВыбораГруппыСобытия'], function ()
						{
							var obj = Ext.create("Справочники.ШаблоныФормулРасчета.ФормаВыбораГруппыСобытия");
