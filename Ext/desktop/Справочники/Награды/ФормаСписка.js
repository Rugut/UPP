Ext.require(['Данные.Справочники.Награды'], function () 
{
	...
	[{
		...
		[
		{
			...
			store:
			{
				...
				{
					data: Ext.create("Данные.Справочники.Награды").data,
				...
				restful: true,
				autoSync: false,
				proxy: {type: 'jsonp',url: 'https://localhost:1337/Справочники/Награды/ВыбратьПоСсылке/100', timeout: 200},
				fields:
				[
					{
						name:'Ссылка',
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.Награды.ФормаСпискаСобытия'], function ()
						{
							var obj = Ext.create("Справочники.Награды.ФормаСпискаСобытия");
