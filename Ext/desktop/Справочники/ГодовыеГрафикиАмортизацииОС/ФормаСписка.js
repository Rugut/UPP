		...
		[
		{
			...
			store:
			{
				data: Ext.create("Ext.data.Store",
				{
					...
					fields: ['Картинка','Код','Наименование','Коэффициент1','Коэффициент2','Коэффициент3','Коэффициент4','Коэффициент5','Коэффициент6','Коэффициент7','Коэффициент8','Коэффициент9','Коэффициент10','Коэффициент11','Коэффициент12','Комментарий',]
				}).data.items,
				autoLoad: true,
				pageSize: 50,
				restful: true,
