...
{
	Ext.define('Справочники.СчетаБюджета.ФормаВыбораГруппы',
	{
			...
			listeners:
			{
				dblclick:
				{
					...
					fn: function ()
					{
						...
						Ext.require(['Справочники.СчетаБюджета.ФормаВыбораГруппыСобытия'], function ()
						{
							var obj = Ext.create("Справочники.СчетаБюджета.ФормаВыбораГруппыСобытия");
