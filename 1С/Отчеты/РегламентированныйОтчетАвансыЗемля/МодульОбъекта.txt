...
Форма20050401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1153003", '20050519', "66н", "ФормаОтчета2005Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20050401, "3.00000");

Форма20060401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1153003", '20060412', "64н", "ФормаОтчета2006Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20060401, "3.00001");

Форма20070301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1153003", '20070219', "16н", "ФормаОтчета2007Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20070301, "3.00002");

Форма20090101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1153003", '20080916', "95н", "ФормаОтчета2009Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу Минфина РФ от 19.05.2005 г. №66н";
НоваяФорма.ДатаНачалоДействия = '20050401';
НоваяФорма.ДатаКонецДействия  = '20060331';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2006Кв2";
НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу Минфина РФ от 19.05.2005 г. №66н (в ред. приказа Минфина РФ от 12.04.2006 № 64н)";
НоваяФорма.ДатаНачалоДействия = '20060401';
НоваяФорма.ДатаКонецДействия  = '20070331'; // Специально сделано, чтобы можно было сдавать
// авансовый расчет за 1 кв. 2007 г., т.к. новая форма расчет еще не вступила в действие с момента публикации.

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв1";
НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу Минфина РФ от 19.05.2005 г. №66н (в ред. приказа Минфина РФ от 12.04.2006 № 64н, от 19.02.2007 №16н с учетом письма ФНС от 24.07.2008 №3-7-04/178@)";
НоваяФорма.ДатаНачалоДействия = '20070101';
НоваяФорма.ДатаКонецДействия  = '20081231';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв1";
НоваяФорма.ОписаниеОтчета     = "Приложение №3 к приказу Министерства финансов Российской Федерации от 16.09.2008 г. № 95н";
